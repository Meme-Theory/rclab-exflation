...
**Source**: Exploration agents scanning all 80+ files in `sessions/` and `computations/`
...
### Format A — `.txt` GATE blocks (computation)
...
### Format B — `.txt` inline verdicts (computation)
