---
ARCHIVED: 2026-05-10
Last meaningful session: S44
Superseded by: sessions/framework/Phononic-Substrate-Geometry.md
Reason: 20-session spectral-action stabilization post-mortem; reframed at S37 paradigm shift (transit dynamics over equilibrium); content fully absorbed into Phononic-Substrate-Geometry.md
---
...
|:-----|:--------|:--------|
| `computations/s36_sfull_tau_stabilization.npz` | S36 | S_full(tau) at 16 points, per-sector |
| `computations/s36_tau_dynamics.npz` | S36 | Dynamical trajectories, dwell times |
| `computations/s36_cc_arithmetic.npz` | S37 | CC gradient, vacuum energies |
| `computations/s37_cutoff_sa.npz` | S37 | 10 cutoffs x 6 Lambda x 16 tau |
| `computations/s37_oneloop_sa.npz` | S37 | F.5 one-loop BdG correction |
| `computations/s37_instanton_action.npz` | S37 | Instanton action, GL parameters |
| `computations/s37_pair_susceptibility.npz` | S37 | Giant pair vibration, E_vac |
