...
| `sessions/session-38/session-38-results-workingpaper.md` | Results working paper | team-lead |
| `sessions/session-38/session-38-einstein-naz-workshop.md` | W0: CC-Through-Instanton | einstein + nazarewicz |
| `sessions/session-38/session-38-naz-qa-workshop.md` | W1: Pair Vibrator as Phonon | nazarewicz + QA |
| `sessions/session-38/session-38-naz-tesla-workshop.md` | W2: Instanton Resonance | nazarewicz + tesla |
| `sessions/session-38/session-38-landau-hawking-workshop.md` | W3: Kibble-Zurek at Fold | landau + hawking |
| `sessions/session-38/session-38-master-synthesis.md` | This file | gen-physicist (rewritten) |
