...
|:-----|:---------------|:------------|:----------|:-------|
| S80 | W1-1 pair (H̃-EPOCH adjudication) | OPEN | **LANDED** | "PASS-F2 landed | Path A selected; Path B δ_OOM = +2.24 at L=5; downstream W1-2 input pinned" (W0-10 draft EVOI priority table, line 1278). |
| S80 | W1-3 FOLD-INST-GRADIENT (S80-FOLD-INST-GRADIENT) | OPEN | **LANDED** | "DONE verdict landed (see §V)" — §VII row line 3320; "FAIL landed | Instanton action monotone, not fold-concentrated; closes one branch of moduli-stabilization space" (W0-10 draft EVOI priority table, line 1280). |
| S80 | W1-6 csub-sign | OPEN | **LANDED** | "PASS landed | Single-pass [SIGN] verification; d(lnA_s)/d(ln c_sub) = −1.0 exact" (W0-10 draft EVOI priority table, line 1283). |
| S80 | 6 new canonical constants (S81 audit/retrofit context recorded in S80 WP §VI.7) | OPEN | **PROMOTED** | "6 new canonical constants promoted; 41 alias renames executed; 1322 `# (local)` tags applied." (§VI.7 line 3305-3306) |
