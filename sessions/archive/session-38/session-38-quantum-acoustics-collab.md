...
**From what data**: computations/dirac_spectrum.py can generate eigenvalues at any tau.
...
**From what data**: Eigenstates from dirac_spectrum.py at each tau value (same data as 3.3).
