...
**Input**: `computations/s37_instanton_mc.npz`
**Data**: `computations/s38_cc_instanton.npz`
...
**Agent**: nazarewicz
**Status**: COMPLETE
**Input**: `computations/s37_instanton_action.npz`, `s37_pair_susceptibility.npz`, `s31Ba_instanton_kapitza.npz`, `s38_cc_instanton.npz`
...
| File | Content |
|:-----|:--------|
| `computations/s38_attempt_freq.py` | Full computation script |
| `computations/s38_attempt_freq.npz` | All frequencies, ratios, instanton parameters |
...
**Input**: `computations/s36_tau_dynamics.npz`, `s37_instanton_action.npz`, `s37_instanton_mc.npz`, `s36_bdi_winding.npz`, `s37_pair_susceptibility.npz`
...
| File | Content |
|:-----|:--------|
| `computations/s38_kz_defects.py` | Full computation script |
| `computations/s38_kz_defects.npz` | All results (transit params, KZ lengths, excitation probabilities, energies, gate verdict) |
...
**Status**: COMPLETE
**Gate**: CHAOS-1
**Input**: `computations/s27_multisector_bcs.npz` (eigenvalues across 9 (p,q) sectors, 9 tau values)
**Priority**: HIGHEST
...
| File | Content |
|:-----|:--------|
| `computations/s38_level_spacing.py` | Analysis script (full computation) |
| `computations/s38_level_spacing.npz` | All <r> values, per-sector, per-tau |
| `computations/s38_level_spacing.png` | 8-panel diagnostic plot |
...
| File | Content |
|:-----|:--------|
| `computations/s38_otoc_bcs.py` | Full OTOC computation script |
| `computations/s38_otoc_bcs.npz` | All results (OTOC, spectra, level statistics, SFF) |
| `computations/s38_otoc_bcs.png` | 9-panel diagnostic plot |
...
| `computations/s38_level_spacing.py` | CHAOS-1 analysis script | kitaev-quantum-chaos-theorist |
| `computations/s38_level_spacing.npz` | CHAOS-1 data (all <r> values) | kitaev-quantum-chaos-theorist |
| `computations/s38_level_spacing.png` | CHAOS-1 diagnostic plot (8 panels) | kitaev-quantum-chaos-theorist |
| `computations/s38_otoc_bcs.py` | CHAOS-2 OTOC computation script | kitaev-quantum-chaos-theorist |
| `computations/s38_otoc_bcs.npz` | CHAOS-2 data (OTOC, spectra, SFF, level stats) | kitaev-quantum-chaos-theorist |
| `computations/s38_otoc_bcs.png` | CHAOS-2 diagnostic plot (9 panels) | kitaev-quantum-chaos-theorist |
| `computations/s38_attempt_freq.py` | C-3 attempt frequency script | nazarewicz |
| `computations/s38_attempt_freq.npz` | C-3 data (all frequencies, ratios) | nazarewicz |
