...
1. **GGE-LAMBDA-38 is the highest-priority computation.** The 8 Lagrange multipliers completely determine the post-transit 4D particle content. This requires: (i) Richardson-Gaudin ground state at tau = 0.175, (ii) LZ overlaps at 8 avoided crossings during sweep, (iii) Bogoliubov coefficients {alpha_k, beta_k}. All inputs exist in computations/_shared.
