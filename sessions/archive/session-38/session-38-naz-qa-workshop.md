...
- `computations/s37_pair_susceptibility.npz` — GPV data, pair susceptibility
- `computations/s38_attempt_freq.npz` — frequency hierarchy
- `computations/s38_kz_defects.npz` — quench parameters, P_exc
- `computations/s38_level_spacing.npz` — integrability result
- `computations/s38_otoc_bcs.npz` — OTOC oscillation data
