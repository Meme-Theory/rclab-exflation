...
| File | Contents | Agent |
|:-----|:---------|:------|
| `computations/s37_instanton_mc.npz` | Delta_samples at T=0.05, 0.20, 1.00, 5.00 | nazarewicz |
| `computations/s37_instanton_action.npz` | GL coefficients a, b, Delta_0, S_inst | nazarewicz |
| `computations/s37_pair_susceptibility.npz` | BdG eigenvalues, pair susceptibility | nazarewicz |
| `computations/s36_cc_arithmetic.npz` | CC gradient, V_vac at fold | einstein |
...
**Script**: `computations/s38_cc_instanton.py`
**Data**: `computations/s38_cc_instanton.npz`
**Plot**: `computations/s38_cc_instanton.png`
