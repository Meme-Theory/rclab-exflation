...
6. **Data files** (script, .npz, .png paths in `computations/`)
...
**Output files**: `computations/s43_qtheory_selftune.{py,npz,png}`
...
**Output**: `computations/s43_lifshitz_class.{py,npz,png}`
...
- `computations/s43_lifshitz_class.py`
- `computations/s43_lifshitz_class.npz`
- `computations/s43_lifshitz_class.png`
...
**Input**: `computations/s27_multisector_bcs.npz` (eigenvalues), `computations/s42_hauser_feshbach.npz` (cross-check)
...
- Script: `computations/s43_phonon_dos.py`
- Data: `computations/s43_phonon_dos.npz`
- Plot: `computations/s43_phonon_dos.png`
...
- Script: `computations/s43_perlman_blur.py`
- Data: `computations/s43_perlman_blur.npz`
- Plot: `computations/s43_perlman_blur.png`
...
**Input**: `computations/s37_pair_susceptibility.npz`, `computations/s37_instanton_action.npz`, `computations/s36_multisector_ed.npz`
...
- Script: `computations/s43_pair_form_factor.py`
- Data: `computations/s43_pair_form_factor.npz` (43.8 KB)
- Plot: `computations/s43_pair_form_factor.png`
...
- Script: `computations/s43_gcm_zeropoint.py`
- Data: `computations/s43_gcm_zeropoint.npz`
- Plot: `computations/s43_gcm_zeropoint.png`
...
| File | Description |
|:-----|:------------|
| `computations/s43_gge_dm_abundance.py` | Computation script |
| `computations/s43_gge_dm_abundance.npz` | All numerical results |
| `computations/s43_gge_dm_abundance.png` | 6-panel diagnostic plot |
...
**Output files**: `computations/s43_twofluid_wz.{py,npz,png}`
...
**Output files**: `computations/s43_twofluid_wz_v2.{py,npz,png}`
...
- `computations/s43_qtheory_selftune.npz` (W1-1 q-theory corrected Lambda)
...
**Input files**:
- `computations/s42_fabric_dispersion.npz` (BdG masses at fold)
- `computations/s42_gradient_stiffness.npz` (spectral stiffness Z(tau))
- `computations/s42_hauser_feshbach.npz` (HF sector data)
- `computations/s40_collective_inertia.npz` (dE/dtau derivatives)
...
- Script: `computations/s43_impedance_mismatch.py`
- Data: `computations/s43_impedance_mismatch.npz`
- Plot: `computations/s43_impedance_mismatch.png`
...
**Input files**:
- `computations/s23a_kosmann_singlet.py` (Kosmann generator construction)
- `computations/s35_pfaffian_corrected_j.npz` (BDI T/P/S definitions)
- `computations/s43_baryo_k7.npz` (W1-3 results)
- `computations/dirac_spectrum.py` (Dirac infrastructure)
...
**Input files**:
- `computations/s43_lifshitz_class.npz` (W1-2)
- `computations/s43_qfluc_tau0.npz` (W3-2)
- `computations/s42_gradient_stiffness.npz`, `s42_constants_snapshot.npz`, `s42_kz_fnl.npz`, `s42_ns_tilt.npz`
...
**Input files**:
- `computations/s42_gradient_stiffness.py`
- `computations/dirac_spectrum.py`
...
3. **Eigenvalue computation.** For each of 7 metric points (center + 3 directions x 2 signs), computed full D_K eigenvalues on 10 KK sectors: (0,0), (1,0), (0,1), (1,1), (2,0), (0,2), (3,0), (0,3), (2,1), (1,2). Used dirac_spectrum infrastructure (orthonormal frame, spin connection, Clifford algebra, Peter-Weyl decomposition).
...
| File | Description |
|:-----|:------------|
| `computations/s43_offjensen_z_matrix.py` | Computation script |
| `computations/s43_offjensen_z_matrix.npz` | Full Z matrix, eigenvalues, eigenvectors, per-sector data |
| `computations/s43_offjensen_z_matrix.png` | 4-panel plot: Z heatmap, G heatmap, eigenvalue comparison, per-sector breakdown |
...
- Fold metric data from `computations/s42_gradient_stiffness.npz`
...
**Files produced**:
- Script: `computations/s43_lichnerowicz.py`
- Data: `computations/s43_lichnerowicz.npz`
- Plot: `computations/s43_lichnerowicz.png`
...
**Input files**:
- `computations/s42_hauser_feshbach.npz` (full KK spectrum)
...
**Output files**: `computations/s43_oneloop_liv.{py,npz,png}`
...
**Input files**:
- `computations/s36_mmax_authoritative.npz` (V_rem)
- `computations/s40_qrpa_modes.npz` (QRPA frequencies, coherence factors)
- `computations/s40_b2_decay_out.npz` (B2 linewidth)
- `computations/s42_gradient_stiffness.npz` (d^2S/dtau^2 for d^3S)
...
**Files:** `computations/s43_offj_jsymm.{py,npz,png}`
...
**Files**: `computations/s43_twisted_real.py` (script), `.npz` (data), `.png` (3-panel figure)
...
**Input files**:
- W1-2 results (`computations/s43_lifshitz_class.npz`)
...
**Files**: `computations/s43_bcs_universality.py` (script), `.npz` (data), `.png` (4-panel figure)
...
**Input files**:
- `computations/s42_coupled_doorway.npz`
...
- Script: `computations/s43_fsigma8.py`
- Data: `computations/s43_fsigma8.npz`
- Plot: `computations/s43_fsigma8.png`
...
**Data files**: `computations/s43_void_catalog.{py,npz,png}`
...
**Files:**
- Script: `computations/s43_simons_prereg.py`
- Data: `computations/s43_simons_prereg.npz`
- Plot: `computations/s43_simons_prereg.png`
...
**Input files**: `computations/s42_dm_profile.npz`, Papers 32, 51, 55, 56 in `researchers/Little-Red-Dots/`
...
**Files**: `computations/s43_sidm_nfw.py` (script), `.npz` (data), `.png` (4-panel figure: density profiles, circular velocity, sigma_los, discrimination S/N).
...
**Input files**: `computations/s42_constants_snapshot.npz`, `computations/s42_homogeneity.npz`, PDG values
...
**Files:** `computations/s43_mkk_posterior.{py,npz,png}` (script, data, 6-panel figure).
...
**Script/data/plot:** `computations/s43_schwinger_cp.{py,npz,png}`
...
**Files:** `computations/s43_quality_factors.{py,npz,png}`.
...
**Files**: `computations/s43_bg_spinor_polariton.{py,npz,png}`
...
- `computations/s43_alpha_pattern.py`, `.npz`, `.png`
...
**Files**: `computations/s43_gsl_transit.{py,npz,png}`
...
- Script: `computations/s43_first_law.py`
- Data: `computations/s43_first_law.npz`
- Plot: `computations/s43_first_law.png`
...
**Files**: `computations/s43_transplanckian.{py,npz,png}`
...
- Script: `computations/s43_greybody.py`
- Data: `computations/s43_greybody.npz`
- Plot: `computations/s43_greybody.png`
...
- Script: `computations/s43_acoustic_metric.py`
- Data: `computations/s43_acoustic_metric.npz`
- Plot: `computations/s43_acoustic_metric.png`
...
**Files**: `computations/s43_parametric_resonance.{py,npz,png}`
...
- `computations/s43_persistent_homology.py` -- computation script
- `computations/s43_persistent_homology.npz` -- all Betti curve statistics
- `computations/s43_persistent_homology.png` -- 6-panel diagnostic plot
...
**Files:** `computations/s43_foam_gge.{py,npz,png}`
...
**Output files**: `computations/s43_dowker_sorkin.{py,npz,png}`
...
**Computation**: Map lambda_k(tau) across BCS window [0.15, 0.25] using dirac_spectrum.py. Compute W(tau) of B2 gap-edge modes at each tau. Flat-band criterion: W << Delta (Delta = 0.464 from S37). Compute T_c(g) scaling from actual DOS: exponential or linear? Report W/Delta and T_c scaling.
...
| File | Contents |
|:-----|:---------|
| `computations/s43_flat_band.py` | Computation script |
| `computations/s43_flat_band.npz` | All numerical data (tau grid, eigenvalues, gaps, M spectrum) |
| `computations/s43_flat_band.png` | 6-panel diagnostic plot |
...
| File | Description |
|:-----|:------------|
| `computations/s43_gge_temperatures.py` | Computation script (full ED reconstruction + GGE analysis) |
| `computations/s43_gge_temperatures.npz` | All numerical results (8 temperatures, occupations, entropies, pairwise T, non-thermality) |
| `computations/s43_gge_temperatures.png` | 4-panel: (a) GGE occupations vs MF, (b) effective temperatures vs T_RH, (c) Boltzmann plot, (d) energy/entropy budget |
...
**12. Files.** `computations/s43_kz_cell_variants.{py,npz,png}`.
...
- Script: `computations/s43_cw_preregistrations.py`
- Data: `computations/s43_cw_preregistrations.npz`
- Plot: `computations/s43_cw_preregistrations.png`
...
**Output files**: `computations/s43_friedmann_bcs.{py,npz,png}`
...
**Input files**: `dirac_spectrum.py`, W1-2 results.
...
- Script: `computations/s43_higher_sector_crossings.py`
- Data: `computations/s43_higher_sector_crossings.npz`
- Plot: `computations/s43_higher_sector_crossings.png`
...
**Files**: `computations/s43_kk_cmb_transfer.py` (script), `.npz` (data), `.png` (4-panel figure: power spectrum, transfer function, first-sound ratio, correlation function)
...
**Files**: `computations/s43_mod_reheating.py` (script), `.npz` (data), `.png` (4-panel figure: r vs n_s, f_NL vs tau, Z eigenvalues, S curvature ratio)
...
Full assessment + Redux appendix: `computations/s43_sagan_assessment.md`

#### Gate-by-Gate Summary (Level 1 only -- full table in assessment file)
...
|:-----|:------------|:-----|:-------|
| `computations/s43_qtheory_selftune.{py,npz,png}` | Q-theory self-tuning | W1-1 | |
| `computations/s43_lifshitz_class.{py,npz,png}` | Lifshitz classification | W1-2 | |
| `computations/s43_baryo_k7.{py,npz,png}` | K_7 anomaly diagnostics | W1-3 | |
| `computations/s43_phonon_dos.{py,npz,png}` | Phonon DOS histogram | W1-4 | |
| `computations/s43_perlman_blur.{py,npz,png}` | Angular blur vs Perlman | W1-5 | |
| `computations/s43_adiabaticity.{py,npz,png}` | Adiabaticity diagnostic | W1-6 | |
| `computations/s43_pair_form_factor.{py,npz,png}` | Pair transfer form factor | W1-7 | |
| `computations/s43_gcm_zeropoint.{py,npz,png}` | GCM zero-point correction | W1-8 | |
| `computations/s43_gge_dm_abundance.{py,npz,png}` | GGE DM abundance | W2-1 | |
| `computations/s43_twofluid_wz.{py,npz,png}` | Two-fluid w(z) | W2-2 | |
| `computations/s43_carlip_cc.{py,npz,png}` | Carlip CC mechanism | W2-3 | |
| `computations/s43_impedance_mismatch.{py,npz,png}` | Acoustic impedance mismatch | W2-4 | |
| `computations/s43_cbb_timeline.{py,npz,png}` | Cold Big Bang timeline | W3-1 | |
| `computations/s43_qfluc_tau0.{py,npz,png}` | Vacuum fluctuations at tau=0 | W3-2 | |
| `computations/s43_jodd_wall.{py,npz,png}` | J-odd at domain wall | W3-3 | |
| `computations/s43_chiral_eta.{py,npz,png}` | Chiral eta invariant | W3-4 | |
| `computations/s43_kz_transfer.{py,npz,png}` | KZ transfer function | W3-5 | |
| `computations/s43_offjensen_z_matrix.{py,npz,png}` | Off-Jensen Z_{ij} 3x3 | W4-1 | |
| `computations/s43_lichnerowicz.{py,npz,png}` | Lichnerowicz stability | W4-2 | |
| `computations/s43_breathing_mode.{py,npz,png}` | Breathing mode | W4-3 | |
| `computations/s43_oneloop_liv.{py,npz,png}` | One-loop LIV | W4-4 | |
| `computations/s43_thermal_conductivity.{py,npz,png}` | Thermal conductivity | W4-5 | |
| `computations/s43_offj_jsymm.{py,npz,png}` | Off-Jensen J-symmetry | W5-1 | |
| `computations/s43_twisted_real.{py,npz,png}` | Twisted real structure | W5-2 | |
| `computations/s43_bcs_universality.{py,npz,png}` | BCS universality class | W5-3 | |
| `computations/s43_fano_continuum.{py,npz,png}` | Fano continuum | W5-4 | |
| `computations/s43_fsigma8.{py,npz,png}` | f*sigma_8 sentinel | W5-5 | |
| `computations/s43_void_expansion.{py,npz,png}` | Void expansion rate | W5-6 | |
| `computations/s43_void_catalog.{py,npz,png}` | DESI DR2 void catalog | W5-7 | |
| `computations/s43_lrd_clustering.{py,npz,png}` | LRD clustering | W5-8 | |
| `computations/s43_simons_prereg.{py,npz,png}` | Simons Observatory pre-reg | W5-9 | |
| `computations/s43_sidm_nfw.{py,npz,png}` | SIDM vs NFW profiles | W5-10 | |
| `computations/s43_hf_cascade.{py,npz,png}` | HF cascade | W5-11 | |
| `computations/s43_mkk_posterior.{py,npz,png}` | Bayesian M_KK posterior | W5-12 | |
| `computations/s43_schwinger_cp.{py,npz,png}` | Schwinger-instanton CP | W6-1 | |
| `computations/s43_quality_factors.{py,npz,png}` | Quality factor spectrum | W6-2 | |
| `computations/s43_bg_spinor_polariton.{py,npz,png}` | BG spinor polariton | W6-3 | |
| `computations/s43_alpha_pattern.{py,npz,png}` | Relic alpha pattern | W6-4 | |
| `computations/s43_gsl_transit.{py,npz,png}` | GSL for transit | W6-5 | |
| `computations/s43_first_law.{py,npz,png}` | Internal first law | W6-6 | |
| `computations/s43_transplanckian.{py,npz,png}` | Trans-Planckian universality | W6-7 | |
| `computations/s43_greybody.{py,npz,png}` | Greybody factor | W6-8 | |
| `computations/s43_polariton_bz.{py,npz,png}` | Polariton full BZ | W6-9 | |
| `computations/s43_acoustic_metric.{py,npz,png}` | Acoustic metric | W6-10 | |
| `computations/s43_parametric_resonance.{py,npz,png}` | Parametric resonance | W6-11 | |
| `computations/s43_persistent_homology.{py,npz,png}` | Persistent homology | W6-12 | |
| `computations/s43_spectral_dissolution.{py,npz,png}` | Spectral dissolution | W6-13 | |
| `computations/s43_foam_gge.{py,npz,png}` | Foam GGE imprint | W6-14 | |
| `computations/s43_gquest_prereg.{py,npz,png}` | GQuEST null prediction | W6-15 | |
| `computations/s43_dowker_sorkin.{py,npz,png}` | Dowker-Sorkin comparison | W6-16 | |
| `computations/s43_flat_band.{py,npz,png}` | Flat band reinterpretation | W6-17 | |
| `computations/s43_elasticity_tetrad.{py,npz,png}` | Elasticity tetrad Z(tau) | W6-18 | |
| `computations/s43_schwinger_factor36.{py,npz,png}` | Schwinger factor 36 | W6-19 | COMPLETE |
| `computations/s43_gge_temperatures.{py,npz,png}` | 8 GGE temperatures | W6-20 | |
| `computations/s43_kz_cell_variants.{py,npz,png}` | KZ-CELL N_cell variants | W6-21 | |
| `computations/s43_cw_preregistrations.{py,npz,png}` | CW pre-registrations F.1-F.6 (2 CLOSED, 3 OPEN, 1 NEW) | W6-22 | COMPLETE |
| `computations/s43_friedmann_bcs.{py,npz,png}` | Coupled Friedmann-BCS epsilon_H | W7-2 | |
| `computations/s43_higher_sector_crossings.{py,npz,png}` | Higher-sector sign crossings | W7-3 | |
| `computations/s43_kk_cmb_transfer.{py,npz,png}` | Full KK→CMB transfer function | W7-4 | |
| `computations/s43_cc_113_workshop.md` | CC 113 OOM workshop | W7-5 | |
| `computations/s43_sagan_assessment.md` | Sagan probability update | W7-1 | |
