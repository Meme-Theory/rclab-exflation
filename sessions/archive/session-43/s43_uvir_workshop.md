...
This computation uses only the 992 eigenvalues already computed in computation. It requires no new physics assumptions. It is the single most diagnostic test available.
