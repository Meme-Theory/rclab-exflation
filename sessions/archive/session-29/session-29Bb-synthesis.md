...
Method: finite-difference Hessian with eps = 0.02. Dirac spectrum computed at 8 off-Jensen points (2 per direction) using the dirac_spectrum infrastructure with generalized left-invariant metric parameterization at max_pq_sum = 3 (includes all 9 BCS sectors).
...
| File | Description |
|:-----|:-----------|
| `computations/s29b_jensen_transverse.py` | Jensen 5D transverse Hessian computation |
| `computations/s29b_jensen_transverse.npz` | Full results: eigenvalues, Hessian, V_spec/F_BCS decomposition |
| `computations/s29b_jensen_transverse.txt` | Human-readable results summary |
| `computations/s29b_jensen_transverse.png` | Diagnostic plots |
| `computations/s29b_bogoliubov_bcs.py` | Bogoliubov BCS gap equation |
| `computations/s29b_bogoliubov_bcs.npz` | Full results: Delta(tau) for 3 sectors, T_eff, enhancement |
| `computations/s29b_bogoliubov_bcs.txt` | Human-readable results summary |
| `computations/s29b_bogoliubov_bcs.png` | Gap vs tau diagnostic |
| `computations/s29b_josephson_coupling.py` | Full 1-loop Josephson coupling |
| `computations/s29b_josephson_coupling.npz` | Full results: J_max, J/Delta, CG coefficients |
| `computations/s29b_josephson_coupling.txt` | Human-readable results summary |
| `computations/s29b_josephson_coupling.png` | J/Delta vs tau diagnostic |
| `computations/s29b_gate_verdicts.txt` | Gate verdicts (appended to 29Ab + 29Ba verdicts) |
