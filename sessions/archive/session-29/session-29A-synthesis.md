...
**Output**: `computations/s29a_tmatrix_extension.{py,npz,png}`
...
**Output**: `computations/s29a_derived_drive_rate.{py,npz,png}`
...
**Output**: `computations/s29a_entropy_balance.{py,npz,png}`
...
**Output**: `computations/s29a_inter_sector_coupling.{py,npz,png}`
...
**Output**: `computations/s29b_free_energy_comparison.{py,npz,png}`
...
**Output**: `computations/s29b_modulus_eom.{py,npz,png}`
...
**Output**: `computations/s29b_gaussian_correction.{py,npz,txt,png}`
...
| File | Computation |
|:-----|:-----------|
| `computations/s29a_tmatrix_extension.{py,npz,png}` | 29a-1 |
| `computations/s29a_derived_drive_rate.{py,npz,png}` | 29a-2 |
| `computations/s29a_entropy_balance.{py,npz,png}` | 29a-3 |
| `computations/s29a_inter_sector_coupling.{py,npz,png}` | 29a-4 |
| `computations/s29a_gate_verdicts.txt` | All 29Aa gates |

### 29Ab

| File | Computation |
|:-----|:-----------|
| `computations/s29b_free_energy_comparison.{py,npz,png}` | 29b-1 |
| `computations/s29b_modulus_eom.{py,npz,png}` | 29b-2 |
| `computations/s29b_gaussian_correction.{py,npz,txt,png}` | 29b-3 |
| `computations/s29b_gate_verdicts.txt` | All 29Ab gates |
