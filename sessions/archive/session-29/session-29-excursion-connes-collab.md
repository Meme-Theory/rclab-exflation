...
The excursion's RGE gate (Level 1) and Weinberg angle gate (Level 1) are both in the first category. The proton lifetime (Level 1) is in the second. The N_eff prediction is borderline between first and third.
...
The excursion lists Lambda from BCS sector cancellation as a Level 4 prediction (Section VIII). From the NCG standpoint, the cosmological constant arises from the a_0 Seeley-DeWitt coefficient:
