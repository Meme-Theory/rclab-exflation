...
**From what data**: Round-metric eigenvalues are already in the dirac_spectrum output. The formula requires only a symbolic analysis of the Lichnerowicz bound on SU(3).
