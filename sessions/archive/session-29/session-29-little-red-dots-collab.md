...
**From what data**: The 3-sector F_BCS from `computations/s29b_3sector_fbcs.npz`. The symmetry breaking pattern determines which generators become massive and which (if any) remain light.
...
**From what data**: Dirac eigenvalue data from computations/_shared (Sessions 7-12). The (1,1) sector eigenvalues at tau_frozen ~ 0.35-0.50 give M_X.
