...
| File | Computation |
|:-----|:-----------|
| `computations/s29a_tmatrix_extension.{py,npz,png}` | 29a-1 (T-matrix extension) |
| `computations/s29a_derived_drive_rate.{py,npz,png}` | 29a-2 (self-consistent drive) |
| `computations/s29a_entropy_balance.{py,npz,png}` | 29a-3 (entropy balance) |
| `computations/s29a_inter_sector_coupling.{py,npz,png}` | 29a-4 (inter-sector J_perp) |
| `computations/s29a_gate_verdicts.txt` | 29Aa gate verdicts |

### 29Ab
| File | Computation |
|:-----|:-----------|
| `computations/s29b_free_energy_comparison.{py,npz,png}` | 29b-1 (free energy comparison) |
| `computations/s29b_modulus_eom.{py,npz,png}` | 29b-2 (modulus EOM) |
| `computations/s29b_gaussian_correction.{py,npz,txt,png}` | 29b-3 (Gaussian fluctuation) |
| `computations/s29b_gate_verdicts.txt` | 29Ab + 29Ba + 29Bb gate verdicts |

### 29Ba
| File | Computation |
|:-----|:-----------|
| `computations/s29b_3sector_fbcs.{py,npz,png}` | 29B-1/29B-6 (3-sector + gradient balance) |
| `computations/s29b_pmns_extraction.{py,npz,png,txt}` | 29B-2 (PMNS extraction) |

### 29Bb
| File | Computation |
|:-----|:-----------|
| `computations/s29b_jensen_transverse.{py,npz,png,txt}` | 29B-4 (Jensen 5D Hessian) |
| `computations/s29b_bogoliubov_bcs.{py,npz,png,txt}` | 29B-3 (Bogoliubov BCS gap) |
| `computations/s29b_josephson_coupling.{py,npz,png,txt}` | 29B-5 (Josephson coupling) |

### 29Ac
| File | Computation |
|:-----|:-----------|
| `computations/s29c_gibbons_hawking_temperature.{py,npz,png}` | 29c-1 (Bogoliubov spectrum) |
| `computations/s29c_k_transition.{py,npz,png}` | 29c-2 (k_transition) |
| `computations/s29c_cdl_bounce.{py,npz,png}` | 29c-3 (CDL bounce) |
| `computations/s29c_gw_spectrum.{py,npz,png}` | 29c-4 (GW spectrum) |
| `computations/s29c_gate_verdicts.txt` | 29Ac gate verdicts |
