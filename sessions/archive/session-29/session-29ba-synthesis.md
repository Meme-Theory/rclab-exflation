...
| File | Description |
|:-----|:-----------|
| `computations/s29b_3sector_fbcs.py` | 3-sector F_BCS computation + gradient balance |
| `computations/s29b_3sector_fbcs.npz` | Full results: F_3sect grid, Hessians, gradient balance |
| `computations/s29b_3sector_fbcs.png` | 3-panel plot: F_3sect(tau), fraction, gradient balance |
| `computations/s29b_pmns_extraction.py` | PMNS extraction (Methods B and C) |
| `computations/s29b_pmns_extraction.npz` | Full results: mixing angles, eigenvalues, U matrices |
| `computations/s29b_pmns_extraction.png` | 4-panel diagnostic: theta_13, theta_12, theta_23, R vs tau |
| `computations/s29b_pmns_extraction.txt` | Human-readable results summary |
| `computations/s29b_gate_verdicts.txt` | Gate verdicts (appended to 29Ab verdicts) |
