...
|:-------|:-----------|:-------|
| `computations/s31Ba_kapitza_gate.py` | K-1 Kapitza computation script | COMPLETE |
| `computations/s31Ba_kapitza_gate.npz` | V_Kapitza data for all amplitudes | COMPLETE |
| `computations/s31Ba_kapitza_gate.png` | V_Kapitza plot (all A values + static reference) | COMPLETE |
| `computations/s31Ba_instanton_kapitza.py` | I-1 instanton frequency script | COMPLETE |
| `computations/s31Ba_instanton_kapitza.npz` | Instanton action, tunneling rate, frequency ratio | COMPLETE |
| `computations/s31Ba_instanton_kapitza.png` | Instanton frequency ratio plot | COMPLETE |
| `computations/s31Ba_nck_tau021.py` | B-31nck compatibility script | COMPLETE |
| `computations/s31Ba_nck_tau021.npz` | Lambda_SA/M_KK data at tau~0.21 | COMPLETE |
| `computations/s31Ba_gate_verdicts.txt` | Gate verdict log (K-1, I-1, B-31nck) | COMPLETE |
...
|:-----|:-----|:---------|:--------|
| `computations/s31Ba_kapitza_gate.py` | 1 | sim | K-1 Kapitza computation script |
| `computations/s31Ba_kapitza_gate.npz` | 1 | sim | V_Kapitza data, all amplitudes, both T3/T4 |
| `computations/s31Ba_kapitza_gate.png` | 1 | sim | 4-panel plot: V_Kapitza at T3/T4, correction term, gradient comparison |
| `computations/s31Ba_instanton_kapitza.py` | 2 | sim | I-1 instanton frequency script |
| `computations/s31Ba_instanton_kapitza.npz` | 2 | sim | S_inst, Gamma_inst, omega_tau, frequency ratio |
| `computations/s31Ba_instanton_kapitza.png` | 2 | sim | 4-panel plot: action, tunneling rate, modulus frequency, gate ratio |
| `computations/s31Ba_nck_tau021.py` | 3 | sim | B-31nck compatibility script |
| `computations/s31Ba_nck_tau021.npz` | 3 | sim | Lambda_SA, M_KK, ratio, coupling data at tau=0.21 |
| `computations/s31Ba_gate_verdicts.txt` | -- | coord | Gate verdict log (K-1, I-1, B-31nck) |
