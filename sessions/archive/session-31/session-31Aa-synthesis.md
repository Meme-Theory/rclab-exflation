...
**Files**: `computations/s31alt_spectral_dimension.npz`, `computations/s31alt_spectral_dimension.png`. Runtime: 40.8s.
...
**Files**: `computations/s31alt_cc_ratio.npz`, `computations/s31alt_cc_ratio.png`. Runtime: 0.2s.
...
**Files**: `computations/s31alt_orientation_test.npz`. Runtime: 57.8s.
...
**Files**: `computations/s31alt_3form_potential.npz`, `computations/s31alt_3form_potential.png`. Runtime: 0.2s.
...
**Source documents**: `computations/s31alt_order_one_severity.npz`, `sessions/session-31/session-31-order-one-assessment.md`. Runtime: 314.6s.
...
**Files**: `computations/s31a_nck_tau021.npz`. Runtime: < 1s.
...
|:-----|:-----|:---------|:--------|
| `computations/s31alt_spectral_dimension.npz` | BA-31-1 | sim | Eigenvalues, P(t), d_s(t) at 4 tau |
| `computations/s31alt_spectral_dimension.png` | BA-31-1 | sim | d_s(t) diagnostic plot |
| `computations/s31alt_cc_ratio.npz` | BA-31-2 | sim | a_0/a_2 ratio at 441 grid points |
| `computations/s31alt_cc_ratio.png` | BA-31-2 | sim | CC ratio landscape plot |
| `computations/s31alt_orientation_test.npz` | BA-31-3 | sim | Eigenvalue comparison, 4 tau |
| `computations/s31alt_3form_potential.npz` | BA-31-4 | sim | \|omega_3\|^2, V_FR at 9 tau |
| `computations/s31alt_3form_potential.png` | BA-31-4 | sim | V_spec vs V_FR comparison plot |
| `computations/s31alt_order_one_severity.npz` | BA-31-6 | sim | Random matrix comparison, 100 trials |
| `computations/s31a_nck_tau021.npz` | BA-31-7 | sim | Lambda_SA/M_KK at tau=0.21 |
...
| `computations/s31Aa_gate_verdicts.txt` | All | coord | Gate verdicts (this session) |
