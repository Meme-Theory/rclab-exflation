...
Script: `computations/kk1_bosonic_tower.py`
Data: `computations/kk1_bosonic_spectrum.npz`
...
Script: `computations/b6_scalar_vector_laplacian.py`
...
Script: `computations/c1_seeley_dewitt_convergence.py`
...
Script: `computations/h5_standalone_verify.py` (standalone, zero agent imports)
Plot: `computations/h5_standalone_verify.png`
...
| File | Description |
|:-----|:------------|
| `computations/h5_standalone_verify.py` | Standalone V_eff (zero agent imports, GPU) |
| `computations/h5_standalone_verify.png` | 4-panel plot |
| `computations/h5_full_veff.py` | Original H-5 script (vector double-counting fixed) |
| `computations/h5_production_run.py` | Production sweep script (updated summaries) |
| `computations/kk1_bosonic_tower.py` | Full bosonic KK tower (KK-Theorist) |
| `computations/kk1_bosonic_spectrum.npz` | Pre-computed spectra at 4 s-values |
| `computations/b6_scalar_vector_laplacian.py` | Scalar/vector Laplacians (Baptista) |
| `computations/c1_seeley_dewitt_convergence.py` | SD convergence assessment (Connes) |
