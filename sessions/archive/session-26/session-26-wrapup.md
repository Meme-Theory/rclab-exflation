...
|:-----|:---------------|:------------|:----------|:-------|
| S26 | P2 (Cooling trajectory) | OPEN | **CLOSED** | 184/184 trajectories fail to lock tau. Three independent closure mechanisms (timescale separation, gradient alignment, T >> T_c). |
| S26 | P3 (a_6 Seeley-DeWitt) | OPEN | **CLOSED** | Zero minima for sigma >= 0 across 10,100-point scan. All Seeley-DeWitt coefficients monotonically increasing on Jensen deformations -- closes perturbative spectral action to ALL orders. |
| S26 | P2-LOCK gate | OPEN | **CLOSED** | 0/184 trajectories produce sustained lock. Zero exceptions. |
| S26 | B-1 persistence under a_6 gate | OPEN | **CLOSED** | Zero minima for sigma >= 0 across 10,100-point (rho, sigma) scan |
| S26 | Perturbative spectral action potential | OPEN | **CLOSED** | Closed at ALL orders (P3 monotonicity theorem). Do not revisit. |
| S26 | Singlet-only BCS cooling | OPEN | **CLOSED** | Closed (P2, 184/184 CLOSED). Do not re-run with different parameters. |
| S26 | No-boundary mu selection | OPEN | **CLOSED** | Retracted by its proponent. Closed. |
| S26 | GSL balance sheet | OPEN | **CLOSED** | Retracted by its proponent. Closed. |
| S26 | B-1 Kerner bridge at a_4 truncation | OPEN | **CLOSED** | Destroyed by a_6 (P3). The minimum was a truncation artifact. |
