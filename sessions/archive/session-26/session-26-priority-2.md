...
**Script**: `computations/s26_p2_cooling_trajectory.py`
**Design Doc**: `computations/s26_p2_cooling_design.md`
**Output Data**: `computations/s26_p2_cooling_trajectory.npz` (194 KB)
**Output Plot**: `computations/s26_p2_cooling_trajectory.png` (261 KB)
...
#   computations/s24a_vspec.npz        (V_spec potential)
#   computations/s26_multimode_bcs.npz  (P1 BCS data)
#   computations/s22a_slow_roll.npz     (moduli metric)

# Run the computation
"phonon-exflation-sim/.venv312/Scripts/python.exe" computations/s26_p2_cooling_trajectory.py

# Output:
#   computations/s26_p2_cooling_trajectory.npz  (194 KB)
#   computations/s26_p2_cooling_trajectory.png  (261 KB)
