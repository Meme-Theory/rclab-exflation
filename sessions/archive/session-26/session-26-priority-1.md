...
**Script**: `computations/s26_multimode_bcs.py`
**Output Data**: `computations/s26_multimode_bcs.npz` (100.7 KB)
**Output Plot**: `computations/s26_multimode_bcs.png`
**Runtime**: 0.7 seconds
...
"phonon-exflation-sim/.venv312/Scripts/python.exe" computations/s26_multimode_bcs.py

# Required input files:
#   computations/s23a_kosmann_singlet.npz
#   computations/s23a_gap_equation.npz
```
