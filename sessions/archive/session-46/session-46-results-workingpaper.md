...
**Files**: `computations/s46_qtheory_selfconsistent.py`, `.npz`, `.png`
...
**Files**: `computations/s46_hose_count.py`, `computations/s46_hose_count.npz`, `computations/s46_hose_count.png`
...
- Plot: `computations/s46_zubarev_derivation.png`
...
**Files**: `computations/s46_spectral_flow_ns.py`, `computations/s46_spectral_flow_ns.npz`, `computations/s46_spectral_flow_ns.png`
...
**Files**: `computations/s46_quasistatic_ns.py`, `.npz`, `.png`
...
**Files**: `computations/s46_omega_classify.py`, `.npz`, `computations/s46_omega_verify.py`
...
**Files**: `computations/s46_gpv_fragmentation.py`, `.npz`, `.png`
...
**Files**: `computations/s46_twist_bdg.{py,npz,png}`
...
**Files**:
- Script: `computations/s46_max_pq_sum_4.py`
- Data: `computations/s46_max_pq_sum_4.npz`
- Plot: `computations/s46_max_pq_sum_4.png`
...
**Files**:
- Script: `computations/s46_v_b3b3.py`
- Data: `computations/s46_v_b3b3.npz`
- Plot: `computations/s46_v_b3b3.png`
...
**Files**:
- Script: `computations/s46_landau_zener_ns.py`
- Data: `computations/s46_landau_zener_ns.npz`
- Plot: `computations/s46_landau_zener_ns.png`
...
**Script**: `computations/s46_berry_phase.py`
**Data**: `computations/s46_berry_phase.npz`
**Plot**: `computations/s46_berry_phase.png`
...
**Data**: `computations/s46_anomalous_dispersion.{py,npz,png}`
...
**Data**: `computations/s46_fwd_bwd_ns.{py,npz,png}`
...
#### Files
- Script: `computations/s46_nonsinglet_dissipation.py`
- Data: `computations/s46_nonsinglet_dissipation.npz`
- Plot: `computations/s46_nonsinglet_dissipation.png`
...
**Files**:
- Script: `computations/s46_fabric_tessellation.py`
- Data: `computations/s46_fabric_tessellation.npz`
- Plot: `computations/s46_fabric_tessellation.png`
...
- Script: `computations/s46_bayesian_gp.py`
- Data: `computations/s46_bayesian_gp.npz`
- Plot: `computations/s46_bayesian_gp.png`
...
**Data files**: `s46_multi_jacobson.{py,npz,png}` in `computations/`
...
#### Files
- Script: `computations/s46_three_freq_universe.py`
- Data: `computations/s46_three_freq_universe.npz`
- Plot: `computations/s46_three_freq_universe.png`
...
**Data**: `computations/s46_dissolution_singlet.{py,npz,png}`
...
**Data**: `computations/s46_peter_weyl_censorship.{py,npz,png}`
...
**Data**: `computations/s46_gcm_zero_point.{py,npz,png}`
...
**Data**: `computations/s46_spectral_form_factor.{py,npz,png}`
...
**Files**: `computations/s46_sa_omega_tau.{py,npz,png}`
...
**Data**: `computations/s46_spectral_zeta_nonint.{py,npz,png}`
...
**Data**: `computations/s46_phonon_magnetic_moment.{py,npz,png}`
...
**Files**:
- Script: `computations/s46_kapitza_parametric.py`
- Data: `computations/s46_kapitza_parametric.npz`
- Plot: `computations/s46_kapitza_parametric.png`
...
**Data**: `computations/s46_bekenstein_torsion.{py,npz}`
...
**Data**: `computations/s46_gsl_qtheory.{py,npz,png}`
...
**Data**: `computations/s46_transplanckian.{py,npz,png}`
...
|:-----|:---------------|:------------|:----------|:-------|
| S46 | Quasi-static inflation at q-theory equilibrium (QUASISTATIC-NS-46) | OPEN | **CLOSED** | Three independent obstructions: No capture (KE/PE ~ 10^{11}), Virial obstruction (<eps_H> = 3/2 for harmonic well), Planck exclusion (quadratic potential gives n_s = 0.80 at N_e = 60, excluded at >10 sigma). |
| S46 | "Number projection might increase Delta_B3 above 0.13" (NUMBER-PROJECTED-BCS-46) | OPEN | **CLOSED** | It does the opposite: Delta_B3 drops from 0.084 (BCS) to 0.054 (PBCS). |
| S46 | "Hose count" alpha exponent as a path to n_s (GPV-FRAGMENTATION-46) | OPEN | **CLOSED** | Three independent measurements (W1-2 counting, W2-2 spectral function, W3-1 fragmentation) all confirm no power-law scaling. |
| S46 | Twist route to Lorentzian signature from internal BCS (TWIST-BDG-46) | OPEN | **CLOSED** | The twist route to Lorentzian signature from internal BCS is CLOSED for A_F acting diagonally in Nambu space (32nd closure). |
| S46 | GGE beat -> 4D transfer function as an n_s mechanism (TRANSFER-FUNCTION-46) | OPEN | **CLOSED** | Three structural suppressions (f_s, energy ratio, timescale hierarchy) combine to give delta(n_s - 1) = 1.8e-7, which is 5e-6 of the needed -0.035. No parameter adjustment can overcome the 5-order-of-magnitude shortfall because each suppression factor is determined by established structural results (EIH-GRAV-44, S_fold, H_fold). |
| S46 | Tessellation route to alpha = 1 (FABRIC-TESSELLATION-46) | OPEN | **CLOSED** | The tessellation route to alpha = 1 is CLOSED by the scale hierarchy k_BdG << k_c. |
| S46 | "GCM zero-point might shift tau* from 0.209 to 0.190" (GCM-ZERO-POINT-46) | OPEN | **CLOSED** | The BCS state has no soft mode in the tau coordinate. tau* uncertainty is dominated by gap model choice (BAYESIAN-GP-46: sigma = 0.117), not by quantum zero-point motion. |
| S46 | Parametric amplification of tau modulus by GGE beats (KAPITZA-PARAMETRIC-46) | OPEN | **CLOSED** | Structural reason: 52-317x frequency mismatch; Arnold tongues at these subharmonic orders narrower than 10^{-100}; adiabatic regime (Omega/omega << 1). |
| S46 | SU(2,1) as DIRECT replacement for SU(3) (PSEUDO-RIEMANNIAN-46) | OPEN | **CLOSED** | SU(2,1) as DIRECT replacement for SU(3) is CLOSED. Three obstructions: compact resolvent (FATAL), [J, D] nonvanishing (2.72), spectral action IR divergence (Vol(SU(2,1)) = infinity). |
