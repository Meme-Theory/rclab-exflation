...
- `computations/s46_hose_count.py` (W1-2)
- `computations/s46_rg_pair_transfer.py` (W2-2)
- `computations/s46_gpv_fragmentation.py` (W3-1)
- `computations/s46_v_b3b3.py` (V-B3B3-46)
- `computations/s46_max_pq_sum_4.py` (W3-6)
- `computations/s46_berry_phase.py` (W4-2)
- `computations/s46_spectral_form_factor.py` (W4-13)
