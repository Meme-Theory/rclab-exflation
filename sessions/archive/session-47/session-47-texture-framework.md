...
**Source data**:
- `computations/s47_texture_corr.npz` (TEXTURE-CORR-48 data)
- `computations/s47_texture_corr.py` (computation script)
- `computations/s47_texture_corr.png` (6-panel figure)
