...
**Format**: Python script using existing infrastructure in `dirac_spectrum.py`. Input: V matrix elements from `s39_integrability_check.npz`. Output: sector-resolved gaps and self-consistency check.
