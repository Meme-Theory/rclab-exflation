...
- **What**: Modify `collect_spectrum` in `dirac_spectrum.py` to retain eigenvectors
...
### Level 1 — Pre-Registered Gates (must execute)
...
### Level 2 — High-Priority Carry-Forwards
...
### Level 3 — Topological and Berry Phase (from S46, all unexecuted)
...
### Level 5 — Paasch, String, QA (unexecuted S46 backlog)
...
### Level 6 — Deeper Investigations (longer-term)

25. **Dirac eigenvector retention** (B-6) — modify code, Chladni patterns
