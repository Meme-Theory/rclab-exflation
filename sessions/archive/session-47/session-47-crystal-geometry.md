...
The current Peter-Weyl computation (collect_spectrum in dirac_spectrum.py) discards eigenvectors. Modifying it to retain and analyze eigenvectors would close the loop between the spectral landscape and the condensate structure, answering whether the crystal's vibration patterns are correlated with its order parameter profile.
...
**Data files examined**:
- `computations/s47_condensate_torus.npz`
- `computations/s47_curvature_anatomy.npz`
- `computations/s47_spectral_landscape.npz`

**Plots examined**:
- `computations/s47_condensate_torus.png`
- `computations/s47_condensate_torus_analysis.png`
- `computations/s47_condensate_torus_haar.png`
- `computations/s47_condensate_torus_characters.png`
- `computations/s47_curvature_anatomy.png`
- `computations/s47_spectral_landscape.png`
