...
- Script: `computations/s42_gradient_stiffness.py`
- Data: `computations/s42_gradient_stiffness.npz`
- Plot: `computations/s42_gradient_stiffness.png`
...
**Script**: `computations/s42_giant_voronoi.py`
**Data**: `computations/s42_giant_voronoi.npz`
**Plot**: `computations/s42_giant_voronoi.png`
...
| File | Description |
|:-----|:------------|
| `computations/s42_hauser_feshbach.py` | Computation script |
| `computations/s42_hauser_feshbach.npz` | All numerical results |
| `computations/s42_hauser_feshbach.png` | 4-panel diagnostic plot |
...
| File | Description |
|:-----|:------------|
| `computations/s42_fabric_dispersion.py` | Computation script |
| `computations/s42_fabric_dispersion.npz` | All numerical results |
| `computations/s42_fabric_dispersion.png` | 4-panel diagnostic (tau dispersion, BdG dispersion, m_tau vs tau, group velocity) |
...
| File | Description |
|:-----|:------------|
| `computations/s42_tau_dyn_reopening.py` | Computation script |
| `computations/s42_tau_dyn_reopening.npz` | All numerical results |
| `computations/s42_tau_dyn_reopening.png` | 4-panel diagnostic plot |
...
| File | Description |
|:-----|:------------|
| `computations/s42_coupled_doorway.py` | Computation script |
| `computations/s42_coupled_doorway.npz` | All numerical results |
| `computations/s42_coupled_doorway.png` | 6-panel diagnostic (DR vs delta_tau, preference, Fano |q|, coupled spectrum, channel suppression, interface modes) |
...
| File | Description |
|:-----|:------------|
| `computations/s42_fabric_wz_v2.py` | REDO #2: correct epoch-matched computation |
| `computations/s42_fabric_wz_v2.npz` | All numerical results |
| `computations/s42_fabric_wz_v2.png` | 4-panel plot (w(z), energy hierarchy, parameter scan, three estimates vs M_KK) |
| `computations/s42_fabric_wz.py` | REDO #1 (superseded, epoch-mixing error) |
| `computations/s42_fabric_wz.npz` | REDO #1 results (superseded) |
| `computations/s42_dark_energy_wz.py` | Original single-tau (superseded) |
...
| File | Description |
|:-----|:------------|
| `computations/s42_dm_profile.py` | Computation script |
| `computations/s42_dm_profile.npz` | All numerical results |
| `computations/s42_dm_profile.png` | 4-panel diagnostic (density profile, rotation curve, lensing, inner slope) |
...
- Script: `computations/s42_constants_snapshot.py`
- Data: `computations/s42_constants_snapshot.npz`
- Plot: `computations/s42_constants_snapshot.png`
...
- Script: `computations/s42_ns_tilt.py`
- Data: `computations/s42_ns_tilt.npz`
- Plot: `computations/s42_ns_tilt.png`
...
| File | Description |
|:-----|:------------|
| `computations/s42_gge_energy.py` | Computation script |
| `computations/s42_gge_energy.npz` | All numerical results (both M_KK routes) |
| `computations/s42_gge_energy.png` | 4-panel diagnostic (energy scales, eta vs n_breaks, timeline, sector branching) |
...
- `computations/s42_fabric_wz_v2.npz` (W3-1 REDO-2): w_0 = -1.0, w_a = -2.4e-29
...
**DESI DR2 dynamical DE (2.8-4.2 sigma for w != -1)** is the primary threat to the framework in this domain. If confirmed, it directly contradicts the framework's Level 4 prediction w = -1. The f*sigma_8(z) comparison above shows the framework (= LCDM) systematically overpredicts the growth rate relative to DESI, which is qualitatively consistent with the DESI DR2 w != -1 signal — both point to slower-than-LCDM growth. The framework has no mechanism to accommodate this without abandoning w = -1.

### Output Files

- Script: `computations/s42_s8_tension.py`
- Data: `computations/s42_s8_tension.npz`
- Plot: `computations/s42_s8_tension.png`
...
- Script: `computations/s42_polariton.py`
- Data: `computations/s42_polariton.npz`
- Plot: `computations/s42_polariton.png`
...
- Script: `computations/s42_kz_fnl.py`
- Data: `computations/s42_kz_fnl.npz`
- Plot: `computations/s42_kz_fnl.png`
...
- Script: `computations/s42_homogeneity.py`
- Data: `computations/s42_homogeneity.npz`
- Plot: `computations/s42_homogeneity.png`
