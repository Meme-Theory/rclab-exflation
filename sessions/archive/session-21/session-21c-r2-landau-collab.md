...
### 3.1 Landau Free Energy Classification (computation #20): Modified by delta_T > 0
...
### 3.2 Pomeranchuk Stability / BCS Channel Scan (Level 1 #9): Still Viable but Reframed
...
**Recommendation**: Level 1 #9 remains the highest-priority condensed matter computation. Promote to Level 1 #1 alongside the coupled V_IR.
...
1. **BCS/BEC channel scan** (Level 1 #9): Tests the non-perturbative pairing interaction directly. Independent of perturbative spectral sums.
...
4. **Higgs-sigma portal** (Connes, Level 1 #6): The cross-coupling lambda_{H sigma}(tau) is independent of spectral sums and could generate a combined V(H, sigma) minimum that V_eff(tau) alone does not possess.
