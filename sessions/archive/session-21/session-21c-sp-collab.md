...
This is a Level 2 computation flagged since Session 17b but not yet executed. The three-monopole structure makes it more urgent: the Petrov type may change AT the monopoles (where the eigenstate topology changes), providing a spectral/curvature correspondence.
