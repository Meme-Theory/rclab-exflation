...
The erratum establishes the physical window where the (0,0) singlet controls the gap edge. From Observable 2 in the CP-1 investigation (`computations/s21c_cp1_output.txt`), the sector crossings occur at:
...
### 3.1 Berry Curvature B_n(tau) Profile (Level 1 #3) -- Priority ELEVATED
...
### 3.2 Spectral Form Factor K(k) at Monopoles (computation #8) -- Still Informative
...
### 3.4 Low-Mode Level Statistics / Brody Parameter (computation #7) -- Still Viable
...
| File | Description |
|:-----|:-----------|
| `computations/s21c_cp1_output.txt` | CP-1 identity investigation output |
| `computations/s21c_cp1_investigation.npz` | CP-1 numerical data |
| `computations/s21c_T_double_prime_result.txt` | T''(0) = +7,969 |
