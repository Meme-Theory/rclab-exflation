...
**Leveled priors (Gen-Physicist / Paasch-Analyst consensus)**:
...
2. **Z_3 prior probability**: Gen-physicist gives 35-45% for 30% match; Paasch-analyst gives 25-35%. Difference reflects weighting of radiative correction effects on tree-level ratios. **NARROWED**: Both agree on leveled structure (pattern: ~50%, 30% match: ~30-40%, 5% Paasch-precise: ~10-20%). The ~10% spread reflects honest uncertainty about QCD/EM correction cancellation in ratio comparisons.
