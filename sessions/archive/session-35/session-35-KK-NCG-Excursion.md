...
|:--|:-----|:----|:------|:-------|:-------|:--------|
| 1 | Compute a₄ for D on M⁴×SU(3)_Jensen×F | connes-ncg-theorist + baptista | Papers 10,13-15,17 | Gauge coupling from full a₄ | computation script + .md | None |
...
|:-----|:-------|:------------|
| `computations/s33a_rge_gate_corrected.py` | CREATED | Corrected RGE computation with √3 and non-GUT betas |
| `computations/s33a_rge_gate_corrected.{npz,png}` | CREATED | Data and plot |
| `computations/s36_kk_ncg_bridge.py` | CREATED | Bridge theorem computation |
| `computations/s36_kk_ncg_bridge.npz` | CREATED | Bridge theorem data |
| `computations/s33a_gate_verdicts.txt` | MODIFIED | RGE-33a verdict corrected |
