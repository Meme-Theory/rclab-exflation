...
| File | Content |
|:-----|:--------|
| `computations/s35_thouless_multiband.py` | Computation script |
| `computations/s35_thouless_multiband.npz` | All numerical results |
| `computations/s35_thouless_multiband.png` | 4-panel diagnostic plot |
...
**Data files**:
- Script: `computations/s35_ed_corrected_dos.py`
- Data: `computations/s35_ed_corrected_dos.npz`
- Plot: `computations/s35_ed_corrected_dos.png`
...
**Data files:**
- Script: `computations/s35_rg_bcs_flow.py`
- Data: `computations/s35_rg_bcs_flow.npz`
- Plot: `computations/s35_rg_bcs_flow.png`
...
**Data files**:
- Script: `computations/s35_k7_thouless.py`
- Data: `computations/s35_k7_thouless.npz`
- Plot: `computations/s35_k7_thouless.png`
...
**Data files**:
- Script: `computations/s35_vh_sensitivity.py`
- Data: `computations/s35_vh_sensitivity.npz`
- Plot: `computations/s35_vh_sensitivity.png`
...
**Data files**:
- Script: `computations/s35_b2_coherence.py`
- Data: `computations/s35_b2_coherence.npz`
- Plot: `computations/s35_b2_coherence.png`
...
**Data files**:
- Script: `computations/s35_impedance_wavematch.py`
- Data: `computations/s35_impedance_wavematch.npz`
- Plot: `computations/s35_impedance_wavematch.png`
...
**Data files**:
- Script: `computations/s35_sector_10_spectrum.py`
- Data: `computations/s35_sector_10_spectrum.npz`
- Plot: `computations/s35_sector_10_spectrum.png`
...
| File | Content |
|:-----|:--------|
| `computations/s35_pmns_corrected.py` | Computation script (101-point Delta scan, multi-tau, factor scans) |
| `computations/s35_pmns_corrected.npz` | All numerical results (R, angles, factor scans vs Delta_B2) |
| `computations/s35_pmns_corrected.png` | 6-panel diagnostic plot (R, sin2_13, theta_23, mixing, levels, R vs V12) |
...
| File | Content |
|:-----|:--------|
| `computations/s35_poschl_teller.py` | Computation script |
| `computations/s35_poschl_teller.npz` | All numerical results |
| `computations/s35_poschl_teller.png` | 4-panel diagnostic plot |
...
- `computations/s35_thouless_multiband.npz`: M_max = 1.674, N_eff_min = 2.48, PR = 6.36. CONFIRMED.
- `computations/s35_ed_corrected_dos.npz`: E_cond = -0.115, vacuum_overlap = 0.0. CONFIRMED.
- `computations/s35_rg_bcs_flow.npz`: g_bare = 0.801, Landau pole at mu*/W = 0.287. CONFIRMED.
- `computations/s35_vh_sensitivity.npz`: M_global range [3.13, 3.48], 5/5 PASS. CONFIRMED.
- `computations/s35_b2_coherence.npz`: C_min = 0.99997. CONFIRMED.
...
| File | Content |
|:-----|:--------|
| `computations/s35_spectral_entropy.py` | Computation script |
| `computations/s35_spectral_entropy.npz` | All numerical results (S, tau, betas, gate data) |
| `computations/s35_spectral_entropy.png` | 4-panel diagnostic plot |
...
| File | Description |
|:------|:-------------|
| `computations/s35_pfaffian_corrected_j.py` | Computation script |
| `computations/s35_pfaffian_corrected_j.npz` | Numerical results (34 tau values) |
...
**Files**: `computations/s35_k7_dphys.py`, `computations/s35_k7_dphys.npz`, `computations/s35_k7_dphys.png`
...
**Files**: `computations/s35_specificity_su2su2.py`, `computations/s35_specificity_su2su2.npz`, `computations/s35_specificity_su2su2.png`
...
**Script**: `computations/s35_optical_theorem.py`
**Data**: `computations/s35_optical_theorem.npz`
...
Scripts: 16 Python scripts in `computations/s35_*.py`
Data: 16 .npz files in `computations/s35_*.npz`
Plots: ~12 .png files in `computations/s35_*.png`
...
| File | Agent | Content |
|:-----|:------|:--------|
| `computations/s35_vh_sensitivity.py` | gen-physicist | VH-SENS-35 computation script |
| `computations/s35_vh_sensitivity.npz` | gen-physicist | VH-SENS-35 data (M_max at 5 tau points, rho, V, E) |
| `computations/s35_vh_sensitivity.png` | gen-physicist | VH-SENS-35 3-panel plot (dispersion, M_max, local DOS) |
| `computations/s35_ed_corrected_dos.py` | quantum-acoustics | ED-CORRECTED-35 computation script |
| `computations/s35_ed_corrected_dos.npz` | quantum-acoustics | ED-CORRECTED-35 data (4 scenarios + cross-check + BMF) |
| `computations/s35_ed_corrected_dos.png` | quantum-acoustics | ED-CORRECTED-35 4-panel plot (E_cond, chi_pp, spectrum, pair occ) |
| `computations/s35_b2_coherence.py` | gen-physicist | COH-35 computation script |
| `computations/s35_b2_coherence.npz` | gen-physicist | COH-35 data (overlap matrices, coherence fractions, gap functions) |
| `computations/s35_b2_coherence.png` | gen-physicist | COH-35 4-panel plot (coherence, M_max, SVD, heatmap) |
| `computations/s35_pmns_corrected.py` | neutrino | PMNS-CORRECTED-35 computation script (101-pt Delta scan, multi-tau, factor scans) |
| `computations/s35_pmns_corrected.npz` | neutrino | PMNS-CORRECTED-35 data (R, angles, factor scans vs Delta_B2) |
| `computations/s35_pmns_corrected.png` | neutrino | PMNS-CORRECTED-35 6-panel diagnostic plot |
| `computations/s35_optical_theorem.py` | feynman | OPT-35 computation script (T-matrix, algebraic identity, diagonal OT) |
| `computations/s35_optical_theorem.npz` | feynman | OPT-35 data (T-matrices, violations, identity errors, DOS comparisons) |
