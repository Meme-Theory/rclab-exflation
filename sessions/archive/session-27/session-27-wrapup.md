...
**Data**: `computations/s27_torsion_gap_gate.npz`
**Plot**: `computations/s27_torsion_gap_gate.png`
...
**Script**: `computations/s27_multisector_bcs.py` (921 lines)
**Data**: `computations/s27_multisector_bcs.npz` (8.7 MB)
**Plot**: `computations/s27_multisector_bcs.png`
...
|:-----|:---------------|:------------|:----------|:-------|
| 2026-02-26 | K-1e universality (mu=0 BCS) | CLOSED (singlet only, S23a) | **CLOSED** | The mu=0 BCS CLOSED is universal across all 9 sectors (not singlet-specific); the spectral gap prevents BCS condensation at zero chemical potential for ALL representations with p+q <= 3. |
