...
|:-----|:-----------|:-----|
| `computations/s28a_bogoliubov_coefficients.py` | KC-1 script | PASS |
| `computations/s28a_bogoliubov_coefficients.npz` | KC-1 data | PASS |
| `computations/s28a_bogoliubov_coefficients.png` | KC-1 plot | PASS |
| `computations/s28a_thermal_spectral_action.py` | L-1 script | CLOSED |
| `computations/s28a_thermal_spectral_action.npz` | L-1 data | CLOSED |
| `computations/s28a_thermal_spectral_action.png` | L-1 plot | CLOSED |
| `computations/s28a_lichnerowicz_decomposition.py` | E-1 script | DIAGNOSTIC |
| `computations/s28a_lichnerowicz.npz` | E-1 data | DIAGNOSTIC |
| `computations/s28a_lichnerowicz.png` | E-1 plot | DIAGNOSTIC |
| `computations/s28a_spectral_action_comparison.py` | C-1 script | CLOSED |
| `computations/s28a_spectral_action_comparison.npz` | C-1 data | CLOSED |
| `computations/s28a_spectral_action_comparison.png` | C-1 plot | CLOSED |
| `computations/s28a_spectral_correlations.py` | C-4 script | DIAGNOSTIC |
| `computations/s28a_spectral_correlations.npz` | C-4 data | DIAGNOSTIC |
| `computations/s28a_spectral_correlations.png` | C-4 plot | DIAGNOSTIC |
| `computations/s28a_mmax_dispersion.py` | S-2 script | DIAGNOSTIC |
| `computations/s28a_mmax_dispersion.npz` | S-2 data | DIAGNOSTIC |
| `computations/s28a_mmax_dispersion.png` | S-2 plot | DIAGNOSTIC |
| `computations/s28a_torsionful_bcs.py` | E-4/S-1/L-4 script | MINOR PASS |
| `computations/s28a_torsionful_bcs.npz` | E-4/S-1/L-4 data | MINOR PASS |
| `computations/s28a_torsionful_bcs.png` | E-4/S-1/L-4 plot | MINOR PASS |
