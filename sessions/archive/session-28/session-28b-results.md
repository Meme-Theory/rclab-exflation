...
**Input data**: s27_multisector_bcs.npz, s27_torsion_gap_gate.npz, s28a_torsionful_bcs.npz, s28a_thermal_spectral_action.npz, dirac_spectrum.py, s22c_order_one.py infrastructure
...
|:-----|:-----------|:-----|
| `computations/s28b_order_one.py` | C-3 script | FAIL |
| `computations/s28b_order_one.npz` | C-3 data | FAIL |
| `computations/s28b_order_one.txt` | C-3 verdict | FAIL |
| `computations/s28b_relaxation_times.py` | L-3 script | PASS |
| `computations/s28b_relaxation_times.npz` | L-3 data | PASS |
| `computations/s28b_relaxation_times.png` | L-3 plot | PASS |
| `computations/s28b_pomeranchuk.py` | L-5 script | DIAGNOSTIC |
| `computations/s28b_pomeranchuk.npz` | L-5 data | DIAGNOSTIC |
| `computations/s28b_pomeranchuk.png` | L-5 plot | DIAGNOSTIC |
| `computations/s28b_quasiparticle_weight.py` | L-6 script | DIAGNOSTIC |
| `computations/s28b_quasiparticle_weight.npz` | L-6 data | DIAGNOSTIC |
| `computations/s28b_quasiparticle_weight.png` | L-6 plot | DIAGNOSTIC |
| `computations/s28b_cubic_invariant.py` | L-9 script | PASS |
| `computations/s28b_cubic_invariant.npz` | L-9 data | PASS |
| `computations/s28b_cubic_invariant.png` | L-9 plot | PASS |
| `computations/s28b_self_consistent_tau_T.py` | L-7 script | WEAK PASS |
| `computations/s28b_self_consistent_tau_T.npz` | L-7 data | WEAK PASS |
| `computations/s28b_self_consistent_tau_T.png` | L-7 plot | WEAK PASS |
| `computations/s28b_hessian.py` | S-3 script | PASS |
| `computations/s28b_hessian.npz` | S-3 data | PASS |
| `computations/s28b_hessian.txt` | S-3 verdict | PASS |
| `computations/s28b_lambda_eff.py` | E-5 script | DIAGNOSTIC |
| `computations/s28b_lambda_eff.txt` | E-5 estimate | DIAGNOSTIC |
| `computations/s28b_gate_verdicts.txt` | All gate verdicts | — |
