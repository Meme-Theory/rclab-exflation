...
|:-----|:---------------|:------------|:----------|:-------|
| S34 | MU-35a | OPEN | **CLOSED** | PH forces mu=0 in canonical spectral action |
| S34 | GC-35a | OPEN | **CLOSED** | Helmholtz F minimized at mu=0 (thermodynamic identity) |
...
| `sessions/session-34/session-34a-synthesis.md` | coord | Wave 1 synthesis |
| `sessions/session-34/session-34-synthesis.md` | team-lead | Session synthesis |
| `sessions/session-34/session-34-exploration-addendum.md` | team-lead | Framework exploration |
| `sessions/session-34/session-34-scratchpad.md` | team-lead | Investigation scratchpad |
| `sessions/session-34/session-34-*-collab.md` (×20) | 20 agents | Individual collabs |
| `sessions/session-34/session-34-*-workshop.md` (×3) | 6 agents | Three workshops |
