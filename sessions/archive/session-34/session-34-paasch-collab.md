...
**Concrete computation**: With the wall profile $\tau(x)$ from `computations/s33w3_modulus_equation.npz` and the B2 eigenvalue curvature $a_2 = 0.588$ at $\tau_0 = 0.190$, construct the effective Poschl-Teller potential:
