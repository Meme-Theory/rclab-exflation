...
**Gate verdicts**: computations/s34a_gate_verdicts.txt (5/5 computed), s35a results (3 gates)
...
| `computations/s34a_dphys_thouless.{py,npz,png}` | bap | Thouless criterion (DPHYS-34a-3) |
...
| `computations/s35a_mu_physical_basis.{py,npz,png}` | connes | Canonical μ = 0 proof |
