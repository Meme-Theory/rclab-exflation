...
**Estimated difficulty**: Moderate. Requires computing D_K with a spatially modulated tau, which is a tensor product of internal and 4D components. The conceptual framework exists (Kaluza-Klein reduction with spatially varying modulus) but has not been implemented in computation.
