...
**Level 1:** Compute Dirac spectrum on Baptista's SU(3); run Monte Carlo on Paasch spiral.
**Level 2:** Paper revision (CMB, dark matter, Baptista claims, Bell/KS, G(t)).
**Level 3:** Simulation scaling (after Level 1 result).
...
**Level 2 -- Paper revision (parallel):**
