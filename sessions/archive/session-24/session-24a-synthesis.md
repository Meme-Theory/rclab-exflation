...
| File | Producer |
|:-----|:---------|
| `computations/s24a_vspec.py` | phonon-sim |
| `computations/s24a_vspec.npz` | phonon-sim |
| `computations/s24a_vspec.png` | phonon-sim |
| `computations/s24a_berry.py` | phonon-sim |
| `computations/s24a_berry.npz` | phonon-sim |
| `computations/s24a_berry.png` | phonon-sim |
| `computations/s24a_neutrino.py` | phonon-sim |
| `computations/s24a_neutrino.txt` | phonon-sim |
| `computations/s24a_eigenvalue_ratios.py` | phonon-sim |
| `computations/s24a_eigenvalue_ratios.npz` | phonon-sim |
| `computations/s24a_eigenvalue_ratios.png` | phonon-sim |
| `computations/s24a_gate_verdicts.txt` | coordinator |
