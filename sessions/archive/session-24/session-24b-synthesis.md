...
|:-----|:---------------|:------------|:----------|:-------|
| 2026-02-21 | V-1 (V_spec Monotone) | OPEN | **CLOSED** | Monotonically increasing, all rho in [0.001, 0.5]. a_4/a_2 = 1000:1. |
| S17a | V_tree minimum | OPEN | **CLOSED** | Monotonically decreasing |
| S18 | 1-loop Coleman-Weinberg | OPEN | **CLOSED** | Monotonic, F/B = 8.4:1 (Trap 1) |
| S19d | Casimir scalar + vector | OPEN | **CLOSED** | Constant-ratio trap |
| S20a | Seeley-DeWitt a_2/a_4 | OPEN | **CLOSED** | Both monotonic |
| S20b | Casimir with TT 2-tensors | OPEN | **CLOSED** | Constant-ratio trap (F/B = 0.55) |
| S17c | D_K Pfaffian Z_2 | OPEN | **CLOSED** | No sign change |
| S19a | Perturbative fermion condensate | OPEN | **CLOSED** | No attractive channel |
| S19b | Single-field slow-roll | OPEN | **CLOSED** | eta >> 1 everywhere |
| S21a | Connes 8-cutoff positive sums | OPEN | **CLOSED** | All monotonic, AM-GM proof |
| S21a | V''_total spinodal | OPEN | **CLOSED** | V'' > 0 everywhere |
| S21c | S_signed gauge-threshold | OPEN | **CLOSED** | Monotonic, Trap 2 algebraic |
| S22b | Coupled delta_T crossing | OPEN | **CLOSED** | Block-diagonal exactly |
| S22b | Coupled V_IR minimum | OPEN | **CLOSED** | Block-diagonal exactly |
| S22c | Higgs-sigma portal | OPEN | **CLOSED** | Exactly constant (Trap 3) |
| S22d | Rolling modulus quintessence | OPEN | **CLOSED** | Clock closure, 15,000x violation |
| S23a | Kosmann-BCS condensate (mu=0) | OPEN | **CLOSED** | M_max 6.5-12.9x below threshold |
| S23a | Gap-edge self-coupling | OPEN | **CLOSED** | V(gap,gap) = 0 exactly |
| S24a | V_spec(tau; rho) monotone | OPEN | **CLOSED** | Monotonically increasing, all rho. a_4/a_2 = 1000:1. |
