...
**Output data**: `computations/s25_landau_results.npz`
**Computation script**: `computations/s25_landau_results.py`
...
|---|---|---|
| #1: Graded multi-sector sum (Level 1) | Resolved chirality grading. Computed S_eff. | S_eff MONOTONE. F(tau;beta) non-monotone at high beta. |
...
1. `computations/s25_landau_results.py` -- Computation script (10 computations, 726 lines)
2. `computations/s25_landau_results.npz` -- All numerical results (F_matrix, Z_matrix, zeta_matrix, F_therm, S_spec, T_c, lambda_min_vals, Landau coefficients, S_eff arrays)
