...
This is a Level 3 theoretical development but it addresses the deepest question: HOW does the internal geometry imprint on 4D physics? The answer from the island formula is: through entanglement, not through coupling.
...
- If all Level 1 goals fail: 5-8%. Mathematical monument, no physical mechanism. Approaching the Kepler-solids floor.

**Expected posterior from pursuing all Level 1 goals**: ~14%.
