...
**Computation script**: `computations/s25_sp_results.py`
**Results saved**: `computations/s25_sp_results.npz`
...
| **[SP]S-5** | Twistor correspondence | Deferred (Level 3 theoretical) | **DEFERRED.** |
...
|:-----|:-------|:-------|:----------------------|
| [SP]S-5 Twistor correspondence | DEFERRED | Level 3 theoretical. Not computable this session. | LOW |
