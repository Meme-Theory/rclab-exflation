...
**Results Saved**: `computations/s25_feynman_results.npz`
...
|-------------|----------|--------------|
| `computations/s25_feynman_results.npz` | F-1 through F-6 numerical results | `s23a_eigenvectors_extended.npz` |
