...
**Script**: `computations/s25_hawking_computations.py`
**Plot**: `computations/s25_hawking_computations.png`
**Data source**: `computations/s23a_eigenvectors_extended.npz` (11,424 eigenvalues, 28 sectors, 9 tau values)
**Runtime**: 1.3 seconds
