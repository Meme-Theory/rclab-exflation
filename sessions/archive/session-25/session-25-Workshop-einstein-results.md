...
**Computation script**: `computations/s25_einstein_results.py`
**Results saved**: `computations/s25_einstein_results.npz`
...
*References: Einstein (Papers 05, 06, 07, 08, 10 in `researchers/Einstein/`). Kerner (Paper 06 in `researchers/Kaluza-Klein/`). Gilkey, Seeley-DeWitt heat kernel theory. Computation script: `computations/s25_einstein_results.py`. Results data: `computations/s25_einstein_results.npz`.*
