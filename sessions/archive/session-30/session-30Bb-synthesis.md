...
**Gate verdicts**: `computations/s30b_gate_verdicts.txt` (30Ba + 30Bb combined)
...
| File | Contents |
|:-----|:---------|
| `computations/s30b_full_spectrum.py` | Step 3 script (N_max=6, both candidates) |
| `computations/s30b_full_spectrum.npz` | Full eigenvalue data |
| `computations/s30b_full_spectrum_results.txt` | Detailed computation log |
| `computations/s30b_rge_running.npz` | RGE curves + NCG-KK analysis |
| `computations/s30b_rge_running.png` | RGE visualization |
| `computations/s30b_t1_extension.txt` | T1 grid extension (negative result) |
| `computations/s30b_gate_verdicts.txt` | Combined 30Ba + 30Bb verdicts |
