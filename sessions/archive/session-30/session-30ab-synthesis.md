...
**Output files**: `computations/s30a_dtotal_pfaffian.py`, `computations/s30a_dtotal_pfaffian.npz`, `computations/s30a_gate_verdicts.txt` (appended)
...
**Combined 30Aa + 30Ab permanent structural findings**: 8 total (5 from 30Aa + 3 from 30Ab). See `computations/s30a_gate_verdicts.txt` for the complete list.
...
|:-----|:---------|:--------|:-------|
| `computations/s30a_dtotal_pfaffian.py` | phonon-sim | Pfaffian scan script | COMPLETE |
| `computations/s30a_dtotal_pfaffian.npz` | phonon-sim | Pfaffian data (tau, signs, gaps, norms) | COMPLETE |
| `computations/s30a_gate_verdicts.txt` | coordinator | Gate verdicts (30Aa + 30Ab appended) | COMPLETE |
