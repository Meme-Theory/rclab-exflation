...
|:-----|:---------------|:------------|:----------|:-------|
| 2026-03-01 | B-30a (Pfaffian Z_2 topological transition on Jensen curve) | OPEN | **CLOSED** | sgn Pf(Xi . D_total) = +1 for all 75 tau values in [0, 2.5], all 6 Peter-Weyl sectors, at N_max = 2. The D_total spectral gap never closes. |
| 2026-03-01 | B-30min (V_total minimum on 3D U(2)-invariant surface) | OPEN | **CLOSED** | V_total = V_spec + F_BCS has no interior minimum on the 21x21 (tau, epsilon) grid. V_spec dominates F_BCS by 8000x at rho = 0.01. |
| 2026-03-01 | B-30nck (NCG-KK coupling at Weinberg contour tau ~ 0.57) | OPEN | **CLOSED** | Lambda_SA/M_KK ~ 2.0 x 10^15 at M_KK = 10^16 GeV. NCG unification scale at ~10^31 GeV, 15 orders above M_KK. |
| 2026-03-01 | P-30a compound (phi + tree-level Weinberg at single geometry) | OPEN | **CLOSED** | phi and sin^2_B anti-correlated. No simultaneous solution. |
| 2026-03-01 | P-30golden (Golden ratio eigenvalue ratio on U(2)-invariant surface) | OPEN | **CLOSED** | phi_30 max = 1.550 on surface. Golden ratio 1.618 not accessible on any U(2)-invariant geometry. |
| 2026-03-01 | P-30pmns (PMNS mixing at large tau) | OPEN | **CLOSED** | sin^2(theta_13)=0.403 (18x too large). theta_23=63.6 deg. V_12/Delta_E = 27 (perturbation theory breaks). Structural at large tau. |
| 2026-03-01 | Wall 4 (spectral action monotonicity) | OPEN | **REGISTERED** | Extended from 1D Jensen curve to 3D U(2)-invariant surface. V_spec/F_BCS ~ 8000 in all three U(2)-invariant directions at rho = 0.01. |
| 2026-03-01 | Wall 5 (Pfaffian triviality on Jensen curve) | OPEN | **REGISTERED** | NEW. Pf(Xi . D_total) = +1 for all tau in [0, 2.5] at N_max = 2 on Jensen. Interior Mixing Theorem provides algebraic mechanism. |
| 2026-03-01 | Wall 6 (NCG-KK irreconcilability at tau ~ 0.57) | OPEN | **REGISTERED** | NEW. Lambda_SA/M_KK ~ 10^15 at the Weinberg contour. |
| 2026-03-01 | Interior Mixing Theorem | OPEN | **REGISTERED** | On the Jensen curve, D_F = sum_a [D_K, L_{e_a}] couples predominantly to interior spectral modes, not gap-edge modes, via algebraic (m + m') suppression mechanism. |
| 2026-03-01 | K-1 (Kapitza effective potential) | OPEN | **PINNED** | Pre-registered. Compute V_Kapitza(tau; A) from existing grid data. Pass criterion: interior minimum at tau_* in (0.05, 0.55) for some amplitude A. Fail criterion: monotonically decreasing for all A. |
| 2026-03-01 | I-1 (instanton-Kapitza frequency) | OPEN | **PINNED** | Pre-registered. Compute Gamma_inst(tau) from Session 22c action data. Pass: Gamma_inst/omega_tau > 3 at some tau. Fail: ratio < 1 everywhere. |
