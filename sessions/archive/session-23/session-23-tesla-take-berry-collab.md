...
**From what data**: Session 23a eigenvectors (`computations/s23a_eigenvectors_extended.npz`) provide |n^{(0,0)}(tau)> at tau = 0.00, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30, 0.35, 0.50. The Kosmann matrix elements K_a^{nm} = <n|K_a|m> are in `computations/s23a_kosmann_singlet.npz`.
