...
- Infrastructure: dirac_spectrum.py (Riemann tensor 147/147 verified, connection, frame, metric)
...
| `computations/s23a_einstein_validation_report.md` | Independent numerical validation |
