...
| `computations/s23a_eigenvector_extended.py` | phonon-sim | Extension script |
| `computations/s23a_kosmann_singlet.py` | phonon-sim | Kosmann matrix element extraction |
| `computations/s23a_kosmann_singlet.npz` | phonon-sim | K_a matrices in (0,0) singlet |
| `computations/s23a_bcs_gap_equation.py` | phonon-sim | Gap equation solver (4 methods, 3 bases, 3 mu) |
| `computations/s23a_gap_equation.npz` | phonon-sim | All gap equation data (63 KB) |
| `computations/s23a_gap_equation.png` | phonon-sim | 4-panel summary plot |
| `computations/s23a_gap_equation_results.txt` | phonon-sim | Full tabular results with Constraint Gate classification |
| `computations/s23a_precheck_3a_convergence.py` | landau | Seven-way convergence Monte Carlo |
| `computations/s23a_precheck_3b.py` | coordinator | V_IR'' fine N-grid diagnostic |
| `computations/s23a_precheck_3b.png` | coordinator | V_IR'' vs N plot |
| `computations/s23a_precheck_3b_N50_anomaly.py` | landau | N=50 anomaly analysis |
| `computations/s23a_precheck_3b_N50.png` | landau | N=50 anomaly plot |
| `computations/s23a_precheck_3c_bianchi.py` | landau | Bianchi compatibility check |
