...
|:-----|:---------------|:------------|:----------|:-------|
| 2026-02-20 | Scenario C (both alpha and beta from a_2, BF = 50-100) | OPEN | **CLOSED** | The Cartan 3-form \|omega_3\|^2 does NOT appear anywhere in the Baptista submersion formula R_P = R_M + R_K - \|F\|^2 - \|S'\|^2 + (1-1/k)\|N\|^2 + div (eq 2.5). |
| 2026-02-20 | Sub-Scenario A3 (12D->4D moment mapping, BF = 30-70) | OPEN | **CLOSED** | The hierarchy Lambda^4 ~ 10^64 makes the 2x2 system rank-1: both equations fix f_8*Lambda^8 but leave f_4*Lambda^4 completely unconstrained. |
| 2026-02-20 | "Both V_FR terms come from the same higher-dimensional Ricci scalar" (Session 21b Valar plan, line 773) | OPEN | **CLOSED** | This is HALF-TRUE. The -alpha*R_K term comes from R_P via submersion (a_2 level). The beta*\|omega_3\|^2 flux term does NOT come from R_P — it requires a_4 curvature-squared physics. |
| 2026-02-20 | P2a as originally conceived (BF = 50-100, zero free parameters) | OPEN | **CLOSED** | The honest BF is 5-15: the geometric piece of beta/alpha is computable and parameter-free, but the universal piece f_4/(f_8*Lambda^4) introduces one genuinely free parameter that cannot be constrained by any known low-energy observable within the spectral action framework. |
| 2026-02-20 | Session 22d BF = 50-100 | OPEN | **CLOSED** | Revised to 5-15 (beta/alpha alone) or 15-25 (combined with A/C). |
| 2026-02-20 | Normalization discrepancy (Session 22d "beta/alpha = 0.28" vs fiber integral "beta/alpha = 0.335") | OPEN | **CLOSED** | The mapping is r_bap = 0.335 -> beta_flux = 0.02233 -> Session 22 "beta/alpha" = 0.280 via the known geometric factor Vol(K)/15 = 0.84. No error in any prior computation. |
| 2026-02-20 | f-dependence (structural analysis) | OPEN | **CLOSED** | beta/alpha contains f_4/(f_8*Lambda^4), not purely geometric. Scenario C + A3 CLOSED. |
