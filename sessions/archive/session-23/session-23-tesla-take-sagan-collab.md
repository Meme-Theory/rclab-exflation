...
**Verdict**: The Berry phase computation across tau ~ 0.2 is feasible with existing eigenvector data from `computations/s23a_eigenvectors_extended.npz`. It would answer a well-defined mathematical question: does the Z invariant of the BDI class change at the degeneracy transition? This is a genuine zero-cost diagnostic.
...
| Input | Source |
|:------|:-------|
| V_nm matrix | `computations/s23a_kosmann_singlet.npz` |
| Eigenvalue ladder | `computations/s23a_eigenvectors_extended.npz` |
...
| Input | Source |
|:------|:-------|
| Eigenvectors | `computations/s23a_eigenvectors_extended.npz` |
...
| Input | Source |
|:------|:-------|
| R_K(tau), |Ric|^2(tau), K(tau) | `computations/s23c_fiber_integrals.npz` |
