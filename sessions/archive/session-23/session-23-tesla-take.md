...
The data already exists in `computations/r20a_riemann_tensor.npz` and `computations/s23c_fiber_integrals.npz`. R_K(tau), |Ric(tau)|^2, and K(tau) are all computed. This is a 20-line Python script and 30 seconds of runtime.
