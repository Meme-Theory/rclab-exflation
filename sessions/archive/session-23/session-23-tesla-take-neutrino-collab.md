...
The V_{nm} matrix from `computations/s23a_kosmann_singlet.npz` IS a tight-binding Hamiltonian on the eigenvalue ladder. Tesla identified this but did not compute it. The computation is:
