...
- Original script: `computations/s44_sakharov_gn.py` (agent — contains wrong formula)
- Cross-check: `computations/s44_sakharov_gn_crosscheck.py` (Naz — endorsed wrong formula)
- **Audit script: `computations/s44_sakharov_gn_audit.py`** (team-lead — CORRECTED formula, 6 variants)
- Original data: `computations/s44_sakharov_gn.npz`
- **Audit data: `computations/s44_sakharov_gn_audit.npz`** (corrected results)
- Plot: `computations/s44_sakharov_gn.png`
...
**Script**: `computations/s44_lifshitz_eta_crosscheck.py`
**Data**: `computations/s44_lifshitz_eta_crosscheck.npz`
...
- Script: `computations/s44_first_sound_imprint.py`
- Data: `computations/s44_first_sound_imprint.npz` (59 KB, 43 arrays)
- Plot: `computations/s44_first_sound_imprint.png` (6 panels: coupling chain, two-sound oscillations, P(k) ratio, xi(r)*r^2, damping comparison, a_2(tau) gravitational coupling)
...
**Files**: Script `computations/s44_holographic_spec.py`, data `computations/s44_holographic_spec.npz`, plot `computations/s44_holographic_spec.png`.
...
- Script: `computations/s44_dimflow.py`
- Data: `computations/s44_dimflow.npz` (16 tau x 300 sigma landscape, both d_s and dd_s/dtau)
- Plot: `computations/s44_dimflow.png` (9-panel: d_s vs sigma, d_s vs tau, CDT n_s, 2D landscape, Hawking flow, Hawking n_s, heat kernel, dd_s/dtau landscape, summary)
...
- Script: `computations/s44_first_sound_fisher.py`
- Data: `computations/s44_first_sound_fisher.npz` (278 KB, 47 arrays)
- Plot: `computations/s44_first_sound_fisher.png` (6 panels: P(k) oscillations, xi(r)*r^2, first-sound zoom, SNR vs volume, NL damping, summary)
...
**Input files**:
- `computations/s36_sfull_tau_stabilization.npz` (eigenvalues at 7 tau, 10 sectors, 1232 evals/tau)
- `computations/s43_foam_gge.npz` (epsilon_crossover = 0.014)
...
**Input files**:
- `computations/s27_multisector_bcs.npz` (tau=0.0, 0.10, 0.15)
- `computations/s36_sfull_tau_stabilization.npz` (tau=0.05, 0.19)
- `computations/s43_phonon_dos.npz` (tau=0.20 cross-check)
...
**Scripts**: `computations/s44_frg_pilot.py`
**Data**: `computations/s44_frg_pilot.npz`
**Plot**: `computations/s44_frg_pilot.png`
...
**Input files**:
- `computations/s44_sakharov_gn_audit.npz` (W1-1 CORRECTED output)
- `computations/s42_constants_snapshot.npz`
- `computations/s44_induced_g.npz` (W4-2 bosonic a_2)
...
- `computations/s42_hauser_feshbach.npz`
- `computations/s42_constants_snapshot.npz`
- `computations/s43_mkk_posterior.npz` (NOTE: actual filename, not s43_mkk_bayes.npz)
...
- Script: `computations/s44_spectral_dim_band.py`
- Data: `computations/s44_spectral_dim_band.npz` (57 KB, sigma grid, d_s for PW/1D/flat/disp, flat fractions, crossover scales)
- Plot: `computations/s44_spectral_dim_band.png` (9-panel: PW d_s vs sigma, 1D d_s, flat fraction, band structure, heat kernel, suppression profile, branch-resolved P, CDT n_s, summary)
...
**Input files**:
- `computations/s42_hauser_feshbach.npz` (baseline spectrum)
- `computations/dirac_spectrum.py` (Dirac operator construction)
...
**Input files**:
- `computations/s44_dos_tau.npz` (W5-3 output)
- `computations/s43_phonon_dos.npz`

**Output files**:
- Script: `computations/s44_vanhove_track.py`
- Data: `computations/s44_vanhove_track.npz` (25.8 KB)
- Plot: `computations/s44_vanhove_track.png` (459 KB, 4-panel)
...
- Script: `computations/s44_cc_gap_resolved.py`
- Data: `computations/s44_cc_gap_resolved.npz`
- Plot: `computations/s44_cc_gap_resolved.png`
...
- Part A script: `computations/s44_mkk_reconcile.py`
- Part A data: `computations/s44_mkk_reconcile.npz`
- Part A plot: `computations/s44_mkk_reconcile.png`
- Part B script: `computations/s44_constants_corrected.py`
- Part B data: `computations/s44_constants_corrected.npz`
