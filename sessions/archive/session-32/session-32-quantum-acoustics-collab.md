...
**Data source**: `computations/s32b_wall_dos.npz` (overlap matrices, eigenvalues at all wall configurations).
...
**Data source**: `computations/s32a_umklapp_vertex.npz` (v_B2 array at 9 tau values).
...
**Data source**: `computations/s32b_rpa1_thouless.npz` (d2S_abs, per-mode d2lambda, eigenvalues).
...
**Data source**: `computations/s32b_rpa1_thouless.npz` (V matrix, eigenvectors, eigenvalue derivatives).
