...
|:-------|:-----------|:-------|
| `computations/s32b_rpa1_thouless.py` | RPA-1 computation script | COMPLETE |
| `computations/s32b_rpa1_thouless.npz` | RPA-1 data (chi values, V matrix, decomposition) | COMPLETE |
| `computations/s32b_rpa1_thouless.png` | RPA-1 plot (chi vs tau, diagonal vs off-diagonal) | COMPLETE |
| `computations/s32b_wall_dos.py` | WALL-1 computation script | COMPLETE |
| `computations/s32b_wall_dos.npz` | WALL-1 data (rho_wall, overlaps, CdGM spacing) | COMPLETE |
| `computations/s32b_wall_dos.png` | WALL-1 plot (LDOS at wall, trapped modes, parameter scan) | COMPLETE |
| `computations/s32b_param_b2_mathieu.py` | PARAM-B2 computation script | COMPLETE |
| `computations/s32b_param_b2_mathieu.npz` | PARAM-B2 data (Mathieu parameters, stability diagram) | COMPLETE |
| `computations/s32b_param_b2_mathieu.png` | PARAM-B2 plot (stability diagram with B2 operating points) | COMPLETE |
| `computations/s32b_gate_verdicts.txt` | Gate verdict log | COMPLETE |
...
|:-----|:-----|:---------|:--------|
| `computations/s32b_rpa1_thouless.py` | 1 | sim | RPA-1 Stage 2 computation script |
| `computations/s32b_rpa1_thouless.npz` | 1 | sim | chi values, V matrix, decomposition, branch-resolved |
| `computations/s32b_rpa1_thouless.png` | 1 | sim | chi vs tau, diagonal vs off-diagonal, branch contributions |
| `computations/s32b_wall_dos.py` | 2 | sim | WALL-1 computation script |
| `computations/s32b_wall_dos.npz` | 2 | sim | rho_wall, overlaps, CdGM spacing, trapped modes |
| `computations/s32b_wall_dos.png` | 2 | sim | LDOS at wall, parameter scan, mode structure |
| `computations/s32b_param_b2_mathieu.py` | 3 | sim | PARAM-B2 computation script |
| `computations/s32b_param_b2_mathieu.npz` | 3 | sim | Mathieu parameters, stability boundaries |
| `computations/s32b_param_b2_mathieu.png` | 3 | sim | Stability diagram with B2 operating points |
| `computations/s32b_gate_verdicts.txt` | 4 | coord | Gate verdict log (3 gates) |
