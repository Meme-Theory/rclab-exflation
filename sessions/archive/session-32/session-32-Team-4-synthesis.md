...
| File | Agent | Contents |
|:-----|:------|:---------|
| `computations/s33w3_modulus_equation.py` | KK | Full derivation + numerical solver |
| `computations/s33w3_modulus_equation.npz` | KK | Numerical results (V_eff, eta scan, wall profiles) |
| `computations/s33w3_modulus_equation.png` | KK | 4-panel figure |
| `computations/s33w3_swallowtail.png` | KK | Swallowtail vertex visualization |
