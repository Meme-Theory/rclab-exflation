...
| File | Agent | Contents |
|:-----|:------|:---------|
| `computations/s33w3_sp_dump_geometry.py` | SP | K(tau), NEC audit, Bianchi decomposition |
| `computations/s33w3_wall_pmns.py` | Neutrino | Hybrid Hamiltonian, PMNS scan over Delta |
| `computations/s33w3_wall_pmns.npz` | Neutrino | All numerical results |
| `computations/s33w3_wall_pmns.png` | Neutrino | 6-panel figure |
| `computations/s33w3_paasch_dump_point.py` | Paasch | phi ratio analysis, transcendental eq test |
| `computations/s33w3_paasch_dump_point.npz` | Paasch | Results archive |
