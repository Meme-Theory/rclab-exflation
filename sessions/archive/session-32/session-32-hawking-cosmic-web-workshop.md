...
Hawking's pre-registered prediction: rho_s(B2) = (2*Delta_BCS / V_cell) * 4.24. If BCS-at-walls yields Delta_BCS, this gives the London penetration depth and gauge boson mass at the wall. Whether the resulting mass scale connects to Standard Model masses is a Level 3 question that depends on the full KK reduction.
