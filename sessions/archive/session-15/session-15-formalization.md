...
──────                      ────────────────                  ──────
D_K eigenvalues (Level 1) → eq 7.5 + mass integral (14§3.2) → Physical masses
...
| `dirac_spectrum.py` | kk-theorist | ~1580 | Level 1: Dirac spectrum p+q ≤ 6 |
| `spectral_action.py` | sim-specialist | ~900 | Spectral action + heat kernel |
| `phi_analysis.py` | sim-specialist | ~500 | Phi structure analysis framework |
