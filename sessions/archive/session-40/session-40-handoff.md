...
| File | Content | Wave |
|:-----|:--------|:-----|
| `computations/s40_b2_integrability.py` | B2 subsystem integrability | W1-1 |
...
| `computations/s40_acoustic_temperature.py` | Acoustic temperature | W1-2 |
...
| `computations/s40_b2_decay_out.py` | B2 decay-out ED | W2-3 |
| `computations/s40_b2_decay_out.npz` | B2 decay data | W2-3 |
| `computations/s40_b2_decay_out.png` | B2 decay plot | W2-3 |
| `computations/s40_hessian_offjensen.py` | Off-Jensen Hessian | W3-1 |
