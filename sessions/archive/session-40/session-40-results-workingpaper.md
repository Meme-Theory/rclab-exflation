...
**Data files:**
- Script: `computations/s40_b2_integrability.py`
- Data: `computations/s40_b2_integrability.npz`
- Plot: `computations/s40_b2_integrability.png`
...
**Data files:**
- Script: `computations/s40_acoustic_temperature.py`
- Data: `computations/s40_acoustic_temperature.npz`
- Plot: `computations/s40_acoustic_temperature.png`
...
**Data files:**
- Script: `computations/s40_gsl_transit.py`
- Data: `computations/s40_gsl_transit.npz`
- Plot: `computations/s40_gsl_transit.png`
...
**Data files:**
- Script: `computations/s40_cc_transit.py`
- Data: `computations/s40_cc_transit.npz`
...
**Data files:**
- Script: `computations/s40_nohair_sensitivity.py`
- Data: `computations/s40_nohair_sensitivity.npz`
- Plot: `computations/s40_nohair_sensitivity.png`
...
**Data files:**
- Script: `computations/s40_qrpa_modes.py`
- Data: `computations/s40_qrpa_modes.npz`
- Plot: `computations/s40_qrpa_modes.png`
...
**Data files:**
- Script: `computations/s40_internal_page_curve.py`
- Data: `computations/s40_internal_page_curve.npz`
- Plot: `computations/s40_internal_page_curve.png`
...
**Data files:**
- Script: `computations/s40_b2_decay_out.py`
- Data: `computations/s40_b2_decay_out.npz`
- Plot: `computations/s40_b2_decay_out.png`
...
**Data files:**
- Script: `computations/s40_hessian_offjensen.py`
- Data: `computations/s40_hessian_offjensen.npz`
- Plot: `computations/s40_hessian_offjensen.png`
...
**Data files:**
- Script: `computations/s40_collective_inertia.py`
- Data: `computations/s40_collective_inertia.npz`
- Plot: `computations/s40_collective_inertia.png`
...
**Data files produced:**
- `computations/s40_self_consistent_ode.py` (script)
- `computations/s40_self_consistent_ode.npz` (all trajectories, energies, gate data)
- `computations/s40_self_consistent_ode.png` (6-panel comparison plot)
...
| File | Content | Wave |
|:-----|:--------|:-----|
| `computations/s40_b2_integrability.py` | B2 subsystem integrability computation | W1-1 |
| `computations/s40_b2_integrability.npz` | B2 integrability data | W1-1 |
| `computations/s40_b2_integrability.png` | B2 integrability plot | W1-1 |
| `computations/s40_acoustic_temperature.py` | Acoustic temperature computation | W1-2 |
| `computations/s40_acoustic_temperature.npz` | Acoustic temperature data | W1-2 |
| `computations/s40_acoustic_temperature.png` | Acoustic temperature plot | W1-2 |
| `computations/s40_gsl_transit.py` | GSL through transit computation | W1-3 |
| `computations/s40_gsl_transit.npz` | GSL data | W1-3 |
| `computations/s40_gsl_transit.png` | GSL plot | W1-3 |
| `computations/s40_cc_transit.py` | CC transit shift computation | W1-4 |
| `computations/s40_cc_transit.npz` | CC transit data | W1-4 |
| `computations/s40_nohair_sensitivity.py` | No-hair sensitivity computation | W1-5 |
| `computations/s40_nohair_sensitivity.npz` | No-hair data | W1-5 |
| `computations/s40_nohair_sensitivity.png` | No-hair plot | W1-5 |
| `computations/s40_qrpa_modes.py` | QRPA collective modes computation | W2-1 |
| `computations/s40_qrpa_modes.npz` | QRPA data | W2-1 |
| `computations/s40_qrpa_modes.png` | QRPA plot | W2-1 |
| `computations/s40_internal_page_curve.py` | Internal Page curve computation | W2-2 |
| `computations/s40_internal_page_curve.npz` | Page curve data | W2-2 |
| `computations/s40_internal_page_curve.png` | Page curve plot | W2-2 |
| `computations/s40_b2_decay_out.py` | B2 decay-out time-dependent ED | W2-3 |
| `computations/s40_b2_decay_out.npz` | B2 decay data | W2-3 |
| `computations/s40_b2_decay_out.png` | B2 decay plot | W2-3 |
| `computations/s40_hessian_offjensen.py` | Off-Jensen Hessian computation | W3-1 |
| `computations/s40_hessian_offjensen.npz` | Hessian data | W3-1 |
| `computations/s40_hessian_offjensen.png` | Hessian plot | W3-1 |
| `computations/s40_collective_inertia.py` | ATDHFB collective inertia | W3-2 |
| `computations/s40_collective_inertia.npz` | Collective inertia data | W3-2 |
| `computations/s40_collective_inertia.png` | Collective inertia plot | W3-2 |
