...
- `computations/s49_bragg_goldstone.{py,npz,png}` (my computation, W1-C)
- `computations/s49_leggett_transit.{py,npz,png}` (my computation, W1-H)
- `computations/s49_dipolar_catalog.{py,npz,png}` (W1-S, Volovik)
- `computations/s49_alpha_s_bayes.{py,npz,png}` (W1-L, Nazarewicz)
- `computations/s49_multi_t_friedmann.{py,npz,png}` (W1-E, Einstein)
- `computations/s49_hfb_backreaction.{py,npz,png}` (W1-I, Nazarewicz)
- `computations/s49_leggett_gge.{py,npz,png}` (W1-T, Nazarewicz)
- `computations/s48_leggett_mode.{py,npz,png}` (S48 Leggett data)
