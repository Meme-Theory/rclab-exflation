...
- `computations/s49_cavity_resonance.py/.npz/.png` (W1-J, my computation)
- `computations/s49_leggett_phi_scan.py/.npz/.png` (W1-N, my computation)
- `computations/s49_dipolar_catalog.py/.npz/.png` (W1-S, Volovik agent)
- `computations/s49_alpha_s_bayes.py/.npz/.png` (W1-L, Nazarewicz agent)
- `computations/s49_analog_trapped.py/.npz/.png` (W1-G, SP agent)
- `computations/s49_kz_3component.py/.npz/.png` (W1-M, gen-physicist agent)
