...
- Plot: `computations/s49_bragg_goldstone.png`
...
- Plot: `computations/s49_geometric_breaking.png`
...
- Plot: `computations/s49_multi_t_friedmann.png`
...
- Plot: `computations/s49_conformal_transition.png`
...
- Plot: `computations/s49_analog_trapped.png`
...
- Plot: `computations/s49_leggett_transit.png`
...
- Plot: `computations/s49_hfb_backreaction.png`
...
- Plot: `computations/s49_cavity_resonance.png`
...
- Plot: `computations/s49_gauss_codazzi.png`

---

## Level 3 — Observational Predictions
...
- Plot: `computations/s49_alpha_s_bayes.png`
...
- Plot: `computations/s49_kz_3component.png`
...
- Plot: `computations/s49_leggett_phi_scan.png`
...
- Plot: `computations/s49_desi_dr3_prep.png`

---

## Level 4 — Geometric Characterization
...
- Plot: `computations/s49_cosmic_censorship.png`
...
1. At each tau, compute full 8D Riemann tensor from Jensen metric (ON-frame, ). Extract Weyl tensor via n-dimensional decomposition C = R - (1/(n-2))(Ric x g) + (R/((n-1)(n-2)))(g x g).
...
- Plot: `computations/s49_cmpp_transition.png`
...
- Plot: `computations/s49_non_li_tt.png`
...
- Plot: `computations/s49_dipolar_catalog.png`
...
- Plot: `computations/s49_leggett_gge.png`
...
|:-----|:---------------|:------------|:----------|:-------|
| S49 | FRIEDMANN-GOLDSTONE-49 (Friedmann-Goldstone coupling for n_s) | OPEN | **CLOSED** | The Hubble mass is 115 orders below what O-Z needs at the fabric scale. No amount of cosmological dynamics can bridge this gap without changing J or rho_s by 57 orders. |
| S49 | GEOMETRIC-BREAKING-49 (geometric WKB breaking produces m_G in CC range) | OPEN | **CLOSED** | All 4 channels overshoot. |
| S49 | O-Z Friedmann mass for n_s | OPEN | **CLOSED** | m~H_0 exists but 115 OOM short. CMB pivot outside BZ. |
| S49 | Bragg gap for n_s mass | OPEN | **CLOSED** | Gap at KK scale. Z_3 eta=1/2 topologically quantized. |
| S49 | CMPP type transition at 0.537 | OPEN | **CLOSED** | Type II locked by Riemannian signature. |
| S49 | Leggett mode post-transit | OPEN | **CLOSED** | Destroyed (Delta=0), no collective content in GGE. |
| S49 | S48 analog horizons | OPEN | **CLOSED** | Artifact: amplitude gradient ≠ superflow. phi=0 everywhere. |
| S49 | Cavity-Leggett unification | OPEN | **CLOSED** | 11.5x frequency mismatch. Different physics (position vs momentum space). |
| S49 | Goldstone mass (Bragg) | OPEN (S48 wayforward) | **CLOSED** | W1-C: KK-scale gap, Z_3 quantization. |
| S49 | Leggett in GGE | OPEN | **CLOSED** (no collective content) | W1-H + W1-T: Delta=0, N=1 non-interacting. |
