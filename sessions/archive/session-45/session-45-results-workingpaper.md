...
- Cross-check: `computations/s45_kz_ns_crosscheck.py`
...
- Script: `computations/s45_kz_ns_crosscheck.py`
- Data: `computations/s45_kz_ns_crosscheck.npz`
...
- `computations/s44_dos_tau.npz`
- `computations/s44_vanhove_track.npz`
- `computations/s44_multi_t_jacobson.npz`
- `computations/canonical_constants.py`

**Output files**:
- Script: `computations/s45_occ_spectral_landau.py`
- Data: `computations/s45_occ_spectral_landau.npz`
- Plot: `computations/s45_occ_spectral_landau.png`
...
- Script: `computations/s45_alpha_eff.py`
- Data: `computations/s45_alpha_eff.npz`
- Plot: `computations/s45_alpha_eff.png`
...
**Script**: `computations/s45_unexpanded_sa.py`
**Data**: `computations/s45_unexpanded_sa.npz`
**Plot**: `computations/s45_unexpanded_sa.png`
...
**Files**: `computations/s45_kz_ns_kmap.{py,npz,png}`
...
#### Data Files
- Script: `computations/s45_qtheory_bcs.py`
- Data: `computations/s45_qtheory_bcs.npz`
- Plot: `computations/s45_qtheory_bcs.png`
...
**Input files**:
- `computations/s44_dimflow.npz`
- `computations/s42_constants_snapshot.npz`

**Output files**:
- Script: `computations/s45_sigma_select.py`
...
**Input files**:
- `computations/s45_occ_spectral.npz` (from W1-1)

**Output files**:
- Script: `computations/s45_lk_relax.py`
- Data: `computations/s45_lk_relax.npz`
- Plot: `computations/s45_lk_relax.png`
...
**Input files**: `s44_vanhove_track.npz`, `dirac_spectrum.py`
...
**Input files**:
- `computations/s37_pair_susceptibility.npz`
- `computations/s42_hauser_feshbach.npz`

**Output files**:
- Script: `computations/s45_econd_reconcile.py`
- Data: `computations/s45_econd_reconcile.npz`
...
**Files**: `computations/s45_acoustic_ns.py` (script), `s45_acoustic_ns.npz` (data), `s45_acoustic_ns.png` (6-panel plot)
...
**Output**: `computations/s45_heat_kernel_audit.md`

**Results**:

*(Agent completed — see computations/s45_heat_kernel_audit.md)*
...
**Output files**: Script `computations/s45_debye_waller.py`, Data `computations/s45_debye_waller.npz`, Plot `computations/s45_debye_waller.png`
...
**Output files**:
- Script: `computations/s45_qnm_ns.py`
- Data: `computations/s45_qnm_ns.npz`
- Plot: `computations/s45_qnm_ns.png` (9-panel diagnostic)
...
**Files**: `computations/s45_qnm_ns.py` (script), `s45_qnm_ns.npz` (data), `s45_qnm_ns.png` (9-panel plot)
...
**Input files**:
- `computations/r20a_riemann_tensor.npz` (full 8x8x8x8 Riemann, Session 20a)
- `computations/canonical_constants.py` (tau_fold, H_fold, v_terminal, M_KK)

**Output files**:
- Script: `computations/s45_kretschner.py`
- Data: `computations/s45_kretschner.npz`
...
**Output**: `computations/s45_cc_gap_update.py` (summary script)
...
- Script: `computations/s45_cc_gap_update.py`
...
**Input files**:
- `computations/s44_sakharov_gn_audit.npz`
- `computations/s44_dissolution_scaling.npz`

**Output files**:
- Script: `computations/s45_sakharov_dissolution.py`
- Data: `computations/s45_sakharov_dissolution.npz`
- Plot: `computations/s45_sakharov_dissolution.png`
...
**Output files**:
- Script: `computations/s45_occupied_cyclic.py`
- Data: `computations/s45_occupied_cyclic.npz`
- Plot: `computations/s45_occupied_cyclic.png`
...
**Output files**:
- Script: `computations/s45_weak_order_one.py`
- Data: `computations/s45_weak_order_one.npz`
...
**Data files**: `computations/s45_weak_order_one.py`, `computations/s45_weak_order_one.npz`.
...
**Input files**:
- `computations/s44_coherent_wall.npz`, `s44_dos_tau.npz`
- `computations/s43_impedance_mismatch.npz`, `s42_fabric_dispersion.npz`

**Output files**:
- `computations/s45_acoustic_casimir.py` (script)
- `computations/s45_acoustic_casimir.npz` (data)
- `computations/s45_acoustic_casimir.png` (6-panel figure)
...
- `computations/s39_gge_lambdas.npz`
- `computations/s43_gge_temperatures.npz`

**Output files**:
- Script: `computations/s45_gge_beating.py`
- Data: `computations/s45_gge_beating.npz`
- Plot: `computations/s45_gge_beating.png`
...
**Input files**:
- `computations/s41_spectral_refinement.npz`, `s44_vanhove_track.npz`, `s42_hauser_feshbach.npz`
- `computations/s35_sector_10_spectrum.npz`, `s29b_bogoliubov_bcs.npz`, `s44_bcs_tensor_r.npz`

**Output files**:
- Script: `computations/s45_spectral_penrose.py`
- Plot: `computations/s45_spectral_penrose.png`
- Data: `computations/s45_spectral_penrose.npz`
...
**Output files**:
- Script: `computations/s45_dissolution_entropy.py`
- Data: `computations/s45_dissolution_entropy.npz`
- Plot: `computations/s45_dissolution_entropy.png`
...
**Output files**:
- Script: `computations/s45_analytic_torsion.py`
- Data: `computations/s45_analytic_torsion.npz`
- Plot: `computations/s45_analytic_torsion.png`
...
- Script: `computations/s45_fwd_bwd_ns.py`
- Data: `computations/s45_fwd_bwd_ns.npz`
- Plot: `computations/s45_fwd_bwd_ns.png`

## Constraint-Map Updates

| Date | Mechanism/gate | Prior state | New state | Reason |
|:-----|:---------------|:------------|:----------|:-------|
| 2026-03-15 | OCC-SPEC-45 (Occupied-state spectral action tau-stabilization) | OPEN | **CLOSED** | S_occ monotone decreasing at all cutoffs; confirmed independently by Landau free energy (F_geo dominates E_cond by 2,000,000:1) |
| 2026-03-15 | OCC-SPEC-45-LANDAU | OPEN | **CLOSED** | F_total(tau) = F_geo(tau) + E_cond(tau) is monotonically increasing at all 16 tau values in [0.00, 0.50], all 5 cutoff scales Lambda, and both exp and polynomial cutoff functions. No local minimum exists. |
| 2026-03-15 | UNEXPANDED-SA-45 (Full (unexpanded) spectral action CC hierarchy) | OPEN | **CLOSED** | Taylor expansion EXACT for finite discrete spectrum; A_4/A_2 = 2.76 (O(1), immovable); no cutoff function produces hierarchy |
| 2026-03-15 | KZ-NS-KMAP-45 (Bogoliubov/KZ n_s from KK quench) | OPEN | **CLOSED** | n_s = -4.45 with derived EIH k-mapping (unique); all individual reps give n_s ~ -6; 992 discrete modes insufficient for power law |
| 2026-03-15 | SIGMA-SELECT-45 (Sigma-selection for spectral dimension n_s) | OPEN | **CLOSED** | No first-principles method selects sigma. Backreaction tautological (CDT input); Hubble in UV-trivial regime (d_s = 5e-4); occupied-state no plateau; q-theory ad hoc |
| 2026-03-15 | KZ-NS-45 (Bogoliubov route to n_s) | OPEN | **CLOSED** | The Bogoliubov route to n_s is now CLOSED: deeply red (n_s ~ -4.5) at all scales and in all representations individually (n_s ~ -6 per rep). |
| 2026-03-15 | ACOUSTIC-NS-45 (Acoustic dispersion direct route) | OPEN | **CLOSED** | alpha_eff = 4.63 (band curvature); 57-order scale gap kills direct route |
| 2026-03-15 | FWD-BWD-NS-45 (Forward/backward pair creation asymmetry for n_s) | OPEN | **CLOSED** | This is the FOURTH n_s route to fail: Lifshitz eta (S44), Bogoliubov quench (KZ-NS-45), forward/backward (this), all closed |
| 2026-03-15 | Bochniak-Sitarz weak order-one (WEAK-ORDER-ONE-45) | OPEN | **CLOSED** | The Bochniak-Sitarz weak order-one condition FAILS maximally. The entire order-one violation resides in the gauge-gauge sector -- ratio GG/Full = 1.000 exactly at all tau. |
| 2026-03-15 | Spectral action (all variants) for CC/tau-stabilization | OPEN | **CLOSED** | 0/900 minima (S44 foam), S_occ monotone (S45), F_total monotone (S45 Landau), unexpanded SA exact (S45) |
| 2026-03-15 | Torsion suppression for CC | OPEN | **CLOSED** | T > 1 universal; T_singlet = 0.147 gives 112-order overshoot |
| 2026-03-15 | S45-S1 Taylor expansion exactness theorem | OPEN | **REGISTERED** | For finite discrete spectra {lambda_k^2, d_k}, the spectral action S(Lambda) has an EXACT convergent Taylor expansion in 1/Lambda^2 for Lambda^2 > max(lambda_k^2). No non-perturbative content exists beyond the polynomial expansion at finite truncation. |
| 2026-03-15 | S45-S2 EIH k-mapping uniqueness | OPEN | **REGISTERED** | The unique physically motivated k-mapping from internal KK quantum numbers to 4D wavenumber is k = |lambda_k(tau_fold)| with gravitational coupling g = 1/d_{(p,q)} (Schur orthogonality). Resolves the W1-2 ambiguity definitively |
| 2026-03-15 | S45-S3 Analytic torsion universality | OPEN | **REGISTERED** | T(M, g) > 1 for any compact Riemannian manifold with dim >= 2, no zero modes, and Weyl-distributed eigenvalues. T(SU(3), g_fold) = 10^{20,301}. Torsion IS the one-loop CC, not its cure |
| 2026-03-15 | S45-S4 Singlet torsion bound | OPEN | **REGISTERED** | T_singlet = 0.147 (16 modes, EIH sector). Per-mode torsion contribution \|log lambda_k\|/mode = 0.240 (singlet) vs 0.917 (full). Singlet sector has SUPPRESSED torsion because all eigenvalues are near 1 in M_KK units |
| 2026-03-15 | S45-S5 G_N topological protection | OPEN | **REGISTERED** | G_N^{Sak}(tau) is monotone across [0, 0.50] with total variation 2.5%. The leading term (sum d_k lambda_k^2) is Weyl-law dominated and insensitive to Jensen deformation. Ratio G_N^{Sak}/G_N^{obs} = 0.436 at fold |
| 2026-03-15 | S45-S6 Euler deficit disproved | OPEN | **REGISTERED** | The S44 claim "Euler deficit = \|E_cond\| = 6.8%" is an ensemble artifact. The Euler sum sum_k T_k S_k / E = 1.000 EXACTLY (Shannon convention). |
| 2026-03-15 | S45-S7 Van Hove TRUE crossing | OPEN | **REGISTERED** | T3 ((0,0) max) and T5 ((2,0)+(0,2) min) undergo a TRUE CROSSING at tau = 0.19104. Delta_min = 3.27e-5 at tau = 0.191. This is not an avoided crossing -- the trajectories intersect because they belong to different SU(3) representations (no coupling by symmetry) |
| 2026-03-15 | S45-S8 GGE saddle point structure | OPEN | **REGISTERED** | The GGE free energy has Morse index 3 (3 unstable, 5 stable directions). The unstable directions are B3-dominated (weight > 0.92). The stable manifold is 5-dimensional |
| 2026-03-15 | S45-S9 Zubarev alpha formula | OPEN | **REGISTERED** | alpha_eff = S_GGE/(S_max - S_GGE) = 0.410 from the non-equilibrium entropy deficit of the GGE relative to thermal equilibrium. The formula is parameter-free: S_GGE = 1.612 nats (from BCS quench ED), S_max = 8 ln 2 = 5.545 nats |
| 2026-03-15 | S45-S10 Band inversion at round SU(3) | OPEN | **REGISTERED** | The acoustic branch of the Dirac eigenvalue dispersion has a band inversion at tau = 0 (round SU(3)): omega((1,0)) < omega((0,0)). The Jensen deformation resolves this inversion monotonically. |
| 2026-03-15 | OCCUPIED-CYCLIC-45 Thm 1 (PH Identity) | OPEN | **REGISTERED** | ch^0_occ = ch^0_vac/2 at mu=0. PH symmetry n_F(+lam)+n_F(-lam)=1. Verified 0.00e+00 deviation. |
| 2026-03-15 | OCCUPIED-CYCLIC-45 Thm 2 (Strict Positivity) | OPEN | **REGISTERED** | ch^0_occ(1) > 0 for ALL beta, mu. Each term strictly positive (occupation in (0,2), heat kernel > 0). |
| 2026-03-15 | OCCUPIED-CYCLIC-45 Thm 3 (Full Pairing Nondeg) | OPEN | **REGISTERED** | P^occ = diag(w_1,w_2,w_3)*P^vac, all w_i > 0. det(P^occ) > 0. |
| 2026-03-15 | OCCUPIED-CYCLIC-45 Thm 4 (BCS Invariance) | OPEN | **REGISTERED** | ch^0_BCS = ch^0_vac/2. J-protection: v_k^2+u_k^2=1. Verified to machine epsilon. |
| 2026-03-15 | OCCUPIED-CYCLIC-45 Thm 5 (Poincare Duality) | OPEN | **REGISTERED** | det(P^occ) = det(W)*det(P^vac) != 0. Any occupation, any (beta,mu,Delta). |
| 2026-03-15 | OCCUPIED-CYCLIC-45 Thm 6 (Index Stability) | OPEN | **REGISTERED** | Index(D_K)=0 independent of occupation. dim ker(D_K)=0. Topological. |
| 2026-03-15 | WEAK-ORDER-ONE-45 structural theorem | OPEN | **REGISTERED** | For (A_F, H_F, D_K(tau)) on SU(3) in the Baptista representation: (i) \|\|GG\|\|/\|\|Full\|\| = 1 at all tau. (ii) GG = 2*GS = 4*SS exact. (iii) \|\|[[D_K, a], b^0]\|\|_max = (5/sqrt(3))*exp(tau) on (1,0). |
| 2026-03-15 | epsilon_H ratio invariance theorem (S44 Wall #5) | OPEN | **REGISTERED** | epsilon_H = 2.999, INVARIANT under any amplitude projection. Closes entire amplitude-projection class for n_s. |
| 2026-03-15 | OCC-SPEC + Landau double closure (S45 Wall #6) | OPEN | **REGISTERED** | Occupied-state spectral action (Connes formulation) monotone decreasing; Landau free energy F_total = F_geo + E_cond monotone increasing. Both routes closed independently. Scale separation: \|E_cond\|/F_geo = 5.1e-7. |
| 2026-03-15 | Q-THEORY-BCS-45 (q-theory + BCS self-tuning crossing) | OPEN | **LANDED** | Q-THEORY-BCS-45 is the FIRST CC mechanism to PASS a pre-registered gate in the project's history. The crossing at tau* = 0.209 exists for the physically motivated flat-band gap hierarchy (B2 = Delta_0_GL, B1 = Delta_0_GL/2, B3 = 0.176). |
| 2026-03-15 | CC-HIERARCHY-CUBED-45 | OPEN | **CLOSED** | The observation that gap / 36 = 3.25 (approximately 3) is a numerical coincidence. The moment ratios A_0/A_2 = 0.39 and A_2/A_4 = 0.36 are both O(1), not 10^{36}. |
| 2026-03-15 | EULER-DEFICIT-45 (S44 claim disproved) | OPEN | **CLOSED** | S44 reported deficit / \|E_cond\| = 1.000, suggesting an exact identity between the Euler characteristic deficit and the BCS condensation energy. S45 computation shows deficit / \|E_cond\| = 0.843 — the claimed identity was an ensemble averaging artifact. |
