...
- `computations/s45_kz_ns.npz` -- Bogoliubov raw spectrum
- `computations/s45_kz_ns_kmap.npz` -- EIH k-mapped spectrum
- `computations/s45_fwd_bwd_ns.npz` -- Forward/backward sweep (KEY: `ns_vs_tauback`, `tau_back_vals`)
- `computations/s45_collective_ns_rpa.npz` -- RPA collective modes
- `computations/s45_acoustic_ns.npz` -- Acoustic dispersion
- `computations/s42_hauser_feshbach.npz` -- Sector structure, V matrix elements
