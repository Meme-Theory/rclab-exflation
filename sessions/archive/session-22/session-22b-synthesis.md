...
**Output files**: `computations/s22b_eigenvector_extraction.py`, `computations/s22b_eigenvectors.npz`, `computations/s22b_kosmann_matrix.py`, `computations/s22b_block_diagonal_results.py`, `computations/s22b_block_diagonal_results.npz`
...
**Output**: `computations/s22b_eigenvectors.npz` (23.8 MB)
...
**Script**: `computations/s22b_block_diagonal_results.py`
**Output**: `computations/s22b_block_diagonal_results.npz`
...
|:-----|:---------|:--------|:-------|
| `computations/s22b_eigenvector_extraction.py` | phonon-sim | PA-1 eigenvector extraction | COMPLETE |
| `computations/s22b_eigenvectors.npz` | phonon-sim | Eigenvectors, 9 tau, 10 sectors | COMPLETE |
| `computations/s22b_kosmann_matrix.py` | baptista | PA-2 coupling proof (exact zero) | COMPLETE |
| `computations/s22b_block_diagonal_results.py` | phonon-sim | Tasks 11+13 definitive baseline | COMPLETE |
| `computations/s22b_block_diagonal_results.npz` | phonon-sim | delta_T, V_IR, E_ferm tables | COMPLETE |
