...
The BCS channel scan (F-1, script `C:\sandbox\Ainulindale Exflation\computations/_shared\s22c_bcs_channel_scan.py`) produced three genuinely significant results:
...
- **Input**: D_K eigenvectors in the (0,0) singlet sector from `C:\sandbox\Ainulindale Exflation\computations/_shared\s22b_eigenvectors.npz`
...
- *BCS channel scan: `C:\sandbox\Ainulindale Exflation\computations/_shared\s22c_bcs_channel_scan.py`*
- *Instanton action: `C:\sandbox\Ainulindale Exflation\computations/_shared\s22c_instanton_action.py`*
- *Block-diagonal results: `C:\sandbox\Ainulindale Exflation\computations/_shared\s22b_block_diagonal_results.py`*
- *Eigenvector extraction: `C:\sandbox\Ainulindale Exflation\computations/_shared\s22b_eigenvectors.npz`*
