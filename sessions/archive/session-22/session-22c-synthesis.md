...
**Output files**: `computations/s22c_bcs_channel_scan.py/npz/txt`, `s22c_instanton_action.py/npz/txt`, `s22c_higgs_sigma.py/npz/png`, `s22c_order_one.py/txt`, `s22c_landau_classification.py/npz/txt/png`
...
|:-----|:---------|:--------|:-------|
| `computations/s22c_bcs_channel_scan.py` | feynman | F-1 BCS/Pomeranchuk scan | COMPLETE |
| `computations/s22c_bcs_channel_scan.npz` | feynman | Softening data, g*N(0), Pomeranchuk parameters | COMPLETE |
| `computations/s22c_bcs_channel_scan.txt` | feynman | Full tabular output | COMPLETE |
| `computations/s22c_instanton_action.py` | feynman | F-2 Instanton action, Stokes, grav-YM competition | COMPLETE |
| `computations/s22c_instanton_action.npz` | feynman | R(tau), K(tau), rho(tau), competition scan | COMPLETE |
| `computations/s22c_instanton_action.txt` | feynman | Full tabular output | COMPLETE |
| `computations/s22c_higgs_sigma.py` | connes | C-1 Higgs-sigma portal, three approaches | COMPLETE |
| `computations/s22c_higgs_sigma.npz` | connes | a_4 derivatives, lambda_{H,sigma} array | COMPLETE |
| `computations/s22c_higgs_sigma.png` | connes | Portal coupling vs tau | COMPLETE |
| `computations/s22c_order_one.py` | connes | C-2 order-one condition computation | COMPLETE |
| `computations/s22c_order_one.txt` | connes | Norm ||[[D,a],JbJ^{-1}]|| vs tau | COMPLETE |
| `computations/s22c_landau_classification.py` | landau | L-1/L-2/L-3 Landau + BCS-BEC + Exhaustion theorem | COMPLETE |
| `computations/s22c_landau_classification.npz` | landau | V_IR data, Ginzburg numbers, delta_T derivatives | COMPLETE |
| `computations/s22c_landau_classification.txt` | landau | Full output including L-3 formalization (lines 474-652) | COMPLETE |
| `computations/s22c_landau_classification.png` | landau | Classification plots | COMPLETE |
