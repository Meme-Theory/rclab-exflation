...
**Output files**: `computations/s22a_*.py/npz/png/txt`
...
|:-----|:---------|:-----------|:-------|
| `computations/s22a_slow_roll.py` | sp-geometer | SP-1 | COMPLETE |
| `computations/s22a_slow_roll.npz` | sp-geometer | SP-1 | COMPLETE |
| `computations/s22a_slow_roll.png` | sp-geometer | SP-1 | COMPLETE |
| `computations/s22a_weyl_curvature.py` | sp-geometer | SP-2 | COMPLETE |
| `computations/s22a_weyl_curvature.npz` | sp-geometer | SP-2 | COMPLETE |
| `computations/s22a_weyl_curvature.png` | sp-geometer | SP-2 | COMPLETE |
| `computations/s22a_euclidean_action.py` | sp-geometer | SP-3 | COMPLETE |
| `computations/s22a_euclidean_action.txt` | sp-geometer | SP-3 | COMPLETE |
| `computations/s22a_level_stats.py` | sp-geometer | SP-4 | COMPLETE |
| `computations/s22a_level_stats.npz` | sp-geometer | SP-4 | COMPLETE |
| `computations/s22a_level_stats.png` | sp-geometer | SP-4 | COMPLETE |
| `computations/s22a_dnp_bound.py` | sp-geometer | SP-5 | COMPLETE |
| `computations/s22a_dnp_bound.npz` | sp-geometer | SP-5 | COMPLETE |
| `computations/s22a_dnp_bound.png` | sp-geometer | SP-5 | COMPLETE |
| `computations/s22a_impedance.py` | qa-theorist | QA-1 | COMPLETE |
| `computations/s22a_impedance.npz` | qa-theorist | QA-1 | COMPLETE |
| `computations/s22a_impedance.png` | qa-theorist | QA-1 | COMPLETE |
| `computations/s22a_impedance.txt` | qa-theorist | QA-1 + QA-5 | COMPLETE |
| `computations/s22a_fano.py` | qa-theorist | QA-2 | COMPLETE |
| `computations/s22a_fano.txt` | qa-theorist | QA-2 | COMPLETE |
| `computations/s22a_delta_T_profile.py` | qa-theorist | QA-3 | COMPLETE |
| `computations/s22a_delta_T_profile.txt` | qa-theorist | QA-3 | COMPLETE |
| `computations/s22a_delta_T_profile.png` | qa-theorist | QA-3 | COMPLETE |
| `computations/s22a_paasch_curve.py` | qa-theorist | QA-4 | COMPLETE |
| `computations/s22a_paasch_curve.npz` | qa-theorist | QA-4 | COMPLETE |
| `computations/s22a_paasch_curve.png` | qa-theorist | QA-4 | COMPLETE |
