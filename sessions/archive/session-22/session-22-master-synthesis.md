...
|:-----|:---------------|:------------|:----------|:-------|
| S22 | V_tree minimum (17a SP-4) | OPEN | **CLOSED** | Monotonically decreasing |
| S22 | 1-loop Coleman-Weinberg (18) | OPEN | **CLOSED** | Monotonic, F/B = 8.4:1 (Trap 1) |
| S22 | Casimir scalar + vector (19d D-1) | OPEN | **CLOSED** | Constant-ratio trap |
| S22 | Seeley-DeWitt a₂/a₄ (20a SD-1) | OPEN | **CLOSED** | Both monotonic |
| S22 | Casimir with TT 2-tensors (20b L-3/L-4) | OPEN | **CLOSED** | Constant-ratio trap (F/B = 0.55) |
| S22 | D_K Pfaffian Z₂ (17c D-2) | OPEN | **CLOSED** | No sign change |
| S22 | Perturbative fermion condensate (19a S-4) | OPEN | **CLOSED** | No attractive channel (perturbative) |
| S22 | Single-field slow-roll (19b R-1) | OPEN | **CLOSED** | η >> 1 everywhere |
| S22 | Connes 8-cutoff positive spectral sums (21a) | OPEN | **CLOSED** | All monotonic, AM-GM proof |
| S22 | V''_total spinodal (21a Landau) | OPEN | **CLOSED** | V'' > 0 everywhere |
| S22 | S_signed(τ) gauge-threshold (21c R2) | OPEN | **CLOSED** | Monotonic all τ, Δ_b < 0 algebraic (Trap 2) |
| S22 | Coupled delta_T crossing (PB-3) | OPEN | **CLOSED** | Coupled = block-diagonal exactly |
| S22 | Coupled V_IR minimum (PB-2) | OPEN | **CLOSED** | Coupled = block-diagonal exactly |
| S22 | Higgs-sigma portal λ_{H,σ} (22c C-1) | OPEN | **CLOSED** | Exactly constant (Trap 3) |
| S22 | SP-2: Weyl |C|² monotonic | OPEN | **CLOSED** | Monotonically increasing |
| S22 | E-1: DESI w₀/wₐ match | OPEN | **CLOSED** (MARGINAL CLOSURE) | w ~ −1 all scenarios |
| S22 | Rolling modulus quintessence | OPEN | **CLOSED** | clock closure: 15,000× violation |
| S22 | DESI-compatible dynamical dark energy from rolling | OPEN | **CLOSED** | requires rolling, clock-closed |
| S22 | Stokes phenomenon at M1 | OPEN | **CLOSED** | exact crossings, no avoided crossings, no branch points |
| S22 | Inter-sector D_K coupling | OPEN | **CLOSED** | block-diagonality: C_{nm} = 0 identically |
| S22 | Session 21b "4-5x coupling" | OPEN | **CLOSED** | retracted: measured geometric tensor norm, not operator matrix elements |
| S22 | Tesla g·N(0) ~ 8-10 | OPEN | **CLOSED** | corrected to 3.24 by block-diagonality |
| S22 | Tesla phonon sound-speed Weinberg angle proposal | OPEN | **CLOSED** | 107% deviation |
