...
**Output files**: `computations/s22d_rolling_modulus.py`, `computations/s22d_rolling_trajectories.npz`, `computations/s22d_rolling_trajectories.png`, `computations/s22d_constraints.py`, `computations/s22d_constraint_results.npz`
