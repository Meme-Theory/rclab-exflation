...
8. Output directory: `computations/`
...
**Data files:**
- Script: `computations/s39_richardson_gaudin.py`
- Data: `computations/s39_richardson_gaudin.npz`
- Plot: `computations/s39_richardson_gaudin.png`
...
**Data files:**
- Script: `computations/s39_9to1_sweep.py`
- Data: `computations/s39_9to1_sweep.npz`
- Plot: `computations/s39_9to1_sweep.png`
...
Data files:
- Script: `computations/s39_schwinger_geometric.py`
- Data: `computations/s39_schwinger_geometric.npz`
- Plot: `computations/s39_schwinger_geometric.png`
...
2. B1 range [0.818, 0.873] and B2 range [0.845, 0.903] consistent with all prior computation computations
...
**Data files:**
- Script: `computations/s39_cascade_spectroscopy.py`
- Data: `computations/s39_cascade_spectroscopy.npz`
- Plot: `computations/s39_cascade_spectroscopy.png` (8-panel: band structure, group velocities, gap-edge splittings, sliding-window DOS, raw M_max, calibrated M_max, fold region detail, pairing interaction V(tau))
...
**Data files:**
- Script: `computations/s39_fubini_study.py`
- Data: `computations/s39_fubini_study.npz`
- Plot: `computations/s39_fubini_study.png`
...
**Data files:**
- Script: `computations/s39_gge_lambdas.py`
- Data: `computations/s39_gge_lambdas.npz`
- Plot: `computations/s39_gge_lambdas.png`
...
**Data files:**
- Script: `computations/s39_integrability_check.py`
- Data: `computations/s39_integrability_check.npz`
...
**Data files:**
- Script: `computations/s39_spectral_function.py`
- Data: `computations/s39_spectral_function.npz`
- Plot: `computations/s39_spectral_function.png`
...
**Data files:**
- Script: `computations/s39_friedmann_bcs.py`
- Data: `computations/s39_friedmann_bcs.npz`
- Plot: `computations/s39_friedmann_bcs.png` (6-panel: potential landscape, gradient hierarchy, trajectories, dwell vs H_0, amplification scan, e-fold impossibility)
...
**Data files:**
- Script: `computations/s39_schwinger_proof.py`
- Data: `computations/s39_schwinger_proof.npz`
...
Script: `computations/s39_schwinger_naz_review.py`. Data: `computations/s39_schwinger_naz_review.npz`.
...
**Data files:**
- Script: `computations/s39_schwinger_naz_review.py`
- Data: `computations/s39_schwinger_naz_review.npz`
...
**Data files:**
- Script: `computations/s39_kk_mass.py`
- Data: `computations/s39_kk_mass.npz`
...
**Files**: `computations/s39_bdg_simulation.py`, `s39_bdg_simulation.npz`, `s39_bdg_simulation.png`
...
**Data files:**
- Script: `computations/s39_odd_blocking.py`
- Data: `computations/s39_odd_blocking.npz`
- Plot: `computations/s39_odd_blocking.png`
...
**Files**: `computations/s39_bayes_gge_thermal.py` (script), `computations/s39_bayes_gge_thermal.npz` (data)
...
**Scripts**: `computations/s39_entanglement_entropy.py`
**Data**: `computations/s39_entanglement_entropy.npz`
...
**Scripts**: `computations/s39_geodesic_mass.py`
**Data**: `computations/s39_geodesic_mass.npz`
...
**Scripts**: `computations/s39_lie_derivative_integ.py`
**Data**: `computations/s39_lie_derivative_integ.npz`
...
**Files**: `computations/s39_gge_geodesic_constants.py` (script), `computations/s39_gge_geodesic_constants.npz` (data)
...
|:-----|:--------|:------|:-----|
| `computations/s39_richardson_gaudin.py` | Richardson-Gaudin exact solution | gen-physicist | W1-1 |
| `computations/s39_richardson_gaudin.npz` | RG data | gen-physicist | W1-1 |
| `computations/s39_richardson_gaudin.png` | RG plot | gen-physicist | W1-1 |
| `computations/s39_schwinger_geometric.py` | Schwinger exponent from curvature | gen-physicist | W1-3 |
| `computations/s39_schwinger_geometric.npz` | Schwinger data | gen-physicist | W1-3 |
| `computations/s39_schwinger_geometric.png` | Schwinger plot | gen-physicist | W1-3 |
| `computations/s39_9to1_sweep.py` | 9-to-1 tau sweep (B2-only + 8-mode) | gen-physicist | W1-2 |
| `computations/s39_9to1_sweep.npz` | R(tau) sweep data | gen-physicist | W1-2 |
| `computations/s39_9to1_sweep.png` | R(tau) 4-panel plot | gen-physicist | W1-2 |
| `computations/s39_cascade_spectroscopy.py` | Cascade spectroscopy (50 tau) | gen-physicist | W1-4 |
| `computations/s39_cascade_spectroscopy.npz` | Band structure + M_max data | gen-physicist | W1-4 |
| `computations/s39_cascade_spectroscopy.png` | 8-panel band structure plot | gen-physicist | W1-4 |
| `computations/s39_friedmann_bcs.py` | Coupled Friedmann-BCS dynamics | gen-physicist | W2-4 |
| `computations/s39_friedmann_bcs.npz` | Dwell times, trajectories, gradients | gen-physicist | W2-4 |
| `computations/s39_friedmann_bcs.png` | 6-panel: potential, gradients, trajectories, dwell scan | gen-physicist | W2-4 |
| `computations/s39_gge_lambdas.py` | GGE Lagrange multipliers | gen-physicist | W2-1 |
| `computations/s39_gge_lambdas.npz` | GGE data (lambda_k, p_k, entropy) | gen-physicist | W2-1 |
| `computations/s39_gge_lambdas.png` | 9-panel GGE diagnostics | gen-physicist | W2-1 |
| `computations/s39_integrability_check.py` | 8-mode integrability verification | gen-physicist | W2-2 |
| `computations/s39_integrability_check.npz` | Integrability data (level stats, Thouless, FGR) | gen-physicist | W2-2 |
| `computations/s39_spectral_function.py` | Post-quench spectral function A(omega) | gen-physicist | W2-3 |
| `computations/s39_spectral_function.npz` | GGE + equilibrium spectral data | gen-physicist | W2-3 |
| `computations/s39_spectral_function.png` | 4-panel spectral function plot | gen-physicist | W2-3 |
| `computations/s39_schwinger_proof.py` | Schwinger-instanton analytic proof | gen-physicist | W2-5 |
| `computations/s39_schwinger_proof.npz` | Proof data (GL ratio, shape factors, corrections) | gen-physicist | W2-5 |
| `computations/s39_odd_blocking.py` | Odd-particle blocking computation | gen-physicist | W3-5 |
| `computations/s39_odd_blocking.npz` | Blocking energies, mass table, thermal weights | gen-physicist | W3-5 |
| `computations/s39_odd_blocking.png` | 4-panel blocking diagnostics | gen-physicist | W3-5 |
| `computations/s39_bayes_gge_thermal.py` | Bayesian GGE vs thermal comparison | gen-physicist | W4-1 |
| `computations/s39_bayes_gge_thermal.npz` | BF, D_KL, JSD, occupations | gen-physicist | W4-1 |
