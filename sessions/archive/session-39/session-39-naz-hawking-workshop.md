...
**LEVEL 1: Genuinely promising -- could change the constraint map.**
...
**LEVEL 2: Valuable for the physical picture -- cannot change the constraint map.**
...
**LEVEL 3: Theoretically interesting -- practically irrelevant to the framework's viability.**
...
**LEVEL 5: Dead or computationally unreachable.**
