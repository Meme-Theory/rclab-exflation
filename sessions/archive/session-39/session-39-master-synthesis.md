...
| File | Content | Wave |
|:-----|:--------|:-----|
| `computations/s39_richardson_gaudin.py` | Richardson-Gaudin exact solution | W1-1 |
| `computations/s39_richardson_gaudin.npz` | RG data | W1-1 |
| `computations/s39_richardson_gaudin.png` | RG plot | W1-1 |
| `computations/s39_9to1_sweep.py` | 9-to-1 tau sweep | W1-2 |
| `computations/s39_9to1_sweep.npz` | R(tau) data | W1-2 |
| `computations/s39_9to1_sweep.png` | R(tau) plot | W1-2 |
| `computations/s39_schwinger_geometric.py` | Schwinger from curvature | W1-3 |
| `computations/s39_schwinger_geometric.npz` | Schwinger data | W1-3 |
| `computations/s39_schwinger_geometric.png` | Schwinger plot | W1-3 |
| `computations/s39_cascade_spectroscopy.py` | 50-point cascade | W1-4 |
| `computations/s39_cascade_spectroscopy.npz` | Band structure + M_max | W1-4 |
| `computations/s39_cascade_spectroscopy.png` | 8-panel band plot | W1-4 |
| `computations/s39_fubini_study.py` | Fubini-Study metric | W1-5 |
| `computations/s39_fubini_study.npz` | g_FS data | W1-5 |
| `computations/s39_fubini_study.png` | g_FS plot | W1-5 |
| `computations/s39_gge_lambdas.py` | GGE Lagrange multipliers | W2-1 |
| `computations/s39_gge_lambdas.npz` | GGE data | W2-1 |
| `computations/s39_gge_lambdas.png` | 9-panel GGE diagnostics | W2-1 |
| `computations/s39_integrability_check.py` | 8-mode integrability | W2-2 |
| `computations/s39_integrability_check.npz` | Level statistics, Thouless | W2-2 |
| `computations/s39_spectral_function.py` | Post-quench A(omega) | W2-3 |
| `computations/s39_spectral_function.npz` | GGE + eq spectral data | W2-3 |
| `computations/s39_spectral_function.png` | 4-panel spectral plot | W2-3 |
| `computations/s39_friedmann_bcs.py` | Friedmann-BCS dynamics | W2-4 |
| `computations/s39_friedmann_bcs.npz` | Dwell times, trajectories | W2-4 |
| `computations/s39_friedmann_bcs.png` | 6-panel potential + dynamics | W2-4 |
| `computations/s39_schwinger_proof.py` | Schwinger-instanton proof | W2-5 |
| `computations/s39_schwinger_proof.npz` | GL ratio, shape factors | W2-5 |
| `computations/s39_schwinger_naz_review.py` | Nazarewicz independent review | W2-5 |
| `computations/s39_schwinger_naz_review.npz` | Naz review data | W2-5 |
| `computations/s39_kk_mass.py` | 4D mass spectrum | W3-1 |
| `computations/s39_kk_mass.npz` | Mass table data | W3-1 |
| `computations/s39_bdg_simulation.py` | BdG time-dependent | W3-3 |
| `computations/s39_bdg_simulation.npz` | BdG evolution data | W3-3 |
| `computations/s39_bdg_simulation.png` | BdG plot | W3-3 |
| `computations/s39_odd_blocking.py` | Odd-particle blocking | W3-5 |
| `computations/s39_odd_blocking.npz` | Blocking energies | W3-5 |
| `computations/s39_odd_blocking.png` | 4-panel blocking | W3-5 |
| `computations/s39_bayes_gge_thermal.py` | Bayesian comparison | W4-1 |
| `computations/s39_bayes_gge_thermal.npz` | BF, D_KL data | W4-1 |
| `computations/s39_entanglement_entropy.py` | Entanglement entropy | W4-2 |
| `computations/s39_entanglement_entropy.npz` | ENT data | W4-2 |
| `computations/s39_geodesic_mass.py` | Geodesic mass cross-check | W4-3 |
| `computations/s39_geodesic_mass.npz` | GEOD data | W4-3 |
| `computations/s39_lie_derivative_integ.py` | Paper 18 Lie derivative | W4-4 |
| `computations/s39_lie_derivative_integ.npz` | LIED data | W4-4 |
| `computations/s39_gge_geodesic_constants.py` | GGE vs geodesic constants | W4-5 |
| `computations/s39_gge_geodesic_constants.npz` | GEOD-CONST data | W4-5 |
