...
Script: `computations/b2_baptista_verification.py`
...
Script: `computations/b3_dk_correctness_audit.py`
...
Scripts: `computations/sp2_final_verification.py`, `computations/sp2_analytic_derivation.py`
Plot: `computations/sp2_curvature_invariants_v2.png`
...
- Script: `computations/spectral_free_energy.py`
- Plot: `computations/spectral_free_energy.png`
...
### Scripts Produced
- `computations/b2_baptista_verification.py` (baptista, B-2)
- `computations/b3_dk_correctness_audit.py` (baptista, B-3)
- `computations/sp2_final_verification.py` (sp-geometer, SP-2 verification)
- `computations/sp2_analytic_derivation.py` (sp-geometer, SP-2 derivation + plots)
