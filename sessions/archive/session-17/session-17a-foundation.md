...
Script: `computations/d1_d3_j_compatibility.py` (229.6s runtime)
...
Scripts: `computations/coleman_weinberg.py`, `computations/cw_regularized.py`
...
- [x] SP-4: Exact analytic V_tree(s), verified against spectral_action.py
...
### Scripts Produced
- `computations/d1_d3_j_compatibility.py` (dirac, D-1 + D-3)
- `computations/coleman_weinberg.py` (hawking, H-1 raw CW)
- `computations/cw_regularized.py` (hawking, H-1 Boltzmann-regulated)
