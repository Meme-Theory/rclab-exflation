...
### DECISIVE (Level 1.5 — immediate next session)
...
| `coleman_weinberg.py` | Hawking | H-1: Raw CW 40-combo sweep |
| `cw_regularized.py` | Hawking | H-1: 6 regularization schemes + critical Lambda scan |
| `spectral_free_energy.py` | Hawking | H-2 bonus: Spectral free energy prototype |
