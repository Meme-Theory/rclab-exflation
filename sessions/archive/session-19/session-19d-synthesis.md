...
|:-----|:---------------|:------------|:----------|:-------|
| 2026-02-15 | D-1 gate (Casimir energy vs Coleman-Weinberg, linear spectral weighting) | OPEN | **CLOSED** | The gate returned a clean CLOSED: the fermion/boson ratio at linear weighting is 9.92:1 — worse than CW's 8.4:1 — and constant to 1.83% across τ ∈ [0, 2.0]. |
| 2026-02-15 | R variation < 5% criterion | OPEN | **CLOSED** | R variation 1.83% < 5% → CLOSED. |
| 2026-02-15 | dE_total/dτ sign criterion | OPEN | **CLOSED** | dE_total/dτ sign Negative everywhere, Same as CW → CLOSED. |
| 2026-02-15 | Polynomial/exponential spectral functionals class (Casimir, CW, spectral action, heat kernel, zeta function) | OPEN | **CLOSED** | This closes an entire class of spectral functionals simultaneously — Casimir, CW, spectral action, heat kernel, zeta function. All polynomial/exponential spectral functionals are closed for the computed modes. |
| 2026-02-15 | DOF theorem (no monotone weight function w(λ) > 0 can flip the sign of dE_total/dτ when DOF_fermion/DOF_boson >> 1) | OPEN | **PROMOTED** | Einstein praised the D-1 methodology as "how science operates" and elevated the DOF theorem to a permanent structural result of the framework, independent of its ultimate success or failure. |
