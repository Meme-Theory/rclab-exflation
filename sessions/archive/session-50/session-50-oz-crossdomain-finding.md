...
**Date**: 2026-03-20
**Method**: Research corpus cross-correlation + direct computation on existing computation data
**Status**: PRELIMINARY — 5 cross-domain routes tested, 2 survive with identity broken, 3 closed
**Script**: `computations/s50_crossdomain_routes.py`
...
3. Computing the SA correlator using existing computation data → finding 110% pole spread vs 0.051%
