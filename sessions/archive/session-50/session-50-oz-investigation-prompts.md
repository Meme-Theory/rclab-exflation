...
**Method**:
1. Read `computations/canonical_constants.py` for all framework constants.
2. Read `computations/s49_alpha_s_bayes.py` for the O-Z propagator implementation.
3. Read `computations/s49_dipolar_catalog.py` for Josephson coupling data.
4. Read `computations/s48_leggett_mode.npz` (or S48 Leggett data files) for omega_L1, omega_L2, J_ij values.
...
**Method**:
1. Read `computations/canonical_constants.py`.
2. Read `computations/s49_leggett_transit.py` and `.npz` for transit dynamics data.
3. Read `computations/s49_kz_3component.py` and `.npz` for the LZ pair creation data.
4. Read `computations/s49_dipolar_catalog.py` and `.npz` for the Leggett coupling data.
...
**Method**:
1. Read `computations/canonical_constants.py`.
2. Read `computations/s49_alpha_s_bayes.py` and `.npz`.
...
**Method**:
1. Read `computations/canonical_constants.py`.
2. Read `computations/s49_analog_trapped.py` and `.npz` for Mach field and condensate texture data.
3. Read `computations/s49_cavity_resonance.py` and `.npz` for c_BdG and cavity geometry.
...
**Method**:
1. Read `computations/canonical_constants.py`.
2. Read `computations/s49_bragg_goldstone.py` and `.npz` for tessellation geometry.
...
**Method**:
1. Read `computations/canonical_constants.py`.
2. Read `computations/s49_kz_3component.py` and `.npz` for the LZ formula.
3. Read `computations/s49_bragg_goldstone.py` and `.npz` for tessellation geometry.
