...
|:-----|:---------------|:------------|:----------|:-------|
| 2026-02-19 | 17a SP-4 V_tree minimum | OPEN | **CLOSED** | Monotonically decreasing; third-order inflection at tau=0; V'''(0) = -7.2 |
| 2026-02-19 | 18 1-loop Coleman-Weinberg | OPEN | **CLOSED** | Monotonically decreasing for all tau > 0 at all truncation orders; convergent to 0.55% between mps=5 and mps=6; F/B = 8.4:1 without TT |
| 2026-02-19 | 19d D-1 Casimir (scalar + vector only) | OPEN | **CLOSED** | R = 9.92:1, constant to 1.83%; same monotonicity as V_CW |
| 2026-02-19 | 19d Spectral back-reaction (scalar + vector) | OPEN | **CLOSED** | Same sign as V_CW; reinforces runaway |
| 2026-02-19 | 19a S-4 Fermion condensate | OPEN | **CLOSED** | Spectral gap > 0.818 everywhere in tau; gap never closes |
| 2026-02-19 | 20a SD-1 Spectral action NCG (Seeley-DeWitt) | OPEN | **CLOSED** | da_2/dtau > 0 AND da_4/dtau > 0 everywhere; no f_2/f_0 ratio produces minimum; structural, not parametric |
| 2026-02-19 | 20b L-3/L-4 Casimir (with TT 2-tensors, complete mode content) | OPEN | **CLOSED** | F/B = 0.553-0.558, constant (1.8%), monotonically increasing; E_TT accounts for 94.4% of total bosonic E_proxy; structural, not truncation artifact |
| 2026-02-19 | 19b R-1 Single-field tau slow-roll inflation | OPEN | **CLOSED** | epsilon ~ 2.1 >> 1 everywhere |
| 2026-02-19 | K1: s_0 outside [0.24, 0.37] | OPEN | **CLOSED** | (vacuously) No s_0 exists — no minimum found |
| 2026-02-19 | K2: No minimum at any s > 0 | OPEN | **CLOSED** | (definitively) Sessions 18/19d/20a/20b all confirm |
| S20 | Task #10: Does V_eff select s_0 ~ 0.15? | Waiting for V_eff | **CLOSED** | no s_0 exists from perturbative V_eff; 20b CLOSED |
| S20 | Task #13: Seeley-DeWitt convergence at max_pq=5-6 | OPEN | **CLOSED** | RESOLVED — CLOSED by 20a SD-1; SD-1 demonstrated convergence and closure |
| S20 | Task #16: CW convergence H-1 (0/40 minima, 80% Boltzmann) | Superseded | **CLOSED** | Session 18 full computation supersedes and closes |
| S20 | Task #19: Fix kk1_bosonic_spectrum.npz multiplicity bug (dim^2 vs dim) | OPEN | **CLOSED** | Bug is in data file not used in Sessions 20a/20b; superseded by l20 files |
