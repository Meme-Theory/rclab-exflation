...
**Output files:**
- `computations/l20_vtotal_minimum.npz` — full data at 21 tau-values
- `computations/l20_TT_spectrum.npz` — TT eigenvalues per sector
- `computations/l20_vtotal_minimum.png` — 6-panel plot (V_tree, V_CW, E_Casimir, V_total, F/B ratio, dV/dtau)
...
Band structure files: `computations/l20_band_structure.png`, `computations/l20_spectral_gaps.png`
