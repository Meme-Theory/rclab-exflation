...
|:-----|:------|:-------|:-------|
| SD-1: Seeley-DeWitt fast gate | connes | COMPLETE | `computations/sd20a_seeley_dewitt_gate.py` |
| R-1: Full Riemann tensor | phonon-sim | COMPLETE | `computations/r20a_riemann_tensor.py` + `r20a_riemann_tensor.npz` |
...
Data file: `computations/r20a_riemann_tensor.npz` — R_abcd at shape (21, 8, 8, 8, 8).
