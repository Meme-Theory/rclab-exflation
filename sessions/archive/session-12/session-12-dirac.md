# Session 12: Level 1 Dirac Spectrum Computation — Results
...
Built and executed `computations/dirac_spectrum.py` (1572 lines):
...
|------|--------|-------|---------|
| `dirac_spectrum.py` | sim-specialist | 1572 | Complete Level 1 Dirac computation |
