...
**Script**: `computations/s37_cutoff_sa.py`
**Data**: `computations/s37_cutoff_sa.npz`
**Plot**: `computations/s37_cutoff_sa.png`
...
**Script**: `computations/s37_cutoff_crosscheck.py` | **Data**: `computations/s37_cutoff_crosscheck.npz`
...
**Script**: `computations/s37_k7_g1.py`
**Data**: `computations/s37_k7_g1.npz`
**Runtime**: 0.1s
...
**Script**: `computations/s37_instanton_action.py`
**Data**: `computations/s37_instanton_action.npz`
**Plot**: `computations/s37_instanton_action.png`
...
**Script**: `computations/s37_pair_susceptibility.py`
**Data**: `computations/s37_pair_susceptibility.npz`
**Plot**: `computations/s37_pair_susceptibility.png`
...
**Script**: `computations/s37_oneloop_sa.py`
**Data**: `computations/s37_oneloop_sa.npz`
**Plot**: `computations/s37_oneloop_sa.png`
...
**Gate**: INST-MC-37
**Script**: `computations/s37_instanton_mc.py`
**Data**: `computations/s37_instanton_mc.npz`
**Plot**: `computations/s37_instanton_mc.png`
...
|:-----|:---------------|:------------|:----------|:-------|
| 2026-03-08 | CUTOFF-SA-37 | OPEN | **CLOSED** | S_f(tau) has NO local minimum in [0.15, 0.25] for ANY smooth cutoff function f at ANY cutoff scale Lambda in [0.3, 20.0]. The result is STRUCTURAL. |
| 2026-03-08 | CC-CANCELLATION-37 | OPEN | **CLOSED** | dS_f/dtau does not vanish at the fold for any smooth (f, Lambda). |
| 2026-03-08 | CC-SCALE-37 | OPEN | **CLOSED** | No Lambda_crit exists where the gradient vanishes for smooth cutoffs. |
| 2026-03-08 | Cutoff-modified spectral action stabilization of tau | OPEN | **CLOSED** | This computation CLOSES the hypothesis that a cutoff function applied to the spectral action can stabilize tau at the fold. The closure is PERMANENT. |
| 2026-03-08 | K7-G1-37 | OPEN | **CLOSED** | The (B1, B3_0, G1) triad is K_7-incompatible by algebraic representation theory. The fundamental (1,0) of SU(3) has no trivial component under U(1)_7 -- this is a weight-space fact, independent of tau, independent of numerics. |
| 2026-03-08 | INST-37a | OPEN | **CLOSED** | S_inst = 0.069 < 0.5 by a factor of 7.3. Robust across all direct numerical methods (range [0.069, 0.115]). exp(-S_inst) = 0.934. |
| 2026-03-08 | F.2 Pole/Continuum Ratio | OPEN | **CLOSED** | 0.855 -- NEAR-CLOSURE REGIME. The pair-addition strength is concentrated in a single giant collective mode. |
| 2026-03-08 | F.3 Vacuum Polarization Energy | OPEN | **CLOSED** | |E_vac|/|E_cond| = 28.8 >> nuclear benchmark of 0.05-0.15. |
| 2026-03-08 | F5-ONELOOP-37 | OPEN | **CLOSED** | The total one-loop correction at the fold is delta_S = +12.63 (POSITIVE), not negative. BCS condensation RAISES the spectral action through the BdG eigenvalue shift, which overwhelms the attractive condensation energy by 93x. |
| 2026-03-08 | "Hidden nugget" hypothesis (virtual pair fluctuations trap tau) | OPEN | **CLOSED** | Virtual pair fluctuations cannot self-consistently trap tau because the spectral action is the WRONG functional: it penalizes pairing rather than rewarding it. |
| 2026-03-08 | INST-MC-37 | OPEN | **CLOSED** | n_inst * xi_BCS = 2.98 (0D MC), 1.35 (lattice temporal), 4.03 (extended spatial). All three metrics exceed the dense gas threshold (0.5) by factors of 2.7x to 8x. |
