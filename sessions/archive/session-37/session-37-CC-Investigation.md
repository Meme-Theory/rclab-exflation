...
**Script**: `computations/s36_cc_arithmetic.py`
**Data**: `computations/s36_cc_arithmetic.npz`
...
| File | Description |
|:-----|:------------|
| `computations/s36_cc_arithmetic.py` | Computation script (419 lines) |
| `computations/s36_cc_arithmetic.npz` | All results: SD coefficients, vacuum energies, gradients |
