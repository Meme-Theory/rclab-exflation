...
**Input**: `computations/s45_kz_ns.npz`, `computations/s44_dos_tau.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_landau_zener_ns.py`, `.npz`, `.png`
...
**Input**: `computations/s44_dos_tau.npz`, `computations/s45_acoustic_ns.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_berry_phase.py`, `.npz`, `.png`
...
**Input**: `computations/s42_hauser_feshbach.npz`, `computations/s45_collective_ns_rpa.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_anomalous_dispersion.py`, `.npz`, `.png`
...
**Input**: `computations/s45_fwd_bwd_ns.npz`, `computations/s45_kz_ns.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_fwd_bwd_ns.py`, `.npz`, `.png`
...
**Input**: `computations/s44_dos_tau.npz`, `computations/s45_kz_ns.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_nonsinglet_dissipation.py`, `.npz`, `.png`
...
**Input**: `computations/s44_voronoi_fnl.npz`, `computations/s44_coherent_wall.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_fabric_tessellation.py`, `.npz`, `.png`
...
**Input**: `computations/s45_qtheory_bcs.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_bayesian_gp.py`, `.npz`, `.png`
...
**Input**: `computations/s44_multi_t_jacobson.npz`, `computations/s45_qtheory_bcs.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_multi_jacobson.py`, `.npz`, `.png`
...
**Input**: `computations/s42_hauser_feshbach.npz`, `computations/s44_dos_tau.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_gcm_zero_point.py`, `.npz`, `.png`
...
**Input**: `computations/s45_gge_beating.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_three_freq_universe.py`, `.npz`, `.png`
...
**Input**: `computations/s45_dissolution_entropy.npz` (script exists), `computations/canonical_constants.py`
**Output**: `computations/s46_dissolution_singlet.py`, `.npz`, `.png`
...
**Input**: `computations/s44_eih_grav.npz`, `computations/s44_dissolution_scaling.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_peter_weyl_censorship.py`, `.npz`, `.png`
...
Compute K(t) = |sum_k d_k e^{i lambda_k t}|^2 / (sum d_k)^2 for the truncated D_K spectrum at the fold. Identify the Heisenberg time t_H (onset of plateau), the ramp-plateau structure (GUE vs GOE vs Poisson), and tau dependence. K(t) is a Level 1 quantity probing two-point eigenvalue correlations. The SFF diagnostic determines whether the spectrum has random-matrix-like correlations or is integrable.

**Input**: `computations/s44_dos_tau.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_spectral_form_factor.py`, `.npz`, `.png`
...
**Input**: `computations/s44_dos_tau.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_spectral_zeta_nonint.py`, `.npz`, `.png`
**Gate**: Diagnostic.
...
**Input**: W2-4 output (`s46_omega_classify.npz`), `computations/canonical_constants.py`
**Output**: `computations/s46_sa_omega_tau.py`, `.npz`, `.png`
...
**Input**: `researchers/Connes/36_2026_de_Groot_Pseudo_Riemannian_Spectral_Triples_SU11.md`, `computations/canonical_constants.py`
**Output**: `computations/s46_pseudo_riemannian.py`, `.npz`, `.png`
...
**Input**: `computations/s42_hauser_feshbach.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_phonon_magnetic_moment.py`, `.npz`, `.png`
**Gate**: Diagnostic.
...
**Input**: `computations/s45_gge_beating.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_kapitza_parametric.py`, `.npz`, `.png`
...
**Input**: `computations/s45_truncated_torsion.npz` (if exists), `computations/canonical_constants.py`
**Output**: `computations/s46_bekenstein_torsion.py`, `.npz`, `.png`
**Gate**: Diagnostic.
...
**Input**: `computations/s45_qtheory_bcs.npz`, `computations/s42_gge_energy.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_gsl_qtheory.py`, `.npz`, `.png`
...
**Input**: `computations/s45_kretschner.npz` (if exists), `computations/canonical_constants.py`
**Output**: `computations/s46_wch_qtheory.py`, `.npz`, `.png`
**Gate**: Diagnostic.
...
**Input**: `computations/s42_hauser_feshbach.npz`, `computations/s42_gge_energy.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_sa_entropy.py`, `.npz`, `.png`
**Gate**: Diagnostic.
...
**Input**: `computations/s45_kz_ns.npz`, `computations/canonical_constants.py`
**Output**: `computations/s46_transplanckian.py`, `.npz`, `.png`
