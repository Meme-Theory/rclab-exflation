...
Input: computations/session-24/s24a_vspec.npz
       computations/session-28/s28c_steady_state_mu.npz
       computations/session-22/s22d_rolling_trajectories.npz
       computations/session-26/s26_multimode_bcs.npz
Output: computations/session-29/s29a_derived_drive_rate.npz
        computations/session-29/s29a_derived_drive_rate.png
