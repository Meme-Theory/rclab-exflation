...
theta_big = 0.5  # large mixing  # (local)
...
print(f"\n  Plot saved: computations/session-48/s48_goldstone_mass.png")
...
print(f"\n  Data saved: computations/session-48/s48_goldstone_mass.npz")
