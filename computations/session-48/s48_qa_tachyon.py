...
edge_threshold = 0.01  # 1% of typical energy scale  # (local)
...
n_realizations = 200
n_t = 500  # (local)
t_max_sff = 200.0  # In units of mean level spacing  # (local)
...
print("  requires modifying dirac_spectrum.py infrastructure.")
...
ax.fill_between([0, 1], omega_B2 - gamma_B2, omega_B2 + gamma_B2,
                 alpha=0.2, color='coral', label=f'B2 linewidth ($Q$={Q_B2:.0f})')  # (local)
...
Output: computations/session-48/s48_qa_tachyon.{{npz,png,py}}
""")
