...
Input:  s46_berry_phase.npz, s44_dissolution_scaling.npz, dirac_spectrum
...
PI_TOL_STRICT = 0.02   # |gamma/pi - 1| < 0.02  # (local)
PI_TOL_LOOSE = 0.032   # |gamma/pi - 1| < 0.032 (equivalent to |gamma - pi| < 0.1 rad)  # (local)
...
Output: computations/session-48/s48_dissolution_berry.{{npz,png}}
""")
