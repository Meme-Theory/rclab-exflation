...
#
# In dirac_spectrum.py, D_pi = sum_a rho(e_a) x gamma_a + I x Omega
...
E_gap_edge = 0.85  # Near the BCS gap  # (local)
...
Output: computations/session-48/s48_eigenvectors.{{npz,png}}
""")
