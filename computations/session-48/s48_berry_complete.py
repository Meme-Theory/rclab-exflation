...
PHASE_TOL = 0.01  # Gate criterion: all gamma = 0 +/- 0.01  # (local)
...
match_threshold = 0.05  # within 5% of VH position  # (local)
n_matched = 0
matches = []
...
Output: computations/session-48/s48_berry_complete.{{npz,png,py}}
""")
