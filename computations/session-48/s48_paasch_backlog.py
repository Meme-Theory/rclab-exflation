...
alpha_star = 0.775  # S47 corrected value (was 3.91 before retraction)  # (local)
alpha_star_retracted = 3.91  # For comparison  # (local)
...
delta_ppm = 0.5e-6  # 0.5 ppm tolerance (as specified)  # (local)
...
f_ln = 0.5671433  # Solution of ln(f) = -f (Eq. 2.6 of FSC paper)  # (local)
