...
d46 = np.load("computations/session-46/s46_qtheory_selfconsistent.npz", allow_pickle=True)
d35 = np.load("computations/session-35/s35_thouless_multiband.npz", allow_pickle=True)
...
np.savez(
    "computations/session-48/s48_chi_q_phase.npz",
    # Tau grid
...
print(f"\nSaved: computations/session-48/s48_chi_q_phase.npz")
print("=" * 78)
