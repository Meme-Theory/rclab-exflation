"""
PHI-STRUCTURE ANALYSIS OF THE DIRAC SPECTRUM ON (SU(3), g_s)
=============================================================
...
from dirac_spectrum.py and spectral action from spectral_action.py.
...
def main():
    print("=" * 80)
    print("PHI-STRUCTURE ANALYSIS OF SU(3) DIRAC SPECTRUM")
    print("=" * 80)
