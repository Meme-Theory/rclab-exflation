...
# 9. Save results
# ============================================================
np.savez("computations/session-43/s43_lrd_clustering.npz",
    rp_bins=rp_bins,
    wp_dm=wp_dm,
    wp_obs=wp_obs,
    wp_err=wp_err,
...
plt.tight_layout()
plt.savefig("computations/session-43/s43_lrd_clustering.png", dpi=150, bbox_inches='tight')
plt.close()
...
Output files:
  computations/session-43/s43_lrd_clustering.py   (this script)
  computations/session-43/s43_lrd_clustering.npz  (numerical results)
  computations/session-43/s43_lrd_clustering.png  (3-panel figure)
""")
