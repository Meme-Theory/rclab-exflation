...
np.savez('computations/session-43/s43_parametric_resonance.npz',
    # Mode data
    E_fold=E_fold,
    eps_fold=eps_fold,
...
print("\nSaved: computations/session-43/s43_parametric_resonance.npz")
...
plt.tight_layout()
plt.savefig('computations/session-43/s43_parametric_resonance.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-43/s43_parametric_resonance.png")
