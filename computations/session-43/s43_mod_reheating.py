...
Input:
  - computations/session-43/s43_kz_transfer.npz (W3-5)
  - computations/session-42/s42_gradient_stiffness.npz (S42)
  - computations/session-43/s43_offjensen_z_matrix.npz (W4-1)

Output:
  - computations/session-43/s43_mod_reheating.npz
  - computations/session-43/s43_mod_reheating.png
...
# 1. Load input data
# ============================================================
kz = np.load('computations/session-43/s43_kz_transfer.npz', allow_pickle=True)
grad = np.load('computations/session-42/s42_gradient_stiffness.npz', allow_pickle=True)
zmat = np.load('computations/session-43/s43_offjensen_z_matrix.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-43/s43_mod_reheating.png', dpi=150, bbox_inches='tight')
print("\n  Plot saved: computations/session-43/s43_mod_reheating.png")

# ============================================================
# 12. Save results
# ============================================================
np.savez('computations/session-43/s43_mod_reheating.npz',
    # Gate
...
print("  Data saved: computations/session-43/s43_mod_reheating.npz")
