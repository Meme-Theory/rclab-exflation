...
# Save results
# ---------------------------------------------------------------------------
np.savez("computations/session-43/s43_cw_preregistrations.npz",
    # F.1
...
ax.fill_between(r_array,
                ...
                r_array**2 * (xi_l + 2*sigma_noise_array),
                alpha=0.15, color='gray', label=r'DESI DR2 $2\sigma$')  # (local)
...
ax.fill_between(r_array,
                ...
                r_array**2 * 2*sigma_noise_array,
                alpha=0.2, color='gray', label=r'DESI DR2 $2\sigma$ noise')  # (local)
ax.axvspan(305, 345, alpha=0.08, color='red', label='Search window')
...
plt.savefig("computations/session-43/s43_cw_preregistrations.png", dpi=150, bbox_inches='tight')
plt.close()
