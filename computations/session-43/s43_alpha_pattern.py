...
# ============================================================
h = np.load('computations/session-42/s42_homogeneity.npz', allow_pickle=True)
g = np.load('computations/session-42/s42_gradient_stiffness.npz', allow_pickle=True)
c = np.load('computations/session-42/s42_constants_snapshot.npz', allow_pickle=True)
kz = np.load('computations/session-42/s42_kz_fnl.npz', allow_pickle=True)
...
np.savez('computations/session-43/s43_alpha_pattern.npz',
    # Input parameters
    tau_fold=tau_fold,
...
print("  Saved: computations/session-43/s43_alpha_pattern.npz")
...
plt.tight_layout()
plt.savefig('computations/session-43/s43_alpha_pattern.png', dpi=150, bbox_inches='tight')
print("  Saved: computations/session-43/s43_alpha_pattern.png")
