...
Framework context:
  N_eff = 32 distinct Dirac eigenvalues at round SU(3).  # (local)
...
def main():
    ...
    np.savez('computations/session-43/s43_persistent_homology.npz', **save_dict)
    print(f"\nData saved to computations/session-43/s43_persistent_homology.npz")
...
def make_plots(stats, fill_ref, enhancements, labels):
    ...
    plt.savefig('computations/session-43/s43_persistent_homology.png',
                dpi=150, bbox_inches='tight')
    plt.close()
    print("Plot saved to computations/session-43/s43_persistent_homology.png")
