...
n_s = 1 - 6*epsilon_V + 2*eta_V  # (local)
...
# 12. Save results
# ============================================================
np.savez('computations/session-43/s43_qfluc_tau0.npz',
    # tau=0 characterization
    S_0=S_0,
    dS_dtau_0=dS_dtau_0,
...
print(f"\nResults saved to computations/session-43/s43_qfluc_tau0.npz")
...
plt.tight_layout()
plt.savefig('computations/session-43/s43_qfluc_tau0.png', dpi=150, bbox_inches='tight')
print("Plot saved to computations/session-43/s43_qfluc_tau0.png")
plt.close()
