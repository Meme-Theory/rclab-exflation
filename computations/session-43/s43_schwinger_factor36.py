...
plt.tight_layout()
plt.savefig('computations/session-43/s43_schwinger_factor36.png', dpi=150, bbox_inches='tight')
print()
print("Figure saved: computations/session-43/s43_schwinger_factor36.png")

# ============================================================
# 8. SAVE DATA
# ============================================================

np.savez('computations/session-43/s43_schwinger_factor36.npz',
         # Gate
...
print("Data saved: computations/session-43/s43_schwinger_factor36.npz")
