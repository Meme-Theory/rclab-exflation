...
# 1. LOAD INPUT DATA
# ============================================================
homog = np.load('computations/session-42/s42_homogeneity.npz', allow_pickle=True)
...
np.savez('computations/session-43/s43_perlman_blur.npz',
    # Input parameters
    tau_fold=tau_fold,
    S_fold=S_fold,
    dS_fold=dS_fold,
...
print("Data saved to computations/session-43/s43_perlman_blur.npz")
print()
...
plt.tight_layout()
plt.savefig('computations/session-43/s43_perlman_blur.png', dpi=150, bbox_inches='tight')
print("Plot saved to computations/session-43/s43_perlman_blur.png")
print()
