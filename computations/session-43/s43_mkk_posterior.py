...
def log_likelihood_FIRAS(M_KK):
    ...
    val = 0.5 * erfc(x / np.sqrt(2.0))  # (local)
...
print("Saved: computations/session-43/s43_mkk_posterior.npz")
...
ax5.fill_between(log10_MKK[mask],
                 ...
                 ALPHA_EM_MZ_INV + sigma_alpha_th,
                 alpha=0.15, color='blue', label=rf'$\pm\sigma_{{th}}$ = {sigma_alpha_th}')  # (local)
...
print("Saved: computations/session-43/s43_mkk_posterior.png")
plt.close()
