...
# Load framework data
data = np.load('computations/session-42/s42_fabric_wz_v2.npz', allow_pickle=True)
...
plt.savefig('computations/session-43/s43_dowker_sorkin.png', dpi=150, bbox_inches='tight')
print("\nFigure saved: computations/session-43/s43_dowker_sorkin.png")

# =============================================================================
# 10. SAVE RESULTS
# =============================================================================
np.savez('computations/session-43/s43_dowker_sorkin.npz',
    # Gate info
...
print("Data saved: computations/session-43/s43_dowker_sorkin.npz")
