...
# ============================================================
f_sky = 0.4  # SO LAT wide survey (local)
...
# ============================================================
np.savez(
    "computations/session-43/s43_simons_prereg.npz",
...
print(f"\nSaved: computations/session-43/s43_simons_prereg.npz")
...
plt.tight_layout()
plt.savefig("computations/session-43/s43_simons_prereg.png", dpi=150, bbox_inches='tight')
print(f"Saved: computations/session-43/s43_simons_prereg.png")
