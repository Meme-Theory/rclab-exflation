...
# 12. Save data
# ==============================================================
np.savez("computations/session-43/s43_void_catalog.npz",
    # Grid
    R_v_grid=R_v_grid,
    n_svdw=n_svdw,
    # Observed (mock)
...
print(f"\nData saved to computations/session-43/s43_void_catalog.npz")
...
plt.tight_layout()
plt.savefig("computations/session-43/s43_void_catalog.png", dpi=150, bbox_inches='tight')
print(f"Plot saved to computations/session-43/s43_void_catalog.png")
