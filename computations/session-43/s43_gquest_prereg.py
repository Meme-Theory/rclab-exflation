...
Inputs:
  - computations/session-42/s42_fabric_dispersion.npz (m_tau, c_fabric)
  - GQuEST parameters from Paper 17 (Vermeulen+ 2025, PRX 15 011034)

Outputs:
  - computations/session-43/s43_gquest_prereg.npz (all computed quantities)
  - computations/session-43/s43_gquest_prereg.png (suppression factor visualization)
...
# ============================================================
d = np.load('computations/session-42/s42_fabric_dispersion.npz', allow_pickle=True)
...
np.savez('computations/session-43/s43_gquest_prereg.npz', **results)
print("Saved: computations/session-43/s43_gquest_prereg.npz")
...
# Annotate fold point
fold_idx = 5  # tau=0.19 is the fold (local)
...
plt.savefig('computations/session-43/s43_gquest_prereg.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-43/s43_gquest_prereg.png")
