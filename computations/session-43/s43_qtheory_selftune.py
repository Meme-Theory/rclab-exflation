...
d42g = np.load('computations/session-42/s42_gradient_stiffness.npz', allow_pickle=True)
...
d38 = np.load('computations/session-38/s38_cc_instanton.npz', allow_pickle=True)
Delta_0 = float(d38['Delta_0'])
xi_BCS = float(d38['xi_BCS'])
a_GL = float(d38['a_GL'])
b_GL = float(d38['b_GL'])

d42e = np.load('computations/session-42/s42_gge_energy.npz', allow_pickle=True)
...
d42c = np.load('computations/session-42/s42_constants_snapshot.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-43/s43_qtheory_selftune.png', dpi=150, bbox_inches='tight')
print("Plot saved: computations/session-43/s43_qtheory_selftune.png")
...
np.savez('computations/session-43/s43_qtheory_selftune.npz', **save_dict)
print("Data saved: computations/session-43/s43_qtheory_selftune.npz")
