...
Parameters (Planck 2018 TT,TE,EE+lowE+lensing, Table 2 of arXiv:1807.06209):
  ...
  w = -1 (cosmological constant)  # (local)
...
a_init = 1e-4  # z ~ 10000, deep in matter era (local)
...
# ============================================================
np.savez(
    "computations/session-43/s43_fsigma8.npz",
    z_desi=z_desi,
    a_desi=a_desi,
    D_desi=D_desi,
    f_desi=f_desi,
...
print("\nSaved: computations/session-43/s43_fsigma8.npz")
...
ax1.errorbar(z_desi, fsig8_desi, yerr=fsig8_err, fmt='ro', ms=8, capsize=4,
             lw=1.5, label='DESI DR1 RSD')  # (local)
...
plt.tight_layout()
plt.savefig("computations/session-43/s43_fsigma8.png", dpi=150, bbox_inches='tight')
print("Saved: computations/session-43/s43_fsigma8.png")
