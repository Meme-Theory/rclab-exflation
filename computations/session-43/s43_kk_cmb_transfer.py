...
kz_data = np.load('computations/session-43/s43_kz_transfer.npz', allow_pickle=True)
lif_data = np.load('computations/session-43/s43_lifshitz_class.npz', allow_pickle=True)
...
# Derived
from canonical_constants import M_Pl_unreduced as M_Pl  # GeV, k_pivot_planck
...
np.savez('computations/session-43/s43_kk_cmb_transfer.npz',
    # k grid and spectra
    k=k,
...
print(f"\nSaved: computations/session-43/s43_kk_cmb_transfer.npz")
...
plt.tight_layout()
plt.savefig('computations/session-43/s43_kk_cmb_transfer.png', dpi=150, bbox_inches='tight')
print(f"Saved: computations/session-43/s43_kk_cmb_transfer.png")
plt.close()
