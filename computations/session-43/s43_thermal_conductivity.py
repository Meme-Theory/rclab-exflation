...
qrpa = np.load('computations/session-40/s40_qrpa_modes.npz', allow_pickle=True)
mmax = np.load('computations/session-36/s36_mmax_authoritative.npz', allow_pickle=True)
...
b2_decay = np.load('computations/session-40/s40_b2_decay_out.npz', allow_pickle=True)
...
np.savez('computations/session-43/s43_thermal_conductivity.npz',
    # Frequencies
...
print("Data saved to computations/session-43/s43_thermal_conductivity.npz")
...
plt.savefig('computations/session-43/s43_thermal_conductivity.png', dpi=150, bbox_inches='tight')
print("Plot saved to computations/session-43/s43_thermal_conductivity.png")
plt.close()
