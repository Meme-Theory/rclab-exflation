...
# W1-1 results
d_qt = np.load('computations/session-43/s43_qtheory_selftune.npz', allow_pickle=True)
S_0 = float(d_qt['S_0'])
...
# Gradient stiffness
d_gs = np.load('computations/session-42/s42_gradient_stiffness.npz', allow_pickle=True)
...
# GGE energy
d_ge = np.load('computations/session-42/s42_gge_energy.npz', allow_pickle=True)
...
# DM profile (S42)
d_dm = np.load('computations/session-42/s42_dm_profile.npz', allow_pickle=True)
...
# Constants
d_cs = np.load('computations/session-42/s42_constants_snapshot.npz', allow_pickle=True)
...
d36 = np.load('computations/session-36/s36_sfull_tau_stabilization.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-43/s43_gge_dm_abundance.png', dpi=150, bbox_inches='tight')
print("Plot saved: computations/session-43/s43_gge_dm_abundance.png")
...
np.savez('computations/session-43/s43_gge_dm_abundance.npz', **save_dict)
print("Data saved: computations/session-43/s43_gge_dm_abundance.npz")
