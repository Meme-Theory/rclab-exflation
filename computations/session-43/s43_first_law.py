...
wz   = np.load('computations/session-42/s42_fabric_wz_v2.npz', allow_pickle=True)
...
np.savez('computations/session-43/s43_first_law.npz', **results)
print("Saved: computations/session-43/s43_first_law.npz")
...
plt.tight_layout()
plt.savefig('computations/session-43/s43_first_law.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-43/s43_first_law.png")
