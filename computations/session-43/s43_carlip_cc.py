...
d_stiff = np.load('computations/session-42/s42_gradient_stiffness.npz', allow_pickle=True)
d_qth = np.load('computations/session-43/s43_qtheory_selftune.npz', allow_pickle=True)
...
np.savez('computations/session-43/s43_carlip_cc.npz',
    # Framework Lambda
    S_fold=S_fold,
    S_0=S_0,
...
plt.savefig('computations/session-43/s43_carlip_cc.png', dpi=150, bbox_inches='tight')
print("Plot saved to computations/session-43/s43_carlip_cc.png")
