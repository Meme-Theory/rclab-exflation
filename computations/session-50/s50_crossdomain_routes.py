...
E_B2 = E_B2_mean  # (local)
E_B1 = 1.125   # NOTE: intentional override, differs from canonical E_B1 (0.819)
E_B3 = 1.245   # NOTE: intentional override, differs from canonical E_B3_mean (0.978)  # (local)
V_B2B2 = 0.1557  # (local)
...
# N_cells imported from canonical_constants (line 8: from canonical_constants import *)
nx, ny, nz = 4, 4, 2
J_xy_val = 0.933  # (local)
J_z_val = 0.059  # (local)
...
Gamma_GPV = 0.25   # M_KK (Landau damping, from S38)  # (local)
