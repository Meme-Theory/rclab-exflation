...
r_d = 147.09  # Mpc (Planck 2018 fiducial)  # (local)
...
err_scale_dr2 = 0.71  # DR2 ~ sqrt(2) better than DR1  # (local)
err_scale_dr3 = 0.58  # DR3 ~ sqrt(3) better than DR1  # (local)
