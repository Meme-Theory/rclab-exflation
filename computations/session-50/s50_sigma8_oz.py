...
# Three alpha_s cases
alpha_s_zero = 0.0  # (local)
alpha_s_oz = n_s**2 - 1.0                  # = -0.06896... (analytic O-Z)
alpha_s_lattice = -0.038                     # S48 lattice value (superseded)  # (local)

# Observational sigma_8 values
sigma_8_planck_val = 0.811  # (local)
sigma_8_planck_err = 0.006  # (local)
sigma_8_lensing_val = 0.766  # (local)
sigma_8_lensing_err = 0.020  # (local)
...
S8_planck = 0.832  # (local)
S8_planck_err = 0.013  # (local)
S8_des = 0.776  # (local)
