...
Q_Leggett = 6.7e5  # (local)
omega_L1 = 0.0696  # M_KK
omega_L2 = 0.1074  # M_KK
Gamma_L = omega_L1 / (2 * Q_Leggett)  # damping rate

# From W1-E: phi crossing data — tau_fold from canonical_constants
tau_phi = 0.2117  # phi crossing  # (local)
phi_paasch = 1.531580
dR_dtau = -0.553  # d(omega_L2/omega_L1)/dtau at crossing (monotone, transverse)  # (local)
...
dS_dtau = dS_fold  # canonical: 58672.80 at fold
d2S_dtau2 = d2S_fold  # canonical: 317862.85 at fold (convex)

# Transit parameters from S36/S38 — v_terminal, dt_transit from canonical_constants
delta_tau_transit = 0.030  # total tau traversed  # (local)
...
# S_fold imported from canonical_constants (250360.68)
Delta_fold = 0.084  # NOTE: intentional override — local B2 gap estimate, differs from canonical Delta_BCS (0.464)  # (local)
