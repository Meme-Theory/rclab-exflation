...
Delta_over_E_nuc = 0.35  # typical Delta/E_pair for sd-shell  # (local)
Delta_over_E_fw = Delta_B2_mean / E_B2_mean
F_transfer_nuc = 1.5  # typical for sd-shell with 1 pair (few levels near Fermi)  # (local)
F_transfer_fw = F_plain
J_over_EC_nuc = 0.07   # touching nuclei in sd shell  # (local)
...
frac_change_S36 = 0.19  # 19% from S36 convergence study  # (local)
...
if np.any(valid_ec):
    ...
    tau_star_best = 0.0  # (local)
    tau_star_low = 0.0  # (local)
