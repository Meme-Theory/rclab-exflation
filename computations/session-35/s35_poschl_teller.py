...
Inputs:
- computations/session-23/s23a_kosmann_singlet.npz  (eigenvalue curves)
- computations/session-33/s33w3_modulus_equation.npz (wall profile parameters)
- computations/session-33/s33w3_paasch_dump_point.npz (dump point data)
"""
...
d_kosmann = np.load('C:/sandbox/Ainulindale Exflation/computations/session-23/s23a_kosmann_singlet.npz',
                     allow_pickle=True)
d_wall = np.load('C:/sandbox/Ainulindale Exflation/computations/session-33/s33w3_modulus_equation.npz',
                  allow_pickle=True)
d_dump = np.load('C:/sandbox/Ainulindale Exflation/computations/session-33/s33w3_paasch_dump_point.npz',
                  allow_pickle=True)
...
if best_config is not None:
    ...
    coeff = 1.0 / (2.0 * G_tau_tau * best_config['w_wall']**2)  # (local)
...
if best_config is not None:
    ...
    coeff = 1.0 / (2.0 * G_tau_tau * w**2)  # (local)
...
plt.tight_layout()
plt.savefig('C:/sandbox/Ainulindale Exflation/computations/session-35/s35_poschl_teller.png', dpi=150)
print("\nFigure saved to computations/session-35/s35_poschl_teller.png")
...
np.savez('C:/sandbox/Ainulindale Exflation/computations/session-35/s35_poschl_teller.npz',
         # B2 eigenvalue data
...
print("\nResults saved to computations/session-35/s35_poschl_teller.npz")
print("\nDONE.")
