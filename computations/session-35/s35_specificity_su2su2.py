...
d_su3 = np.load('computations/session-33/s33a_strutinsky.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-35/s35_specificity_su2su2.png', dpi=150, bbox_inches='tight')
print("\nPlot saved: computations/session-35/s35_specificity_su2su2.png")
...
np.savez('computations/session-35/s35_specificity_su2su2.npz',
         s_values=s_values,
...
print("Data saved: computations/session-35/s35_specificity_su2su2.npz")
