...
m_G = 0.070   # M_KK, Leggett mass  # (local)
J_G = 0.641   # M_KK, effective Josephson stiffness  # (local)
...
dDelta_dtau = 0.0081   # M_KK per unit tau  # (local)
Delta_B2_val = 0.084   # M_KK  # (local)
J_C2_val = J_C2        # canonical: 0.933 M_KK
...
# ========================================================================
np.savez('computations/session-51/s51_sa_goldstone_mixing.npz',
         K_values=K_values,
         P_G_norm=P_G_norm,
...
print(f"\nData saved to computations/session-51/s51_sa_goldstone_mixing.npz")
...
plt.tight_layout()
plt.savefig('computations/session-51/s51_sa_goldstone_mixing.png', dpi=150, bbox_inches='tight')
print(f"Plot saved to computations/session-51/s51_sa_goldstone_mixing.png")
