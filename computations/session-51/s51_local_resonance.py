...
Usage:
  "phonon-exflation-sim/.venv312/Scripts/python.exe" computations/session-51/s51_local_resonance.py
"""
...
Delta_B2 = 0.855  # B2 BCS gap (M_KK) - from S45 multi-component  # (local)
epsilon_Leggett = 0.00248  # Leggett coupling fraction (S49)  # (local)
...
V_B2B2 = 0.1557  # BCS interaction (M_KK, S34 Schur)  # (local)
...
T_wall = 0.5  # Transmission through Z_3 wall (eta = 1/2)  # (local)
...
g2_texture = 0.0  # (local)
Sigma_texture = 0.0  # (local)
...
m_target = 12.0  # Target mass (M_KK)  # (local)
...
print(f"  Saved: computations/session-51/s51_local_resonance.png")
...
print(f"  Saved: computations/session-51/s51_local_resonance.npz")
