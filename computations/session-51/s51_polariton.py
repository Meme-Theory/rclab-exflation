...
m_G = 0.070            # Leggett mass = omega_L1 (S49 DIPOLAR-CATALOG)  # (local)
epsilon_inner = 0.052  # inner fluctuation breaking parameter (S49)  # (local)
rho_s = 7.962          # superfluid stiffness (S47, C2 Casimir)  # (local)
J_eff = 0.641          # effective Josephson coupling (2*J_C2 + J_su2)/3 (S48)  # (local)
...
dDelta_dtau = 0.0081                   # M_KK (task specification)  # (local)

# Pivot
K_pivot = 2.0                          # M_KK

# Damping
Q_Leggett = 670000.0  # (local)
