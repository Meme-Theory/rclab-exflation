...
for pq, data in mixing_results.items():
    ...
    V_same = 0.090  # typical V(same-charge) from (0,0) sector  # (local)
...
V_same_charge = 0.090  # from (0,0) sector V_fold diagonal  # (local)
...
print(f"  Saved: computations/session-47/s47_k7_filter.npz")
...
print(f"  Saved: computations/session-47/s47_k7_filter.png")
