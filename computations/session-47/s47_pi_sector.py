...
bp = np.load('computations/session-46/s46_berry_phase.npz', allow_pickle=True)
...
k7_data = np.load('computations/session-35/s35_k7_dphys.npz', allow_pickle=True)
...
cluster_B1_upper = 0.830  # above B1 (0.820), below B2 (0.836)  # (local)
cluster_B2_upper = 0.915  # above B2/high-B2 (0.873), below B3 (0.957)  # (local)
cluster_B3_upper = 0.985  # above B3 (0.972), below higher reps (1.022)  # (local)
...
np.savez('computations/session-47/s47_pi_sector.npz',
...
print(f"  Saved: computations/session-47/s47_pi_sector.npz")
...
plt.tight_layout()
plt.savefig('computations/session-47/s47_pi_sector.png', dpi=150, bbox_inches='tight')
print(f"  Saved: computations/session-47/s47_pi_sector.png")
