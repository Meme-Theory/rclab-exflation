...
cs = np.load('computations/session-42/s42_constants_snapshot.npz', allow_pickle=True)
...
np.savez('computations/session-42/s42_homogeneity.npz',
    tau_fold=tau_fold,
    Z_fold=Z_fold,
    d2S_fold=d2S_fold,
    a0_fold=a0_fold,
...
print("\nSaved: computations/session-42/s42_homogeneity.npz")
...
plt.savefig('computations/session-42/s42_homogeneity.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-42/s42_homogeneity.png")
plt.close()
