...
fab = np.load('computations/session-42/s42_fabric_dispersion.npz', allow_pickle=True)
...
np.savez('computations/session-42/s42_dm_profile.npz', **results)
print("  Saved: computations/session-42/s42_dm_profile.npz")
...
plt.savefig('computations/session-42/s42_dm_profile.png', dpi=150, bbox_inches='tight')
print("  Saved: computations/session-42/s42_dm_profile.png")
