...
data_wz = np.load('computations/session-42/s42_fabric_wz_v2.npz', allow_pickle=True)
...
np.savez('computations/session-42/s42_s8_tension.npz',
    # Gate
...
print(f"\nSaved: computations/session-42/s42_s8_tension.npz")
...
plt.tight_layout()
plt.savefig('computations/session-42/s42_s8_tension.png', dpi=150, bbox_inches='tight')
print(f"Saved: computations/session-42/s42_s8_tension.png")
