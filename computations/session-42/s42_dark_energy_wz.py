...
sd = np.load('computations/session-41/s41_constants_vs_tau.npz', allow_pickle=True)
...
# 11. SAVE DATA
# ========================================================================
np.savez('computations/session-42/s42_dark_energy_wz.npz',
    # w(z) prediction
    z_eval=z_eval,
    w_frozen=w_eval,
...
print(f"\n  Data saved: computations/session-42/s42_dark_energy_wz.npz")
...
plt.tight_layout()
plt.savefig('computations/session-42/s42_dark_energy_wz.png', dpi=150, bbox_inches='tight')
print(f"  Plot saved: computations/session-42/s42_dark_energy_wz.png")
