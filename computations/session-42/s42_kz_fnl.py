...
stiff = np.load(resolve_output(42, 's42_gradient_stiffness.npz'), allow_pickle=True)
dyn   = np.load(resolve_output(36, 's36_tau_dynamics.npz'), allow_pickle=True)
inst  = np.load(resolve_output(37, 's37_instanton_action.npz'), allow_pickle=True)
gl    = np.load(resolve_output(36, 's36_gl_cubic_check.npz'), allow_pickle=True)
const = np.load(resolve_output(42, 's42_constants_snapshot.npz'), allow_pickle=True)
c41   = np.load(resolve_output(41, 's41_constants_vs_tau.npz'), allow_pickle=True)
...
np.savez(resolve_output(42, 's42_kz_fnl.npz'), **save_dict)
print(f"\nData saved to: {resolve_output(42, 's42_kz_fnl.npz')}")
...
plt.tight_layout()
plt.savefig(resolve_output(42, 's42_kz_fnl.png'), dpi=150, bbox_inches='tight')
print(f"Plot saved to: {resolve_output(42, 's42_kz_fnl.png')}")
