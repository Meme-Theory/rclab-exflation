...
Input:
  computations/session-42/s42_gradient_stiffness.npz   (W1-1)
  computations/session-36/s36_sfull_tau_stabilization.npz
  computations/session-36/s36_tau_dynamics.npz
  computations/session-40/s40_collective_inertia.npz

Output:
  computations/session-42/s42_tau_dyn_reopening.npz
  computations/session-42/s42_tau_dyn_reopening.png
"""
