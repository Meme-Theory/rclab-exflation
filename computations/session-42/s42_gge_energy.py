...
np.savez('computations/session-42/s42_gge_energy.npz',
    # M_KK values
...
print("\nSaved: computations/session-42/s42_gge_energy.npz")
...
plt.savefig('computations/session-42/s42_gge_energy.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-42/s42_gge_energy.png")
plt.close()
