...
# ========================================================================
gs = np.load('computations/session-42/s42_gradient_stiffness.npz', allow_pickle=True)
fd = np.load('computations/session-42/s42_fabric_dispersion.npz', allow_pickle=True)
vor = np.load('computations/session-42/s42_giant_voronoi.npz', allow_pickle=True)
td = np.load('computations/session-42/s42_tau_dyn_reopening.npz', allow_pickle=True)
sf = np.load('computations/session-36/s36_sfull_tau_stabilization.npz', allow_pickle=True)
inst = np.load('computations/session-37/s37_instanton_action.npz', allow_pickle=True)
...
# 11. SAVE DATA
# ========================================================================
np.savez('computations/session-42/s42_fabric_wz_v2.npz',
    # Gate
    verdict=verdict,
...
print(f"\n  Data saved: computations/session-42/s42_fabric_wz_v2.npz")
...
plt.tight_layout()
plt.savefig('computations/session-42/s42_fabric_wz_v2.png', dpi=150, bbox_inches='tight')
print(f"  Plot saved: computations/session-42/s42_fabric_wz_v2.png")
