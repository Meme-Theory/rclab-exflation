...
def make_plots(results_z08, results_z16, save_path):
    ...
    ax4.hist(n_giant_08, bins=bins, density=True, color='steelblue', edgecolor='black',
             alpha=0.6, label=f'z = 0.8: P(N>=2) = {np.mean(n_giant_08 >= 2):.4f}')  # (local)
    ax4.hist(n_giant_16, bins=bins, density=True, color='coral', edgecolor='black',
             alpha=0.6, label=f'z = 1.6: P(N>=2) = {np.mean(n_giant_16 >= 2):.4f}')  # (local)
...
def main():
    ...
    npz_path = 'computations/session-42/s42_giant_voronoi.npz'
    ...
    # Plot
    # =================================================================
    plot_path = 'computations/session-42/s42_giant_voronoi.png'
