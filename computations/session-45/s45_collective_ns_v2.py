...
# Load data
occ = np.load('computations/session-45/s45_occ_spectral.npz', allow_pickle=True)
bcs = np.load('computations/session-38/s38_cc_instanton.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-45/s45_collective_ns_v2.png', dpi=150)
print("\nPlot saved to s45_collective_ns_v2.png")

# Save
np.savez('computations/session-45/s45_collective_ns_v2.npz',
