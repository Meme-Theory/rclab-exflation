...
N_modes = 992  # stored eigenvalues per tau (local)
...
print(f"""
  ...
  === DATA FILES ===
  Script: computations/session-45/s45_debye_waller.py
  Data:   computations/session-45/s45_debye_waller.npz
  Plot:   computations/session-45/s45_debye_waller.png
""")
