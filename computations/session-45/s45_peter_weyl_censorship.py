...
np.savez('computations/session-45/s45_peter_weyl_censorship.npz', **save_dict)
print("  Saved: computations/session-45/s45_peter_weyl_censorship.npz")
...
plt.savefig('computations/session-45/s45_peter_weyl_censorship.png', dpi=150, bbox_inches='tight')
print("  Saved: computations/session-45/s45_peter_weyl_censorship.png")
