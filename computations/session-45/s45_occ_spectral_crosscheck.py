...
def solve_multimode_bcs(E_k, rho_k, V_kk, mu=0.0, tol=1e-14, max_iter=20000):
    ...
    E_kin = 2.0 * np.sum(xi_k * n_k)  # (local)
...
Lambda_test = 2.0  # Test cutoff (M_KK units) (local)
...
print("  Saved: computations/session-45/s45_occ_spectral_crosscheck.npz")
...
print("Script: computations/session-45/s45_occ_spectral_crosscheck.py")
print("Data:   computations/session-45/s45_occ_spectral_crosscheck.npz")
