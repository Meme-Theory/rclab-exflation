...
inst = np.load('computations/session-38/s38_cc_instanton.npz', allow_pickle=True)
hf = np.load('computations/session-42/s42_hauser_feshbach.npz', allow_pickle=True)
fb = np.load('computations/session-43/s43_flat_band.npz', allow_pickle=True)
dos = np.load('computations/session-44/s44_dos_tau.npz', allow_pickle=True)
naz = np.load('computations/session-45/s45_occ_spectral_crosscheck.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-45/s45_collective_ns_rpa.png', dpi=150, bbox_inches='tight')
print("\nPlot saved: computations/session-45/s45_collective_ns_rpa.png")

# ============================================================
# 16. SAVE DATA
# ============================================================
np.savez('computations/session-45/s45_collective_ns_rpa.npz',
    # Input
    xi_8_fold=xi_8_fold,
...
print("Data saved: computations/session-45/s45_collective_ns_rpa.npz")
