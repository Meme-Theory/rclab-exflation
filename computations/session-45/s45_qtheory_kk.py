...
d43 = np.load('computations/session-43/s43_qtheory_selftune.npz', allow_pickle=True)
...
# S44 trace-log data
d_tl = np.load('computations/session-44/s44_tracelog_cc.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-45/s45_qtheory_kk.png', dpi=150, bbox_inches='tight')
print("Plot saved: computations/session-45/s45_qtheory_kk.png")
...
np.savez('computations/session-45/s45_qtheory_kk.npz', **save_dict)
print("Data saved: computations/session-45/s45_qtheory_kk.npz")
