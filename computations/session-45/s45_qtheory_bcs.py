...
d_w1 = np.load('computations/session-45/s45_qtheory_kk.npz', allow_pickle=True)
tau_star_w1 = float(d_w1['tau_star_7pt_quad'])
TL_singlet_w1 = d_w1['TL_singlet']

# S44 EIH singlet data
d_eih = np.load('computations/session-44/s44_eih_grav.npz', allow_pickle=True)
...
def get_singlet_groups(tau_val):
    ...
    unique_sq = []
    degs = []
    tol = 0.01  # clustering tolerance (local)
...
mu_ref_sq = 1.0  # mu_ref = M_KK  # (local)
...
np.savez('computations/session-45/s45_qtheory_bcs.npz', **save_dict)
print("Saved: computations/session-45/s45_qtheory_bcs.npz")
...
plt.tight_layout()
plt.savefig('computations/session-45/s45_qtheory_bcs.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-45/s45_qtheory_bcs.png")
...
Files:
  Script: computations/session-45/s45_qtheory_bcs.py
  Data:   computations/session-45/s45_qtheory_bcs.npz
  Plot:   computations/session-45/s45_qtheory_bcs.png
""")
