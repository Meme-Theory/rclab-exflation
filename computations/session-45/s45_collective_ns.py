...
ac = np.load('computations/session-45/s45_acoustic_ns.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-45/s45_collective_ns.png', dpi=150)
print("\nPlot saved.")

# Save
np.savez('computations/session-45/s45_collective_ns.npz',
    k_values=k_vals,
