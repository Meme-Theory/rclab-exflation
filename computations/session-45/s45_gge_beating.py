...
eps_rec = 0.01  # 1% tolerance on C(t)/C(0)  # (local)
...
print(f"  Saved: computations/session-45/s45_gge_beating.npz")
...
print(f"  Saved: computations/session-45/s45_gge_beating.png")
