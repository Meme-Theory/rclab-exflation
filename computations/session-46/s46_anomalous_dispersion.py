...
s45 = np.load('computations/session-45/s45_collective_ns_rpa.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-46/s46_anomalous_dispersion.png', dpi=150, bbox_inches='tight')
print("\nPlot saved: computations/session-46/s46_anomalous_dispersion.png")

# ================================================================
# 14. SAVE DATA
# ================================================================

np.savez('computations/session-46/s46_anomalous_dispersion.npz',
    # Input echoed
    k_values=k_values,
...
print("Data saved: computations/session-46/s46_anomalous_dispersion.npz")
