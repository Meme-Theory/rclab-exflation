...
Input
-----
- computations/session-45/s45_gge_beating.npz
- computations/_shared/canonical_constants.py

Output
------
- computations/session-46/s46_three_freq_universe.{npz,png}
"""
...
f_s = 5.683650050929318e-5   # from S44 EIH-GRAV-44, s46_transfer_function.npz  # (local)
...
k_rh_Mpc = 2.153541090487972e+28  # from s46_transfer_function.npz  # (local)
...
t_max = 500.0  # M_KK^-1 (several beat periods) (local)
n_t = 8192  # (local)
...
rho_SA_fold_w34 = 1585.43  # M_KK^4, from s46_transfer_function.npz  # (local)
