...
eih_data = np.load('computations/session-44/s44_eih_grav.npz', allow_pickle=True)
diss_data = np.load('computations/session-44/s44_dissolution_scaling.npz', allow_pickle=True)
...
try:
    hf_data = np.load('computations/session-42/s42_hauser_feshbach.npz', allow_pickle=True)
...
np.savez('computations/session-46/s46_peter_weyl_censorship.npz', **save_dict)
print("  Saved: computations/session-46/s46_peter_weyl_censorship.npz")
...
plt.savefig('computations/session-46/s46_peter_weyl_censorship.png', dpi=150, bbox_inches='tight')
print("  Saved: computations/session-46/s46_peter_weyl_censorship.png")
