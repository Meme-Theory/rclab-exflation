...
vor_data  = np.load('computations/session-44/s44_voronoi_fnl.npz', allow_pickle=True)
...
np.savez('computations/session-46/s46_fabric_tessellation.npz', **save_dict)
print(f"\n  Data saved to computations/session-46/s46_fabric_tessellation.npz")
...
plt.tight_layout()
plt.savefig('computations/session-46/s46_fabric_tessellation.png', dpi=150, bbox_inches='tight')
print(f"  Plot saved to computations/session-46/s46_fabric_tessellation.png")
