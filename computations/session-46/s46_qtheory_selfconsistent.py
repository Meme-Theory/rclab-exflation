...
d_lif = np.load('computations/session-43/s43_lifshitz_class.npz', allow_pickle=True)
...
d_hf = np.load('computations/session-42/s42_hauser_feshbach.npz', allow_pickle=True)
V_direct = {
...
np.savez('computations/session-46/s46_qtheory_selfconsistent.npz', **save_dict)
print("Saved: computations/session-46/s46_qtheory_selfconsistent.npz")
...
plt.tight_layout()
plt.savefig('computations/session-46/s46_qtheory_selfconsistent.png', dpi=150)
print("Saved: computations/session-46/s46_qtheory_selfconsistent.png")
