...
d_sc = np.load('computations/session-46/s46_qtheory_selfconsistent.npz', allow_pickle=True)
...
plt.tight_layout()
plot_path = 'computations/session-46/s46_number_projected_bcs.png'
...
np.savez_compressed('computations/session-46/s46_number_projected_bcs.npz', **save_dict)
print("Data saved: computations/session-46/s46_number_projected_bcs.npz")
