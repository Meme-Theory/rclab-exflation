...
def find_alpha_star(eps_arr, V, mu_val, target_E, tol=1e-6):
    ...
    E_vac = 0.0  # vacuum (no pairs) energy = 0 at mu=0  # (local)
...
print()
print(f"  FILES:")
print(f"    Script: computations/session-46/s46_v_b3b3.py")
print(f"    Data:   computations/session-46/s46_v_b3b3.npz")
print(f"    Plot:   computations/session-46/s46_v_b3b3.png")
