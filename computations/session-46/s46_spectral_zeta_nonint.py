...
def main():
    ...
    print(f"  Saved: computations/session-46/s46_spectral_zeta_nonint.npz")
    ...
    print(f"  Saved: computations/session-46/s46_spectral_zeta_nonint.png")
    plt.close()
