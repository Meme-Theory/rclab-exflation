...
from canonical_constants import tau_fold, r_GOE_canonical
...
Delta_mean_unfolded = 1.0  # by construction  # (local)
...
# Time arrays
N_t = 10000  # (local)
t_max_factor = 3.0  # go to 3x Heisenberg time  # (local)
