...
d_const = np.load('computations/session-42/s42_constants_snapshot.npz', allow_pickle=True)
...
# N_tau from S43:
try:
    d_kz = np.load('computations/session-43/s43_kz_transfer.npz', allow_pickle=True)
...
np.savez('computations/session-46/s46_transfer_function.npz',
    # Gate info
...
print(f"\nSaved: computations/session-46/s46_transfer_function.npz")
...
plt.tight_layout()
plt.savefig('computations/session-46/s46_transfer_function.png', dpi=150, bbox_inches='tight')
print(f"Saved: computations/session-46/s46_transfer_function.png")
plt.close()
