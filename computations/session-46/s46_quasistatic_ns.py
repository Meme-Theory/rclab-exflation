...
d_qnm = np.load('computations/session-45/s45_qnm_ns.npz', allow_pickle=True)
...
d_qt = np.load('computations/session-46/s46_qtheory_selfconsistent.npz', allow_pickle=True)
...
delta_tau_range = 0.05  # conservative estimate  # (local)
...
np.savez('computations/session-46/s46_quasistatic_ns.npz', **save_dict)
print("Saved: computations/session-46/s46_quasistatic_ns.npz")
...
plt.savefig('computations/session-46/s46_quasistatic_ns.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-46/s46_quasistatic_ns.png")
