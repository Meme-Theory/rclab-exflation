...
# 1. LOAD DATA
# ============================================================
d_dos = np.load("computations/session-44/s44_dos_tau.npz", allow_pickle=True)
d_kz = np.load("computations/session-45/s45_kz_ns.npz", allow_pickle=True)
...
Gamma_narrow = 0.050            # M_KK (5x narrower, approaches discrete limit)  # (local)
...
eps_H_current = 2.999  # (local)
eps_H_target = 0.0176  # from n_s = 0.965  # (local)
...
# 17. SAVE RESULTS
# ============================================================
np.savez("computations/session-46/s46_nonsinglet_dissipation.npz",
    # Gate
...
print(f"\nSaved: computations/session-46/s46_nonsinglet_dissipation.npz")
...
plt.tight_layout()
plt.savefig("computations/session-46/s46_nonsinglet_dissipation.png",
            dpi=150, bbox_inches='tight')
print("Saved: computations/session-46/s46_nonsinglet_dissipation.png")
