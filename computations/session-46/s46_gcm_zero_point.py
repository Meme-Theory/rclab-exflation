...
V_at_min = V_min_5
V_at_cross = 0.0  # by definition, rho_gs(tau*) = 0  # (local)
...
print(f"""
  ...
  Data: computations/session-46/s46_gcm_zero_point.npz
  Plot: computations/session-46/s46_gcm_zero_point.png
  Script: computations/session-46/s46_gcm_zero_point.py
""")
