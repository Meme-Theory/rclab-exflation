...
# 1. LOAD DATA
# ============================================================
d_beat = np.load("computations/session-45/s45_gge_beating.npz", allow_pickle=True)
d_tj = np.load("computations/session-44/s44_multi_t_jacobson.npz", allow_pickle=True)
d_fried = np.load("computations/session-44/s44_friedmann_bcs_audit.npz", allow_pickle=True)
d_gge = np.load("computations/session-42/s42_gge_energy.npz", allow_pickle=True)
d_grad = np.load("computations/session-42/s42_gradient_stiffness.npz", allow_pickle=True)
...
B1_frac_cranking = 0.71  # from M-COLL-40  # (local)
...
dE_dtau_B2 = 0.0  # VAN HOVE: zero by definition  # (local)
...
np.savez("computations/session-46/s46_gge_friction.npz",
    # Gate
...
print("  Saved: computations/session-46/s46_gge_friction.npz")
...
plt.tight_layout()
plt.savefig("computations/session-46/s46_gge_friction.png", dpi=150, bbox_inches='tight')
print("  Saved: computations/session-46/s46_gge_friction.png")
