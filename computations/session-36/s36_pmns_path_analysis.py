...
def main():
    # Load W2-A results
    d = np.load('computations/session-36/s36_intersector_pmns.npz', allow_pickle=True)
    s10 = np.load('computations/session-35/s35_sector_10_spectrum.npz', allow_pickle=True)
    k7 = np.load('computations/session-35/s35_k7_thouless.npz', allow_pickle=True)
