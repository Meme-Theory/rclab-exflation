...
# ============================================================
d_auth = np.load('computations/session-36/s36_mmax_authoritative.npz', allow_pickle=True)
d_gcm = np.load('computations/session-36/s36_gcm_self_consistent.npz', allow_pickle=True)
...
# ============================================================
print()
print("Saving results to computations/session-36/s36_bayesian_posterior.npz")
...
np.savez('computations/session-36/s36_bayesian_posterior.npz', **save_dict)
print("Done.")
