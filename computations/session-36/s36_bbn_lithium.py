...
data = np.load('computations/session-23/s23a_eigenvectors_extended.npz', allow_pickle=True)
...
rg = np.load('computations/session-35/s35_rg_bcs_flow.npz', allow_pickle=True)
W_B2 = float(rg['W_B2'])
...
np.savez('computations/session-36/s36_bbn_lithium.npz',
    # Inputs
    tau_target=0.190,
    tau_used=tau_used,
...
print(f"Saved: computations/session-36/s36_bbn_lithium.npz")
print("\nDone.")
