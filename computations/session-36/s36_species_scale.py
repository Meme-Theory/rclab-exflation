...
# ===========================================================================
data_path = 'computations/session-23/s23a_eigenvectors_extended.npz'
...
# Save results
# ===========================================================================
np.savez('computations/session-36/s36_species_scale.npz',
    tau_values=tau_arr,
...
print("\nSaved: computations/session-36/s36_species_scale.npz")
...
plt.savefig('computations/session-36/s36_species_scale.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-36/s36_species_scale.png")
plt.close()
