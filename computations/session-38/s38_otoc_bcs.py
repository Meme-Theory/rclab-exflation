...
d37i = np.load('computations/session-37/s37_instanton_action.npz', allow_pickle=True)
...
# Transit time data
d36 = np.load('computations/session-36/s36_tau_dynamics.npz', allow_pickle=True)
...
omega_PV = 0.792
t_max = 80.0  # in natural units (local)
n_times = 2000
...
np.savez('computations/session-38/s38_otoc_bcs.npz', **save_dict)
print("  Saved: computations/session-38/s38_otoc_bcs.npz")
...
plt.savefig('computations/session-38/s38_otoc_bcs.png', dpi=150, bbox_inches='tight')
print("  Saved: computations/session-38/s38_otoc_bcs.png")
