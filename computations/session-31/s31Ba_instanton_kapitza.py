...
fiber = np.load(str(resolve_output(23, 's23c_fiber_integrals.npz')), allow_pickle=True)
tau_23c = fiber['tau']
...
outfile = str(resolve_output(31, 's31a_instanton_kapitza.npz'))
...
plt.tight_layout()
plotfile = str(resolve_output(31, 's31a_instanton_kapitza.png'))
