...
def main():
    ...
    # Load existing data
    oo_data = np.load('computations/session-28/s28b_order_one.npz', allow_pickle=True)
    ax_data = np.load('computations/session-28/s28c_12d_axioms.npz', allow_pickle=True)
    ...
    # Save
    # ========================================================================
    np.savez('computations/session-31/s31alt_order_one_severity.npz',
    ...
    print(f"\nSaved: computations/session-31/s31alt_order_one_severity.npz")
