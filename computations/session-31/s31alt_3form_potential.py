...
def main():
    ...
    # Compare to V_spec
    # ========================================================================
    vspec_data = np.load('computations/session-24/s24a_vspec.npz')
    ...
    # Save
    # ========================================================================
    np.savez('computations/session-31/s31alt_3form_potential.npz',
    ...
    print(f"\nSaved: computations/session-31/s31alt_3form_potential.npz")
    ...
    plt.tight_layout()
    plt.savefig('computations/session-31/s31alt_3form_potential.png', dpi=150)
    print(f"Saved: computations/session-31/s31alt_3form_potential.png")
