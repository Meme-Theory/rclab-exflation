...
# ── Load data ────────────────────────────────────────────────────────────
print("Loading data...")
dk = np.load(str(resolve_output(31, 's31Ba_kapitza_gate.npz')), allow_pickle=True)
di = np.load(str(resolve_output(31, 's31Ba_instanton_kapitza.npz')), allow_pickle=True)
...
outfile = str(resolve_output(31, 's31Ca_instanton_kapitza.npz'))
...
plotfile = str(resolve_output(31, 's31Ca_instanton_kapitza.png'))
