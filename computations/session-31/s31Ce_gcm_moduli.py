...
# ── Load data ──
grid = np.load('computations/session-30/s30b_grid_bcs.npz', allow_pickle=True)
sdw = np.load('computations/session-30/s30b_sdw_grid.npz', allow_pickle=True)
...
np.savez('computations/session-31/s31Ce_gcm_moduli.npz', **save_dict)
print(f"\nSaved: computations/session-31/s31Ce_gcm_moduli.npz")
...
plt.tight_layout()
plt.savefig('computations/session-31/s31Ce_gcm_moduli.png', dpi=150, bbox_inches='tight')
print(f"Saved: computations/session-31/s31Ce_gcm_moduli.png")
