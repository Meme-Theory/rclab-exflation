...
def main():
    ...
    # ========================================================================
    sdw = np.load('computations/session-30/s30b_sdw_grid.npz')
    tau_grid = sdw['tau']
    eps_grid = sdw['eps']
    ...
    # ========================================================================
    bcs = np.load('computations/session-30/s30b_grid_bcs.npz')
    V_spec = bcs['V_spec']
    ...
    # 7. Save
    # ========================================================================
    np.savez('computations/session-31/s31alt_cc_ratio.npz',
    ...
    print(f"\nSaved: computations/session-31/s31alt_cc_ratio.npz")
    ...
    plt.tight_layout()
    plt.savefig('computations/session-31/s31alt_cc_ratio.png', dpi=150)
    print(f"Saved: computations/session-31/s31alt_cc_ratio.png")
