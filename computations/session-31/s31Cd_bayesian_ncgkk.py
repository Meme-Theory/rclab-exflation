...
# ── Load input data ──
nck = np.load('computations/session-31/s31Ba_nck_tau021.npz', allow_pickle=True)
rge = np.load('computations/session-30/s30b_rge_running.npz', allow_pickle=True)
...
np.savez('computations/session-31/s31Cd_bayesian_ncgkk.npz', **save_dict)
print("\nSaved: computations/session-31/s31Cd_bayesian_ncgkk.npz")
...
plt.tight_layout()
plt.savefig('computations/session-31/s31Cd_bayesian_ncgkk.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-31/s31Cd_bayesian_ncgkk.png")
