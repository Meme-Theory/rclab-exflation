...
Input:
    computations/session-23/s23a_gap_equation.npz (V_matrix, eigenvalues, M_max at 9 tau)
    computations/session-31/s31Ba_kapitza_gate.npz (Kapitza orbit parameters)
    computations/session-31/s31Ba_instanton_kapitza.npz (instanton frequencies)

Output:
    computations/session-31/s31Cc_bcs_kapitza.{py,npz,png}
