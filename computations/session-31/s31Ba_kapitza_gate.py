...
bcs = np.load(str(resolve_output(30, 's30b_grid_bcs.npz')), allow_pickle=True)
stab = np.load(str(resolve_output(30, 's30b_5d_stability.npz')), allow_pickle=True)
sdw = np.load(str(resolve_output(30, 's30b_sdw_grid.npz')), allow_pickle=True)
...
outfile = str(resolve_output(31, 's31a_kapitza_gate.npz'))
...
plt.tight_layout()
plotfile = str(resolve_output(31, 's31a_kapitza_gate.png'))
