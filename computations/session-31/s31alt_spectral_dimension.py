...
def main():
    ...
    np.savez('computations/session-31/s31alt_spectral_dimension.npz', **save_dict)
    print(f"\nSaved: computations/session-31/s31alt_spectral_dimension.npz")
    ...
    plt.tight_layout()
    plt.savefig('computations/session-31/s31alt_spectral_dimension.png', dpi=150)
    print(f"Saved: computations/session-31/s31alt_spectral_dimension.png")
