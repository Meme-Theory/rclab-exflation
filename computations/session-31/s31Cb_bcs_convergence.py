...
Truncation levels:
  N_eff = 2:  Group A only (gap-edge 2-mode, matches K-1e "gap2")  # (local)
  N_eff = 10: Groups A+B (10-mode, matches K-1e "gap10")  # (local)
  N_eff = 16: All groups (full basis, matches K-1e "full16")  # (local)
