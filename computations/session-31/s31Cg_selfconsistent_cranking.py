...
np.savez('computations/session-31/s31Cg_selfconsistent_cranking.npz', **save_dict)
print("\nSaved: computations/session-31/s31Cg_selfconsistent_cranking.npz")
...
plt.tight_layout()
plt.savefig('computations/session-31/s31Cg_selfconsistent_cranking.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-31/s31Cg_selfconsistent_cranking.png")
