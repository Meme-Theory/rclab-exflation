...
# ── Load data ──
kap = np.load('computations/session-31/s31Ba_kapitza_gate.npz', allow_pickle=True)
inst = np.load('computations/session-31/s31Ba_instanton_kapitza.npz', allow_pickle=True)
...
np.savez('computations/session-31/s31Ch_instanton_eff_freq.npz', **save_dict)
print("\nSaved: computations/session-31/s31Ch_instanton_eff_freq.npz")
...
plt.tight_layout()
plt.savefig('computations/session-31/s31Ch_instanton_eff_freq.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-31/s31Ch_instanton_eff_freq.png")
