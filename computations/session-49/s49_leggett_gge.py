...
otoc = np.load('computations/session-38/s38_otoc_bcs.npz', allow_pickle=True)
leggett = np.load('computations/session-48/s48_leggett_mode.npz', allow_pickle=True)
kz = np.load('computations/session-38/s38_kz_defects.npz', allow_pickle=True)
...
np.savez('computations/session-49/s49_leggett_gge.npz',
    # Gate
...
print("Saved: computations/session-49/s49_leggett_gge.npz")
...
plt.tight_layout()
plt.savefig('computations/session-49/s49_leggett_gge.png', dpi=150)
print("Saved: computations/session-49/s49_leggett_gge.png")
...
print("\nUpdated: computations/session-49/s49_leggett_gge.npz")
...
ax.plot(t_array, C_L_N2.real / C_L_N2[0].real * C_L[0].real, 'r-', linewidth=0.8,
        alpha=0.7, label='N=2 GGE (scaled)')  # (local)
ax.axhline(0, color='k', linewidth=0.3)
ax.set_xlabel('t (M_KK^{-1})')
ax.set_ylabel('C_L(t)')
...
plt.tight_layout()
plt.savefig('computations/session-49/s49_leggett_gge.png', dpi=150)
print("Updated: computations/session-49/s49_leggett_gge.png")
