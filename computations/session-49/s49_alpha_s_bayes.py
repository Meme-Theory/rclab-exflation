...
sigma_J_xy = 0.50  # 50% log-normal spread (from BCS + V-matrix combined)  # (local)
sigma_J_z = 0.80   # larger for soft mode (less constrained)  # (local)
sigma_K = 0.30      # K_pivot uncertainty from lattice assignment  # (local)
p_reassign = 0.25   # probability of z-coupling reassignment  # (local)

# Planck measurement
ns_planck_mean = 0.9649  # (local)
...
alpha_s_planck_central = -0.0045  # (local)
alpha_s_planck_sigma = 0.0067  # (local)
