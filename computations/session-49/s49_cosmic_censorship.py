...
dtau=0.030 (reaching ~0.22) WITH BCS friction. But several questions remain:  # (local)
...
def spectral_action_at_tau(tau):
    ...
    local_a0 = 16.0  # dim(spinor) * vol / vol_ref, normalized  # (local)
...
t_max_integration = 0.05  # M_KK^{-1} units (plenty for the transit)  # (local)
