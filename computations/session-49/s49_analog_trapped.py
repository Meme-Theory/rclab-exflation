...
def load_npz(name):
    """Load an npz file from computations."""
...
if n_total > 0:
    ...
    kappa_mean = 0.0  # (local)
    kappa_max_val = 0.0  # (local)
    is_degenerate = True
    T_H_mean = 0.0  # (local)
    T_H_max_val = 0.0  # (local)
...
print(f"\n  Saved: computations/session-49/s49_analog_trapped.npz")
...
plt.close()
print(f"  Saved: computations/session-49/s49_analog_trapped.png")
