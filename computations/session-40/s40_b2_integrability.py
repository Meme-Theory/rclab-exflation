...
d_s39 = np.load('computations/session-39/s39_integrability_check.npz', allow_pickle=True)
d_rg = np.load('computations/session-39/s39_richardson_gaudin.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-40/s40_b2_integrability.png', dpi=150, bbox_inches='tight')
print("Plot saved: computations/session-40/s40_b2_integrability.png")
...
np.savez('computations/session-40/s40_b2_integrability.npz', **save_dict)
print("Data saved: computations/session-40/s40_b2_integrability.npz")
