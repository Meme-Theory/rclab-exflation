...
print(f"  Saved: computations/session-40/s40_b2_decay_out.npz")
...
print(f"  Saved: computations/session-40/s40_b2_decay_out.png")
...
print(f"\n  FILES:")
print(f"    Script: computations/session-40/s40_b2_decay_out.py")
print(f"    Data: computations/session-40/s40_b2_decay_out.npz")
print(f"    Plot: computations/session-40/s40_b2_decay_out.png")
