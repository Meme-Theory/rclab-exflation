...
cas = np.load('computations/session-39/s39_cascade_spectroscopy.npz', allow_pickle=True)
fs  = np.load('computations/session-39/s39_fubini_study.npz', allow_pickle=True)
rg  = np.load('computations/session-39/s39_richardson_gaudin.npz', allow_pickle=True)
s36 = np.load('computations/session-36/s36_sfull_tau_stabilization.npz', allow_pickle=True)
...
np.savez('computations/session-40/s40_collective_inertia.npz',
...
print(f"\nData saved to computations/session-40/s40_collective_inertia.npz")
...
plt.tight_layout()
plt.savefig('computations/session-40/s40_collective_inertia.png', dpi=150, bbox_inches='tight')
print(f"Plot saved to computations/session-40/s40_collective_inertia.png")
