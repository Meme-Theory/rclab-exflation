...
plt.tight_layout()
plt.savefig('computations/session-40/s40_internal_page_curve.png', dpi=150, bbox_inches='tight')
print("  Saved: computations/session-40/s40_internal_page_curve.png")

# ============================================================
# 12. Save data
# ============================================================
np.savez('computations/session-40/s40_internal_page_curve.npz',
    # Gate
    gate_id='PAGE-40',
...
t_end = time.time()
print(f"\nSaved: computations/session-40/s40_internal_page_curve.npz")
