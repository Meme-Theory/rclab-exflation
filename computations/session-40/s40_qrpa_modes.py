...
Input: computations/session-39/s39_richardson_gaudin.npz
       computations/session-37/s37_pair_susceptibility.npz
Output: computations/session-40/s40_qrpa_modes.npz
        computations/session-40/s40_qrpa_modes.png
"""
...
rg = np.load('computations/session-39/s39_richardson_gaudin.npz', allow_pickle=True)
ps = np.load('computations/session-37/s37_pair_susceptibility.npz', allow_pickle=True)
...
np.savez('computations/session-40/s40_qrpa_modes.npz',
    # Gate result
...
print(f"\nData saved to computations/session-40/s40_qrpa_modes.npz")
...
plt.tight_layout()
plt.savefig('computations/session-40/s40_qrpa_modes.png', dpi=150, bbox_inches='tight')
print(f"Plot saved to computations/session-40/s40_qrpa_modes.png")
