...
Input:
  - computations/session-39/s39_kk_mass.npz (MASS-39)
  - computations/session-39/s39_richardson_gaudin.npz (RG-39)
  - computations/session-39/s39_gge_lambdas.npz (GGE-39)
  - computations/session-36/s36_sfull_tau_stabilization.npz (S_full at fold)

Output:
  - computations/session-40/s40_cc_transit.npz
