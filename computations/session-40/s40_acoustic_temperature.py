...
Inputs:
  computations/session-39/s39_cascade_spectroscopy.npz  (B2 dispersion)
  computations/session-39/s39_richardson_gaudin.npz      (BCS gap at fold)
  computations/session-37/s37_pair_susceptibility.npz    (pair gap Delta_pair)

Outputs:
  computations/session-40/s40_acoustic_temperature.npz
  computations/session-40/s40_acoustic_temperature.png
"""
...
print(f"\n  Data saved to: computations/session-40/s40_acoustic_temperature.npz")
...
print(f"  Plot saved to: computations/session-40/s40_acoustic_temperature.png")
