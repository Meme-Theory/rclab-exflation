...
Input: computations/session-23/s23a_gap_equation.npz
Output: computations/session-32/s32a_umklapp_vertex.npz, .png
...
ax.fill_between(tau_values, 0, vertex_product, where=(vertex_product > 0),
                alpha=0.2, color='green', label='Turing OPEN (V > 0)')  # (local)
ax.fill_between(tau_values, 0, vertex_product, where=(vertex_product < 0),
                alpha=0.2, color='red', label='Turing CLOSED (V < 0)')  # (local)
ax.set_xlabel(r'$\tau$')
