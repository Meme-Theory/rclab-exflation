# ============================================================================
# FROZEN SNAPSHOT (post-drift) of s98_w2_2_relaxation_closure.py
# ============================================================================
#
# This snapshot pins the CURRENT (corrected, idempotent) bytes of
# s98_w2_2_relaxation_closure.py at the time of in-session freeze
# (S98 W2-1 mechanical-closure landing, 2026-05-31).
#
# Snapshot tag: frozen-6a4f5a470e2d095f
#   short16 of sha256(s98_w2_2_relaxation_closure.py bytes-at-snapshot-time).
#
# IMPORTANT -- these are NOT the W2-1-emission-time bytes.
#
#   sha256(snapshot-source-bytes, 2026-05-31, post idempotency-guard edit) =
#     6a4f5a470e2d095f928bbb6e3fbd021676768f084563440dbe3f525d9a00a06a
#
#   audit_sha256 / content_sha256 recorded in the canonical W2-1 verdict line
#   of computations/session-98/s98_gate_verdicts.txt (W2-1-emission-time,
#   2026-05-31, BEFORE the idempotency-guard edit) =
...
#
# Per .claude/rules/mechanical-closure-discipline.md §"Carry-forward
# script-bytes immutability": editing the closure script after emitting its
# verdict produces a content_sha256 mismatch between the script-as-emitted and
# script-at-current-time. This does NOT invalidate the previously-emitted
# verdict (the recorded SHAs are commitments to the script-state-at-emission-
# time). The single edit between emission and this snapshot was the addition of
# an idempotency guard in update_wp_section() (no-op when WP §W2-1 is already
# finalized), so the script is a clean re-runnable audit tool. The verdict
# (FAIL, PRE-REG-INC mechanical closure, blocked_by S98-W1-ROUTE-RECONCILIATION
# =FAIL) is unchanged.
# ============================================================================
