...
d_ext = np.load('computations/session-23/s23a_eigenvectors_extended.npz', allow_pickle=True)
d_rpa = np.load('computations/session-32/s32b_rpa1_thouless.npz', allow_pickle=True)
...
d_bcs = np.load('computations/session-27/s27_multisector_bcs.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-33/s33a_strutinsky.png', dpi=150, bbox_inches='tight')
print("\nPlot saved: computations/session-33/s33a_strutinsky.png")
...
np.savez('computations/session-33/s33a_strutinsky.npz', **save_dict)
print("Data saved: computations/session-33/s33a_strutinsky.npz")
