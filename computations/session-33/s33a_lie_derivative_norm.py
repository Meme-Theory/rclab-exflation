...
try:
    d_ls = np.load('computations/session-33/s33a_landau_sector.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-33/s33a_lie_derivative_norm.png', dpi=150, bbox_inches='tight')
print("\nPlot saved: computations/session-33/s33a_lie_derivative_norm.png")

# ─────────────────────────────────────────────────────────────
# 7. Save
# ─────────────────────────────────────────────────────────────

np.savez('computations/session-33/s33a_lie_derivative_norm.npz',
         tau_grid=tau_grid,
         f_vals=f_vals,
         f_prime=f_prime,
...
print("Data saved: computations/session-33/s33a_lie_derivative_norm.npz")
