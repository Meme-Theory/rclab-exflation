...
plt.tight_layout()
plt.savefig('C:/sandbox/Ainulindale Exflation/computations/session-33/s33w3_modulus_equation.png', dpi=150)
print("\nFigure saved to computations/session-33/s33w3_modulus_equation.png")
...
np.savez('C:/sandbox/Ainulindale Exflation/computations/session-33/s33w3_modulus_equation.npz',
         G_tau_tau=G_TAU_TAU,
         chi_0=chi_0,
         chi_1=chi_1,
...
print("\nResults saved to computations/session-33/s33w3_modulus_equation.npz")
print("\nDONE.")
