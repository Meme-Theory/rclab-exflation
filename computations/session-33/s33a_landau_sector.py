...
d_conv = np.load('computations/session-28/s28c_sector_convergence.npz', allow_pickle=True)
...
plt.tight_layout()
plt.savefig('computations/session-33/s33a_landau_sector.png', dpi=150, bbox_inches='tight')
print("\nPlot saved: computations/session-33/s33a_landau_sector.png")
...
np.savez('computations/session-33/s33a_landau_sector.npz', **save_data)
print("Data saved: computations/session-33/s33a_landau_sector.npz")
