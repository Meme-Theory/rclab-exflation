...
plt.tight_layout()
plt.savefig('computations/session-33/s33a_rge_gate.png', dpi=150, bbox_inches='tight')
print("\nPlot saved: computations/session-33/s33a_rge_gate.png")

# ─────────────────────────────────────────────────────────────
# 7. Save
# ─────────────────────────────────────────────────────────────

np.savez('computations/session-33/s33a_rge_gate.npz',
...
print("Data saved: computations/session-33/s33a_rge_gate.npz")
