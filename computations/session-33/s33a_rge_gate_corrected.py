...
plt.tight_layout()
plt.savefig('computations/session-33/s33a_rge_gate_corrected.png', dpi=150, bbox_inches='tight')
print(f"\nPlot saved: computations/session-33/s33a_rge_gate_corrected.png")

# ─────────────────────────────────────────────────────────────
# 10. Save data
# ─────────────────────────────────────────────────────────────

np.savez('computations/session-33/s33a_rge_gate_corrected.npz',
...
print(f"Data saved: computations/session-33/s33a_rge_gate_corrected.npz")
