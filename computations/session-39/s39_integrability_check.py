...
# 1. Load data
# ============================================================
d_s37 = np.load('computations/session-37/s37_pair_susceptibility.npz', allow_pickle=True)
d_s38 = np.load('computations/session-38/s38_otoc_bcs.npz', allow_pickle=True)
d_s39 = np.load('computations/session-39/s39_richardson_gaudin.npz', allow_pickle=True)
...
# Save
# ============================================================
np.savez('computations/session-39/s39_integrability_check.npz',
    # Gate verdict
