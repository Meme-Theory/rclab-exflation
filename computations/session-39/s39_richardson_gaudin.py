...
for ti in range(n_tau):
    tau = tau_kosmann[ti]
    xi_ti = E_8_tau[ti] - mu
    E_kin = 2.0 * np.sum(xi_ti * psi_pair_tau[ti] ** 2)  # (local)
...
print(f"\n  Files produced:")
print(f"    Script: computations/session-39/s39_richardson_gaudin.py")
print(f"    Data:   computations/session-39/s39_richardson_gaudin.npz")
print(f"    Plot:   computations/session-39/s39_richardson_gaudin.png")
