...
INPUT DATA:
  - computations/session-37/s37_instanton_action.npz  (GL parameters, BCS landscape)
  - computations/session-36/s36_tau_dynamics.npz       (terminal velocity)
  - computations/session-39/s39_schwinger_geometric.npz (W1-3 results)
  - computations/session-39/s39_9to1_sweep.npz         (Delta_0(tau) profile)
...
# LOAD DATA
# ====================================================================
s37 = np.load('computations/session-37/s37_instanton_action.npz', allow_pickle=True)
s36 = np.load('computations/session-36/s36_tau_dynamics.npz', allow_pickle=True)
s39 = np.load('computations/session-39/s39_schwinger_geometric.npz', allow_pickle=True)
sweep = np.load('computations/session-39/s39_9to1_sweep.npz', allow_pickle=True)
...
np.savez('computations/session-39/s39_schwinger_proof.npz', **results)
print("Saved: computations/session-39/s39_schwinger_proof.npz")
print()
