...
for tau_p, tau_q in tau_pairs:
    if tau_p in tau_values and tau_q in tau_values:
        ...
        S = -np.sum(pn * np.log(np.maximum(pn, 1e-300)))  # (local)
...
print(f"  Saved: computations/session-39/s39_gge_lambdas.npz")
...
print(f"  Saved: computations/session-39/s39_gge_lambdas.png")
