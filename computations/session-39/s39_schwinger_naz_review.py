...
s39 = np.load('computations/session-39/s39_schwinger_proof.npz', allow_pickle=True)
...
np.savez('computations/session-39/s39_schwinger_naz_review.npz',
    # Verified numbers
...
print("Saved: computations/session-39/s39_schwinger_naz_review.npz")
