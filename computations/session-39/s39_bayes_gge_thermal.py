...
gge_data = np.load('computations/session-39/s39_gge_lambdas.npz', allow_pickle=True)
kk_data = np.load('computations/session-39/s39_kk_mass.npz', allow_pickle=True)
bcs_data = np.load('computations/session-38/s38_otoc_bcs.npz', allow_pickle=True)
...
np.savez('computations/session-39/s39_bayes_gge_thermal.npz',
    # Gate
...
print("  Saved to: computations/session-39/s39_bayes_gge_thermal.npz")
print("\nDone.")
