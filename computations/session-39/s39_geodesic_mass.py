...
Input:
  - computations/session-39/s39_kk_mass.npz (W3-1 BdG masses)
  - computations/session-27/s27_multisector_bcs.npz (Dirac eigenvalues vs tau)
  - computations/session-36/s36_tau_dynamics.npz (terminal velocity)

Output:
  - computations/session-39/s39_geodesic_mass.npz
...
d_mass = np.load('computations/session-39/s39_kk_mass.npz', allow_pickle=True)
d_spec = np.load('computations/session-27/s27_multisector_bcs.npz', allow_pickle=True)
d_dyn = np.load('computations/session-36/s36_tau_dynamics.npz', allow_pickle=True)
...
np.savez('computations/session-39/s39_geodesic_mass.npz',
    # Grid
    tau_grid=tau_grid,
...
print("\nSaved: computations/session-39/s39_geodesic_mass.npz")
print("DONE.")
