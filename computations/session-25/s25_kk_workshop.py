...
# Load all data
# ==============================================================
eig_data = np.load('computations/session-23/s23a_eigenvectors_extended.npz', allow_pickle=True)
fiber = np.load('computations/session-23/s23c_fiber_integrals.npz', allow_pickle=True)
feynman = np.load('computations/session-25/s25_feynman_results.npz', allow_pickle=True)
landau = np.load('computations/session-25/s25_landau_results.npz', allow_pickle=True)
berry = np.load('computations/session-25/s25_berry_results.npz', allow_pickle=True)
baptista = np.load('computations/session-25/s25_baptista_results.npz', allow_pickle=True)
dnp = np.load('computations/session-22/s22a_dnp_bound.npz', allow_pickle=True)
...
# Save results
# ==============================================================
np.savez('computations/session-25/s25_kk_workshop.npz',
...
print("\n" + "=" * 70)
print("All results saved to computations/session-25/s25_kk_workshop.npz")
print("=" * 70)
