...
# LOAD DATA
# ============================================================
data_path = Path(r"C:\sandbox\Ainulindale Exflation\computations\s23a_eigenvectors_extended.npz")
...
N_modes = 50  # lowest 50 modes (local)
...
plt.tight_layout()
plot_path = Path(r"C:\sandbox\Ainulindale Exflation\computations\s25_hawking_computations.png")
