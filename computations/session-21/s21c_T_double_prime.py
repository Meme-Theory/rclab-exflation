...
def compute_T_double_prime(branching, data_file='computations/session-19/s19a_sweep_data.npz'):
    """
...
def compute_S_signed(branching, data_file='computations/session-19/s19a_sweep_data.npz'):
    """
    ...
    plt.tight_layout()
    plt.savefig('computations/session-21/s21c_S_signed.png', dpi=150)
    print(f"\nPlot saved: computations/session-21/s21c_S_signed.png")

    # Save data
    np.savez('computations/session-21/s21c_S_signed.npz',
             ...
             min_tau=min_tau,
             min_val=min_val)
    print(f"Data saved: computations/session-21/s21c_S_signed.npz")
...
if __name__ == '__main__':
    ...
    with open('computations/session-21/s21c_T_double_prime_result.txt', 'w') as f:
    ...
    print(f"\nResult file saved: computations/session-21/s21c_T_double_prime_result.txt")
