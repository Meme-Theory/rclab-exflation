...
Data: computations/_shared/r20a_riemann_tensor.npz
Output: computations/session-21/s21c_gauss_bonnet.txt
"""
...
d = np.load('C:/sandbox/Ainulindale Exflation/computations/_shared/r20a_riemann_tensor.npz', allow_pickle=True)
tau_vals = d['tau']
R_abcd = d['R_abcd']
Ric = d['Ric']
R_scalar = d['R_scalar']
...
with open(output_path, 'w') as f:
    ...
    f.write(f"Data file: computations/_shared/r20a_riemann_tensor.npz\n")
