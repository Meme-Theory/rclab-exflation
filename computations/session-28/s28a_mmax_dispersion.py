...
Input:
  computations/session-27/s27_multisector_bcs.npz (M_max, sectors, tau, mu)

Output:
  computations/session-28/s28a_mmax_dispersion.npz
  computations/session-28/s28a_mmax_dispersion.png
