...
Input: computations/session-28/s28c_phonon_tmatrix.npz  (KC-2 output)
       computations/session-28/s28a_bogoliubov_coefficients.npz  (KC-1 output)
       computations/session-28/s28b_pomeranchuk.npz  (Pomeranchuk data)
Output: computations/session-28/s28c_luttinger.npz
        computations/session-28/s28c_luttinger.txt
