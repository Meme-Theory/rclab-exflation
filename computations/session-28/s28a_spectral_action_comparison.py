...
Input:  computations/session-27/s27_torsion_gap_gate.npz (for tau grid reference)
        Infrastructure from dirac_spectrum.py (geometry, irreps, Dirac)

Output: computations/session-28/s28a_spectral_action_comparison.npz
        computations/session-28/s28a_spectral_action_comparison.png
