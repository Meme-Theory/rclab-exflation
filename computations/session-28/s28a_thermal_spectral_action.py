...
Input: computations/session-19/s19a_sweep_data.npz (full spectrum at 21 tau values)
       computations/session-27/s27_multisector_bcs.npz (eigenvalues per sector)
Output: computations/session-28/s28a_thermal_spectral_action.npz
        computations/session-28/s28a_thermal_spectral_action.png
