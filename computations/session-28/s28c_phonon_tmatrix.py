...
Scattering rate:
    W = 2*pi * sum_{3,4} |T_{12->34}|^2 * delta(E1+E2-E3-E4) * n_3 * n_4  # (local)
...
Input: computations/session-23/s23a_eigenvectors_extended.npz
       computations/session-28/s28a_bogoliubov_coefficients.npz
Output: computations/session-28/s28c_phonon_tmatrix.npz
        computations/session-28/s28c_phonon_tmatrix.png
