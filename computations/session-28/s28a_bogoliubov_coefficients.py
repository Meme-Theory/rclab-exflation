...
Input: computations/session-19/s19a_sweep_data.npz (21 tau values, 11424 modes)
Output: computations/session-28/s28a_bogoliubov_coefficients.npz
        computations/session-28/s28a_bogoliubov_coefficients.png
