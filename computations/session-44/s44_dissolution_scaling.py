...
np.savez('computations/session-44/s44_dissolution_scaling.npz', **save_data)
print("  Saved: computations/session-44/s44_dissolution_scaling.npz")
...
for name, res in fit_results.items():
    ...
    ax1.plot(N_plot, y, '-', color=colors.get(name, 'gray'), linewidth=1.5,
             alpha=0.7, label=label_str)  # (local)
...
plt.savefig('computations/session-44/s44_dissolution_scaling.png', dpi=150, bbox_inches='tight')
print("  Saved: computations/session-44/s44_dissolution_scaling.png")
