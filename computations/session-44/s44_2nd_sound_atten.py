...
therm = np.load('computations/session-43/s43_thermal_conductivity.npz', allow_pickle=True)
qfact = np.load('computations/session-43/s43_quality_factors.npz', allow_pickle=True)
const = np.load('computations/session-42/s42_constants_snapshot.npz', allow_pickle=True)
kkcmb = np.load('computations/session-43/s43_kk_cmb_transfer.npz', allow_pickle=True)
fsimp = np.load('computations/session-44/s44_first_sound_imprint.npz', allow_pickle=True)
...
np.savez('computations/session-44/s44_2nd_sound_atten.npz',
    # Second sound speed
    u_2_internal=u_2,
...
print("Data saved to computations/session-44/s44_2nd_sound_atten.npz")
print()
...
plt.savefig('computations/session-44/s44_2nd_sound_atten.png', dpi=150, bbox_inches='tight')
print("Plot saved to computations/session-44/s44_2nd_sound_atten.png")
plt.close()
