...
grad_data = np.load('computations/session-42/s42_gradient_stiffness.npz', allow_pickle=True)
acous_data = np.load('computations/session-43/s43_acoustic_metric.npz', allow_pickle=True)
therm_data = np.load('computations/session-43/s43_thermal_conductivity.npz', allow_pickle=True)
tf_data = np.load('computations/session-43/s43_kk_cmb_transfer.npz', allow_pickle=True)
const_data = np.load('computations/session-42/s42_constants_snapshot.npz', allow_pickle=True)
...
sfull = np.load('computations/session-36/s36_sfull_tau_stabilization.npz', allow_pickle=True)
...
N_modes = 4 * np.pi * k_1**2 * Delta_k_1 * V_eff_Mpc / (2 * np.pi)**3  # (local)
...
np.savez('computations/session-44/s44_first_sound_imprint.npz',
    # Gate
...
print(f"  Saved: computations/session-44/s44_first_sound_imprint.npz")
...
plt.savefig('computations/session-44/s44_first_sound_imprint.png', dpi=150, bbox_inches='tight')
print(f"  Saved: computations/session-44/s44_first_sound_imprint.png")
plt.close()
