...
Input: computations/session-36/s36_sfull_tau_stabilization.npz (eigenvalues at tau=0.190)
       computations/session-42/s42_constants_snapshot.npz (M_KK, a_2, etc.)
       computations/session-42/s42_hauser_feshbach.npz (reference masses)

Output: computations/session-44/s44_sakharov_gn.npz, s44_sakharov_gn.png
"""
...
print(f"\n  Data saved to: computations/session-44/s44_sakharov_gn.npz")
...
print(f"  Plot saved to: computations/session-44/s44_sakharov_gn.png")
