...
d = np.load('computations/session-42/s42_homogeneity.npz', allow_pickle=True)
...
np.savez('computations/session-44/s44_homog_recompute.npz', **save_dict)
print("Saved: computations/session-44/s44_homog_recompute.npz")
...
plt.savefig('computations/session-44/s44_homog_recompute.png', dpi=150, bbox_inches='tight')
print("Saved: computations/session-44/s44_homog_recompute.png")
plt.close()
