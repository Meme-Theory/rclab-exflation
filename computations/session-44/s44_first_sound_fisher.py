...
# =============================================================================
imprint = np.load('computations/session-44/s44_first_sound_imprint.npz', allow_pickle=True)
transfer = np.load('computations/session-43/s43_kk_cmb_transfer.npz', allow_pickle=True)
constants = np.load('computations/session-42/s42_constants_snapshot.npz', allow_pickle=True)
...
# 13. Save results
# =============================================================================
np.savez('computations/session-44/s44_first_sound_fisher.npz',
    # Gate
...
print(f"\nResults saved to computations/session-44/s44_first_sound_fisher.npz")
...
plt.tight_layout()
plt.savefig('computations/session-44/s44_first_sound_fisher.png', dpi=150, bbox_inches='tight')
print("Plot saved to computations/session-44/s44_first_sound_fisher.png")
