...
Input:
  computations/session-42/s42_gge_energy.npz
  computations/session-42/s42_hauser_feshbach.npz
  computations/session-43/s43_pair_form_factor.npz
  computations/session-43/s43_cdm_category.npz

Output:
  computations/session-44/s44_cdm_construct.npz
  computations/session-44/s44_cdm_construct.png
...
gge = np.load('computations/session-42/s42_gge_energy.npz', allow_pickle=True)
hf  = np.load('computations/session-42/s42_hauser_feshbach.npz', allow_pickle=True)
pff = np.load('computations/session-43/s43_pair_form_factor.npz', allow_pickle=True)
cdm = np.load('computations/session-43/s43_cdm_category.npz', allow_pickle=True)
...
np.savez('computations/session-44/s44_cdm_construct.npz',
    # Gate
...
print(f"\n  Data saved to computations/session-44/s44_cdm_construct.npz")
...
plt.savefig('computations/session-44/s44_cdm_construct.png', dpi=150, bbox_inches='tight')
print(f"\n  Plot saved to computations/session-44/s44_cdm_construct.png")
