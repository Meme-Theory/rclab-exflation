...
np.savez('computations/session-44/s44_coherent_wall.npz', **save_dict)
print("\n  Data saved to computations/session-44/s44_coherent_wall.npz")
...
plt.tight_layout()
plt.savefig('computations/session-44/s44_coherent_wall.png', dpi=150, bbox_inches='tight')
print("  Plot saved to computations/session-44/s44_coherent_wall.png")
