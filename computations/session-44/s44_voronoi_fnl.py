...
# SAVE DATA
# ============================================================
np.savez('computations/session-44/s44_voronoi_fnl.npz',
...
print("\nData saved to computations/session-44/s44_voronoi_fnl.npz")
...
ax.fill_between(ells, np.maximum(Dl - Dl_err, Dl*0.01), Dl + Dl_err,
                alpha=0.3, color='steelblue')  # (local)
...
plt.tight_layout()
plt.savefig('computations/session-44/s44_voronoi_fnl.png', dpi=150, bbox_inches='tight')
print("Plot saved to computations/session-44/s44_voronoi_fnl.png")
print("\nDone.")
