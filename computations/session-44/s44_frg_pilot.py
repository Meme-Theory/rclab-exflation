...
d42 = np.load('computations/session-42/s42_hauser_feshbach.npz', allow_pickle=True)
d44s = np.load('computations/session-44/s44_strutinsky_diag.npz', allow_pickle=True)
...
# 12. Save all results
# ============================================================
np.savez('computations/session-44/s44_frg_pilot.npz',
    # Input
    eps_modes=eps,
    mult=mult,
    N_modes=N,
...
print(f"\nData saved to computations/session-44/s44_frg_pilot.npz")
...
plt.tight_layout()
plt.savefig('computations/session-44/s44_frg_pilot.png', dpi=150, bbox_inches='tight')
print("Plot saved to computations/session-44/s44_frg_pilot.png")
