...
d_s36 = np.load('computations/session-36/s36_sfull_tau_stabilization.npz', allow_pickle=True)
d_s42g = np.load('computations/session-42/s42_gradient_stiffness.npz', allow_pickle=True)
d_s38 = np.load('computations/session-38/s38_cc_instanton.npz', allow_pickle=True)
d_s42gge = np.load('computations/session-42/s42_gge_energy.npz', allow_pickle=True)
d_s44eih = np.load('computations/session-44/s44_eih_grav.npz', allow_pickle=True)
d_s43 = np.load('computations/session-43/s43_friedmann_bcs.npz', allow_pickle=True)
...
np.savez('computations/session-44/s44_friedmann_bcs_audit.npz',
    # Gate
...
print(f"\nData saved to computations/session-44/s44_friedmann_bcs_audit.npz")
...
plt.tight_layout()
plt.savefig('computations/session-44/s44_friedmann_bcs_audit.png', dpi=150, bbox_inches='tight')
print(f"Plot saved to computations/session-44/s44_friedmann_bcs_audit.png")
