...
d22 = np.load('computations/session-22/s22b_eigenvectors.npz', allow_pickle=True)
...
# STEP 10: Save Data
# ============================================================
np.savez('computations/session-44/s44_n3_bdg.npz',
    # Gate
...
print("\nData saved to computations/session-44/s44_n3_bdg.npz")
...
plt.savefig('computations/session-44/s44_n3_bdg.png', dpi=150, bbox_inches='tight')
print("Plot saved to computations/session-44/s44_n3_bdg.png")
