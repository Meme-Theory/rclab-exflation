...
data_const = np.load('computations/session-42/s42_constants_snapshot.npz', allow_pickle=True)
data_sfull = np.load('computations/session-36/s36_sfull_tau_stabilization.npz', allow_pickle=True)
...
np.savez('computations/session-44/s44_eih_grav.npz',
    # Gate
...
print(f"\nSaved: computations/session-44/s44_eih_grav.npz")
...
plt.tight_layout()
plt.savefig('computations/session-44/s44_eih_grav.png', dpi=150, bbox_inches='tight')
print(f"Saved: computations/session-44/s44_eih_grav.png")
