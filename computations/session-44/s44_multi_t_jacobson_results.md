...
- `computations/session-44/s44_multi_t_jacobson.py` (script)
- `computations/session-44/s44_multi_t_jacobson.npz` (39 KB)
- `computations/session-44/s44_multi_t_jacobson.png` (283 KB)
