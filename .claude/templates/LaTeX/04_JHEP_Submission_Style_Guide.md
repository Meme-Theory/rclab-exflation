...
\author{Author One\thanks{e-mail: author1@univ.edu},
        Author Two\thanks{e-mail: author2@cern.ch}}
...
```latex
\author{A.~Author\thanks{e-mail: author@univ.edu},
        B.~Colleague\thanks{e-mail: colleague@cern.ch},
        C.~Collaborator\thanks{e-mail: collaborator@physics.org}}
