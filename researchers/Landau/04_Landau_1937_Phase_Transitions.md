...
- 1-loop CW computed using Level 1 eigenvalues
...
4. **Classify fluctuations** (AVAILABLE: Level 1 eigenvalues)
5. **Compute correlation functions** (FUTURE: Level 2)
...
Every script in computations/_shared/ computes some aspect of this Landau free
