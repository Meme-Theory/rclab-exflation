...
Source: `sessions/archive/session-24/session-24-sagan-verdict.md`
...
|:-----|:---------|:--------|
| `sessions/archive/session-24/session-24-sagan-verdict.md` | sagan | Full Sagan Standard verdict on 7-gate battery |
| `sessions/archive/session-24/session-24b-synthesis.md` | coordinator | This document: combined synthesis with branch assignment |
