...
**Predecessor**: `sessions/archive/session-18/session-18-veff-convergence.md` (full Session 18 minutes)
...
| File | Description |
|:-----|:------------|
| `sessions/archive/session-18/session-18-wrapup.md` | This document |
| `sessions/archive/session-18/session-18-veff-convergence.md` | Full Session 18 minutes |
